  ...
  return (function (e) {
    ...
    function (e, t, r) {
      ...
      t.create = function (e) {
        function t(e) {
          ...
          return (
            -1 === o
              ? ((i =
                  e.math === !0
                    ? e.factory(c.type, f, t, c.typed, c)
                    : e.factory(c.type, f, t, c.typed)),
                r.push(e),
                u.push(i))
              : (i = u[o]),
            i
        ...
        var r = [],
          ...
          c = o.mixin({});
        (c.type = {}),
          (c.expression = { transform: Object.create(c) }),
        ...
        return (c['import'] = t(a)), (c.config = t(s)), e && c.config(e), c;
      };
    },
    function (e, t) {
      'use strict';
      (t.clone = function r(e) {
        var t = typeof e;
        if ('number' === t || 'string' === t || 'boolean' === t || null === e || void 0 === e)
          return e;
          ...
          for (var r in t)
            if (t.hasOwnProperty(r))
              if (t[r] && t[r].constructor === Object)
                void 0 === e[r] && (e[r] = {}),
                  e[r].constructor === Object ? n(e[r], t[r]) : (e[r] = t[r]);
              else {
        ...
        (t.deepEqual = function (e, r) {
          ...
          if (Array.isArray(e)) {
            ...
            for (i = 0, o = e.length; o > i; i++) if (!t.deepEqual(e[i], r[i])) return !1;
            return !0;
          }
        ...
        (t.canDefineProperty = function () {
          try {
            if (Object.defineProperty)
              return Object.defineProperty({}, 'x', { get: function () {} }), !0;
          } catch (e) {}
          return !1;
        }),
          ...
          (t.conversions = [
            ...
            },
            {
              ...
              convert: function (t) {
                if (i(t) > 15)
                  throw new TypeError(
                    'Cannot implicitly convert a number with >15 significant digits to Fraction (value: ' +
                      t +
    ...
    function (e, t, r) {
      ...
      !(function (r, a) {
        (i = []),
          (n = a),
          (o = 'function' == typeof n ? n.apply(t, i) : n),
        ...
        function e() {
          function t(e) {
            ...
            if (!t) {
              ...
              throw new Error(
                'Unknown type "' + e + '"' + (i ? '. Did you mean "' + i + '"?' : '')
              );
            }
            return t;
          }
            ...
            for (var t = '', r = 0; r < e.length; r++) {
              ...
              if (n.signatures && '' != n.name)
                if ('' == t) t = n.name;
                  ...
                  var i = new Error(
                    'Function names do not match (expected: ' + t + ', actual: ' + n.name + ')'
                  );
          ...
          function n(e, t, r, n, i) {
            var o,
              ...
              u = e || 'unnamed',
              c = s && d(s, 'any'),
              f = { fn: e, index: r, actual: n, expected: s };
            o = s
              ? t > r && !c
                ...
                : 'Too few arguments in function ' +
                  ...
                  r +
                  ')'
              : 'Too many arguments in function ' + u + ' (expected: ' + r + ', actual: ' + t + ')';
            var l = new TypeError(o);
            return (l.data = f), l;
          }
          function i(e) {
          ...
          function u(e) {
            ...
            for (
              ...
              if (((t = i[r]), t.varArgs))
                for (var h = t.params.length - 1, m = t.params[h], g = 0; g < m.types.length; ) {
                  if (m.conversions[g])
                    for (var v = m.types[g], y = 0; y < i.length; y++) {
                      var x = i[y],
                        b = x.params[h];
                      if (x !== t && b && d(b.types, v) && !b.conversions[h]) {
                        m.types.splice(g, 1), m.conversions.splice(g, 1), g--;
                        break;
                      }
                    }
                  g++;
          ...
          function f(e, t) {
            ...
            for (r = 0; r < e.length; r++)
              (n = e[r]), n.params.length !== a || i || (i = n), void 0 != n.params[a] && u.push(n);
            u.sort(function (e, t) {
              return o.compare(e.params[a], t.params[a]);
            });
            var c = [];
            for (r = 0; r < u.length; r++) {
              n = u[r];
              ...
              if (p) {
                if (p.param.varArgs)
                  throw new Error('Conflicting types "' + p.param + '" and "' + l + '"');
                p.signatures.push(n);
            ...
            for (r = 0; r < c.length; r++) {
              var m = c[r];
              h[r] = f(m.signatures, t.concat(m.param));
            }
            return new s(t, i, h);
          }
          function l(e) {
          ...
          function p(e, t) {
            ...
            var a = f(o, []),
              ...
              p = e || '',
              m = l(h(o));
            s.push('function ' + p + '(' + m.join(', ') + ') {'),
              s.push('  "use strict";'),
              s.push("  var name = '" + p + "';"),
              s.push(a.toCode(r, '  ')),
              s.push('}');
            var d = [r.toCode(), 'return ' + s.join('\n')].join('\n'),
              g = new Function(r.name, 'createError', d),
              v = g(r, n);
            return (v.signatures = c(o)), v;
          }
          function h(e) {
          ...
          function g(e, t) {
            ...
            if (o) return o;
            throw new TypeError(
              'Signature not found (signature: ' + (e.name || 'unnamed') + '(' + r.join(', ') + '))'
            );
          }
          function v(e, t) {
            var r = m(e);
          ...
          (i.prototype.add = function (e, t) {
              ...
              for (var n in r)
                if (r.hasOwnProperty(n))
                  for (var i = r[n], o = 0; o < i.length; o++)
                    e.push('var ' + n + o + ' = ' + t + "['" + n + "'][" + o + '];');
              return e.join('\n');
            }),
            (o.compare = function (e, t) {
              if (e.anyType) return 1;
              if (t.anyType) return -1;
              if (d(e.types, 'Object')) return 1;
              if (d(t.types, 'Object')) return -1;
              if (e.hasConversions()) {
                if (t.hasConversions()) {
                  var r, n, i;
            ...
            (o.prototype.overlapping = function (e) {
              for (var t = 0; t < this.types.length; t++) if (d(e.types, this.types[t])) return !0;
              return !1;
            }),
                ...
                if (n.length < r.params.length) {
                  ...
                  if (c.varArgs) {
                    for (s = c.clone(), i = 0; i < N.conversions.length; i++)
                      if (((u = N.conversions[i]), !d(c.types, u.from) && d(c.types, u.to))) {
                        var f = s.types.length;
                        (s.types[f] = u.from), (s.conversions[f] = u);
                      }
                    e(r, n.concat(s));
                  } else {
                    for (i = 0; i < c.types.length; i++) e(r, n.concat(new o(c.types[i])));
                    for (i = 0; i < N.conversions.length; i++)
                      (u = N.conversions[i]),
                        !d(c.types, u.from) &&
                          d(c.types, u.to) &&
                          ((s = new o(u.from)), (s.conversions[0] = u), e(r, n.concat(s)));
                  }
                } else t.push(new a(n, r.fn));
              }
              var t = [];
              return e(this, []), t;
            }),
            (a.compare = function (e, t) {
              ...
              var r,
                ...
                a = 0;
              for (r = 0; n > r; r++)
                e.params[r].hasConversions() && i++, t.params[r].hasConversions() && a++;
              if (i > a) return 1;
              if (a > i) return -1;
              for (r = 0; r < e.params.length; r++) {
                var s = o.compare(e.params[r], t.params[r]);
                if (0 !== s) return s;
              }
              return 0;
            }),
            ...
            (a.prototype.toCode = function (e, t) {
              for (
                var r = [], n = new Array(this.params.length), i = 0;
                ...
                o.varArgs
                  ? (n[i] = 'varArgs')
                  : a
                  ? (n[i] = e.add(a.convert, 'convert') + '(arg' + i + ')')
                  : (n[i] = 'arg' + i);
              }
            ...
            (s.prototype.toCode = function (e, r, n) {
              var i = [];
              if (this.param) {
                var o = this.path.length - 1,
                  a = this.param.conversions[0],
                  s = '// type: ' + (a ? a.from + ' (convert to ' + a.to + ')' : this.param);
                if (this.param.varArgs)
                  if (this.param.anyType)
                    i.push(r + 'if (arguments.length > ' + o + ') {'),
                      i.push(r + '  var varArgs = [];'),
                      i.push(r + '  for (var i = ' + o + '; i < arguments.length; i++) {'),
                      i.push(r + '    varArgs.push(arguments[i]);'),
                      i.push(r + '  }'),
                      i.push(this.signature.toCode(e, r + '  ')),
                      i.push(r + '}');
                  else {
                    for (
                      var u = function (r, n) {
                          for (var i = [], o = 0; o < r.length; o++)
                            i[o] = e.add(t(r[o]), 'test') + '(' + n + ')';
                          return i.join(' || ');
                        }.bind(this),
                        c = this.param.types,
                        f = [],
                      ...
                      void 0 === this.param.conversions[l] && f.push(c[l]);
                    i.push(r + 'if (' + u(c, 'arg' + o) + ') { ' + s),
                      i.push(r + '  var varArgs = [arg' + o + '];'),
                      i.push(r + '  for (var i = ' + (o + 1) + '; i < arguments.length; i++) {'),
                      i.push(r + '    if (' + u(f, 'arguments[i]') + ') {'),
                      i.push(r + '      varArgs.push(arguments[i]);');
                    for (var l = 0; l < c.length; l++) {
                      var p = this.param.conversions[l];
                      if (p) {
                        var h = e.add(t(c[l]), 'test'),
                          m = e.add(p.convert, 'convert');
                        i.push(r + '    }'),
                          i.push(r + '    else if (' + h + '(arguments[i])) {'),
                          i.push(r + '      varArgs.push(' + m + '(arguments[i]));');
                      }
                    }
                    i.push(r + '    } else {'),
                      i.push(
                  ...
                  i.push(r + '// type: any'), i.push(this._innerCode(e, r, n));
                else {
                  var d = this.param.types[0],
                    h = 'any' !== d ? e.add(t(d), 'test') : null;
                  i.push(r + 'if (' + h + '(arg' + o + ')) { ' + s),
                    i.push(this._innerCode(e, r + '  ', n)),
                    i.push(r + '}');
                }
            ...
            (s.prototype._innerCode = function (e, t, r) {
              var n,
                i = [];
              this.signature &&
                (i.push(t + 'if (arguments.length === ' + this.path.length + ') {'),
                i.push(this.signature.toCode(e, t + '  ')),
                i.push(t + '}'));
              var o;
              ...
              for (n = 0; n < this.childs.length; n++) i.push(this.childs[n].toCode(e, t, o));
              r && !this.param.anyType && i.push(r.toCode(e, t, o));
              var a = this._exceptions(e, t);
            ...
            (s.prototype._exceptions = function (e, t) {
              ...
              for (var n = {}, i = [], o = 0; o < this.childs.length; o++) {
                var a = this.childs[o];
                if (a.param)
                  for (var s = 0; s < a.param.types.length; s++) {
                    var u = a.param.types[s];
                    u in n || a.param.conversions[s] || ((n[u] = !0), i.push(u));
                  }
              }
              return (
                t +
          ...
          var y = [
            ...
            b = [],
            w = [],
            N = { config: x, types: y, conversions: b, ignore: w };
          return (
            (N = p('typed', {
              Object: function (e) {
                var t = [];
              ...
              'string, Object': p,
              '...Function': function (e) {
                for (var t, n = r(e), i = {}, o = 0; o < e.length; o++) {
                  var a = e[o];
                  if ('object' != typeof a.signatures)
                    throw (
                      ((t = new TypeError('Function is no typed-function (index: ' + o + ')')),
                      (t.data = { index: o }),
                      t)
                    );
                  for (var s in a.signatures)
                    if (a.signatures.hasOwnProperty(s))
                      if (i.hasOwnProperty(s)) {
                        if (a.signatures[s] !== i[s])
                          throw (
                            ((t = new Error('Signature "' + s + '" is defined twice')),
                            (t.data = { signature: s }),
                            t)
                          );
        ...
        (t.format = function (e, r) {
          ...
          switch (
            (r &&
              ...
              t.isNumber(r) ? (i = r) : r.precision && (i = r.precision)),
            n)
          ) {
            case 'fixed':
            ...
            case 'auto':
              return t
                .toPrecision(e, i, r && r.exponential)
            ...
            default:
              throw new Error(
                'Unknown notation "' + n + '". Choose "auto", "exponential", or "fixed".'
              );
          }
        }),
    ...
    function (e, t) {
      ...
      function r(e) {
        ...
        (i += -1 !== o ? o - 1 : n.length - 1),
          ...
          0 === this.coefficients.length && (this.coefficients.push(0), i++),
          (this.exponent = i);
      }
      function n(e) {
      ...
      (r.prototype.toEngineering = function (e) {
        var t = this.roundDigits(e),
          r = t.exponent,
          i = t.coefficients,
          o = r % 3 === 0 ? r : 0 > r ? r - 3 - (r % 3) : r - (r % 3),
          a = r >= 0 ? r : Math.abs(o);
        i.length - 1 < a && (i = i.concat(n(a - (i.length - 1))));
        for (var s = Math.abs(r - o), u = 1, c = ''; --s >= 0; ) u++;
        var f = i.slice(u).join(''),
          l = f.match(/[1-9]/) ? '.' + f : '';
        return (
          (c = i.slice(0, u).join('') + l),
          (c += 'e' + (r >= 0 ? '+' : '') + o.toString()),
          t.sign + c
        );
      }),
        (r.prototype.toFixed = function (e) {
          var t = this.roundDigits(this.exponent + 1 + (e || 0)),
            ...
            o = i + (e || 0);
          return (
            r.length < o && (r = r.concat(n(o - r.length))),
            0 > i && ((r = n(-i + 1).concat(r)), (i = 1)),
            e && r.splice(i, 0, 0 === i ? '0.' : '.'),
            this.sign + r.join('')
          );
        }),
        (r.prototype.toExponential = function (e) {
          ...
          var o = r.shift();
          return (
            this.sign + o + (r.length > 0 ? '.' + r.join('') : '') + 'e' + (i >= 0 ? '+' : '') + i
          );
        }),
        (r.prototype.toPrecision = function (e, t) {
          var r = t && void 0 !== t.lower ? t.lower : 0.001,
            i = t && void 0 !== t.upper ? t.upper : 1e5,
            o = Math.abs(Math.pow(10, this.exponent));
          if (r > o || o >= i) return this.toExponential(e);
          var a = e ? this.roundDigits(e) : this.clone(),
            s = a.coefficients,
            u = a.exponent;
          s.length < e && (s = s.concat(n(e - s.length))),
            (s = s.concat(n(u - s.length + 1 + (s.length < e ? e - s.length : 0)))),
            (s = n(-u).concat(s));
          var c = u > 0 ? u : 0;
        ...
        (r.prototype.clone = function () {
          ...
          return (
            (e.sign = this.sign),
            (e.coefficients = this.coefficients.slice(0)),
      ...
      function n(e, t, r, n, u) {
        ...
        function f(e, t, r) {
          if ((r.wrap && 'function' == typeof t && (t = p(t)), d(u[e]) && d(t)))
            return (
              (t = r.override ? n(e, t.signatures) : n(u[e], t)),
              (u[e] = t),
              l(e, t),
              void u.emit('import', e, function () {
                return t;
              })
            );
        ...
        function h(e, t) {
          if ('string' == typeof e.name) {
            var o = e.name,
              s = e.path ? a(u, e.path) : u,
              c = s.hasOwnProperty(o) ? s[o] : void 0,
              f = function () {
                var i = r(e);
                if (d(c) && d(i)) return t.override || (i = n(c, i)), i;
                if (void 0 === c || t.override) return i;
                if (!t.silent) throw new Error('Cannot import "' + o + '": already exists');
              };
            e.lazy !== !1 ? i(s, o, f) : (s[o] = f()), u.emit('import', o, f, e.path);
          } else r(e);
        }
        function m(e) {
          return (
    ...
    function (e, t) {
      ...
      (r.prototype = new Error()),
        (r.prototype.constructor = Error),
        (r.prototype.name = 'ArgumentsError'),
        (r.prototype.isArgumentsError = !0),
        (e.exports = r);
    },
    function (e, t, r) {
      'use strict';
    ...
    function (e, t, r) {
      e.exports = [r(14), r(100), r(102), r(335), r(499), r(501)];
    },
    function (e, t, r) {
    ...
    function (e, t, r) {
      function n(e, t, r, n, o) {
        var a = i.clone({ precision: t.precision });
        return (
          ...
          o.on('config', function (e, t) {
            e.precision !== t.precision && a.config({ precision: e.precision });
          }),
          a
        );
      }
    ...
    function (e, t, r) {
      ...
      !(function (i) {
        ...
        function o(e) {
          ...
          if (i > 0) {
            for (o += a, t = 1; i > t; t++)
              (n = e[t] + ''), (r = Pe - n.length), r && (o += g(r)), (o += n);
            (a = e[t]), (n = a + ''), (r = Pe - n.length), r && (o += g(r));
        ...
        function s(e, t, r, n) {
          ...
          return (
            --t < 0 ? ((t += Pe), (i = 0)) : ((i = Math.ceil((t + 1) / Pe)), (t %= Pe)),
            (o = Ce(10, Pe - t)),
            (s = e[i] % o | 0),
            null == n
              ? 3 > t
                ? (0 == t ? (s = (s / 100) | 0) : 1 == t && (s = (s / 10) | 0),
                  (a = (4 > r && 99999 == s) || (r > 3 && 49999 == s) || 5e4 == s || 0 == s))
                : (a =
                    (((4 > r && s + 1 == o) || (r > 3 && s + 1 == o / 2)) &&
                      ((e[i + 1] / o / 100) | 0) == Ce(10, t - 2) - 1) ||
                    ((s == o / 2 || 0 == s) && 0 == ((e[i + 1] / o / 100) | 0)))
              : 4 > t
              ? (0 == t
                  ? (s = (s / 1e3) | 0)
                  : 1 == t
                  ? (s = (s / 100) | 0)
                  : 2 == t && (s = (s / 10) | 0),
                (a = ((n || 4 > r) && 9999 == s) || (!n && r > 3 && 4999 == s)))
              : (a =
                  (((n || 4 > r) && s + 1 == o) || (!n && r > 3 && s + 1 == o / 2)) &&
                  ((e[i + 1] / o / 1e3) | 0) == Ce(10, t - 3) - 1),
            a
          );
        }
        function u(e, t, r) {
          for (var n, i, o = [0], a = 0, s = e.length; s > a; ) {
            ...
            for (o[0] += xe.indexOf(e.charAt(a++)), n = 0; n < o.length; n++)
              o[n] > r - 1 &&
                (void 0 === o[n + 1] && (o[n + 1] = 0), (o[n + 1] += (o[n] / r) | 0), (o[n] %= r));
          }
          return o.reverse();
        }
        function c(e, t) {
          var r,
            ...
            i = t.d.length;
          32 > i
            ? ((r = Math.ceil(i / 3)), (n = Math.pow(4, -r).toString()))
        ...
        function f(e, t, r, n) {
          ...
          e: if (null != t) {
            ...
            if (((o = t - i), 0 > o))
              (o += Pe), (a = t), (f = l[(p = 0)]), (u = (f / Ce(10, i - a - 1)) % 10 | 0);
            else if (((p = Math.ceil((o + 1) / Pe)), (s = l.length), p >= s)) {
              if (!n) break e;
              for (; s++ <= p; ) l.push(0);
              (f = u = 0), (i = 1), (o %= Pe), (a = o - Pe + 1);
            } else {
              for (f = s = l[p], i = 1; s >= 10; s /= 10) i++;
              (o %= Pe), (a = o - Pe + i), (u = 0 > a ? 0 : (f / Ce(10, i - a - 1)) % 10 | 0);
            }
            if (
              ((n = n || 0 > t || void 0 !== l[p + 1] || (0 > a ? f : f % Ce(10, i - a - 1))),
              (c =
                4 > r
                  ? (u || n) && (0 == r || r == (e.s < 0 ? 3 : 2))
                  : u > 5 ||
                    (5 == u &&
                      (4 == r ||
                        n ||
                        (6 == r && (o > 0 ? (a > 0 ? f / Ce(10, i - a) : 0) : l[p - 1]) % 10 & 1) ||
                        r == (e.s < 0 ? 8 : 7)))),
              1 > t || !l[0])
            )
              return (
                (l.length = 0),
                c
                  ? ((t -= e.e + 1), (l[0] = Ce(10, (Pe - (t % Pe)) % Pe)), (e.e = -t || 0))
                  : (l[0] = e.e = 0),
                e
              );
            if (
              (0 == o
                ...
                : ((l.length = p + 1),
                  (s = Ce(10, Pe - o)),
                  (l[p] = a > 0 ? ((f / Ce(10, i - a)) % Ce(10, a) | 0) * s : 0)),
              c)
            )
              for (;;) {
                if (0 == p) {
                  ...
                  o != s && (e.e++, l[0] == Ie && (l[0] = 1));
                  break;
                }
                if (((l[p] += s), l[p] != Ie)) break;
                (l[p--] = 0), (s = 1);
              }
        ...
        function l(e, t, r) {
          ...
          return (
            t
              ? (r && (n = r - s) > 0
                  ? (a = a.charAt(0) + '.' + a.slice(1) + g(n))
                  : s > 1 && (a = a.charAt(0) + '.' + a.slice(1)),
                (a = a + (e.e < 0 ? 'e' : 'e+') + e.e))
              : 0 > i
              ? ((a = '0.' + g(-i - 1) + a), r && (n = r - s) > 0 && (a += g(n)))
              : i >= s
              ? ((a += g(i + 1 - s)), r && (n = r - i - 1) > 0 && (a = a + '.' + g(n)))
              : ((n = i + 1) < s && (a = a.slice(0, n) + '.' + a.slice(n)),
                r && (n = r - s) > 0 && (i + 1 === s && (a += '.'), (a += g(n)))),
            a
          );
        }
        function p(e, t) {
          for (var r = 1, n = e[0]; n >= 10; n /= 10) r++;
          return r + t * Pe - 1;
        }
        function h(e, t, r) {
          if (t > Ue) throw ((Me = !0), r && (e.precision = r), Error(_e));
          return f(new e(be), t, 1, !0);
        }
        function m(e, t, r) {
          if (t > qe) throw Error(_e);
        ...
        function v(e, t, r, n) {
          var i,
            ...
            a = Math.ceil(n / Pe + 4);
          for (Me = !1; ; ) {
            if ((r % 2 && ((o = o.times(t)), C(o.d, a) && (i = !0)), (r = Te(r / 2)), 0 === r)) {
        ...
        function b(e, t) {
          ...
          for (null == t ? ((Me = !1), (l = v)) : (l = t), c = new d(0.03125); e.e > -2; )
            (e = e.times(c)), (m += 5);
          for (
            n = ((Math.log(Ce(2, m)) / Math.LN10) * 2 + 5) | 0,
              l += n,
              r = a = u = new d(1),
              d.precision = l;
            ;
            ...
            if (
              ...
              (r = r.times(++h)),
              (c = u.plus(je(a, r, l, 1))),
              o(c.d).slice(0, l) === o(u.d).slice(0, l))
            ) {
              for (i = m; i--; ) u = f(u.times(u), l, 1);
              if (null != t) return (d.precision = v), u;
              if (!(3 > p && s(u.d, l - n, g, p))) return f(u, (d.precision = v), g, (Me = !0));
              (d.precision = l += 10), (r = a = c = new d(1)), (h = 0), p++;
            }
            u = c;
          }
        }
        function w(e, t) {
          var r,
            ...
            E = N.rounding,
            M = N.precision;
          if (x.s < 0 || !b || !b[0] || (!x.e && 1 == b[0] && 1 == b.length))
            return new N(b && !b[0] ? -1 / 0 : 1 != x.s ? NaN : b ? 0 : x);
          if (
            (null == t ? ((Me = !1), (m = M)) : (m = t),
            (N.precision = m += y),
            (r = o(b)),
            ...
            return (
              (p = h(N, m + 2, M).times(a + '')),
              (x = w(new N(n + '.' + r.slice(1)), m - y).plus(p)),
              (N.precision = M),
              null == t ? f(x, M, E, (Me = !0)) : x
            );
          for (; (7 > n && 1 != n) || (1 == n && r.charAt(1) > 3); )
            (x = x.times(e)), (r = o(x.d)), (n = r.charAt(0)), v++;
          for (
            a = x.e,
              n > 1 ? ((x = new N('0.' + r)), a++) : (x = new N(n + '.' + r.slice(1))),
              d = x,
              l = u = x = je(x.minus(1), x.plus(1), m, 1),
              g = f(x.times(x), m, 1),
              i = 3;
            ;
            ...
            if (
              ((u = f(u.times(g), m, 1)),
              (p = l.plus(je(u, new N(i), m, 1))),
              o(p.d).slice(0, m) === o(l.d).slice(0, m))
            ) {
              if (
                ((l = l.times(2)),
                0 !== a && (l = l.plus(h(N, m + 2, M).times(a + ''))),
                (l = je(l, new N(v), m, 1)),
                null != t)
              )
                return (N.precision = M), l;
              if (!s(l.d, m - y, E, c)) return f(l, (N.precision = M), E, (Me = !0));
              (N.precision = m += y),
                (p = u = x = je(d.minus(1), d.plus(1), m, 1)),
                (g = f(x.times(x), m, 1)),
                (i = c = 1);
            }
            (l = p), (i += 2);
        ...
        function E(e, t) {
          ...
          for (
            (r = t.indexOf('.')) > -1 && (t = t.replace('.', '')),
              (n = t.search(/e/i)) > 0
                ? (0 > r && (r = n), (r += +t.slice(n + 1)), (t = t.substring(0, n)))
                : 0 > r && (r = t.length),
              n = 0;
            48 === t.charCodeAt(n);
            n++
        ...
        function M(e, t) {
          var r, n, i, o, a, s, c, f, l;
          if ('Infinity' === t || 'NaN' === t)
            return +t || (e.s = NaN), (e.e = NaN), (e.d = null), e;
          if (ze.test(t)) (r = 16), (t = t.toLowerCase());
          else if (Se.test(t)) r = 2;
          else {
            if (!Be.test(t)) throw Error(Oe + t);
            r = 8;
          }
          for (
            o = t.search(/p/i),
              o > 0 ? ((c = +t.slice(o + 1)), (t = t.substring(2, o))) : (t = t.slice(2)),
              o = t.indexOf('.'),
              a = o >= 0,
              n = e.constructor,
              a &&
          ...
          return 0 > o
            ...
            : ((e.e = p(f, l)),
              ...
              (Me = !1),
              a && (e = je(e, i, 4 * s)),
              c && (e = e.times(Math.abs(c) < 54 ? Math.pow(2, c) : Ne.pow(2, c))),
              (Me = !0),
              e);
        }
        function A(e, t) {
        ...
        function O(e, t, r, n, i) {
          var o,
            ...
            f = e.precision,
            l = Math.ceil(f / Pe);
          for (Me = !1, u = r.times(r), s = new e(n); ; ) {
            if (
              ((a = je(s.times(u), new e(t++ * t++), f, 1)),
              (s = i ? n.plus(a) : n.minus(a)),
              (n = je(a.times(u), new e(t++ * t++), f, 1)),
              (a = s.plus(n)),
              void 0 !== a.d[l])
            ) {
        ...
        function _(e, t) {
          var r,
            ...
            i = m(e, e.precision, 1),
            o = i.times(0.5);
          if (((t = t.abs()), t.lte(o))) return (ge = n ? 4 : 1), t;
          if (((r = t.divToInt(i)), r.isZero())) ge = n ? 3 : 2;
          else {
            if (((t = t.minus(r.times(i))), t.lte(o)))
              return (ge = y(r) ? (n ? 2 : 3) : n ? 4 : 1), t;
            ge = y(r) ? (n ? 1 : 4) : n ? 3 : 2;
          }
        ...
        function T(e, t, r, n) {
          ...
          if (
            (v
              ? (a(r, 1, ye), void 0 === n ? (n = g.rounding) : a(n, 0, 8))
            ...
            for (
              h = l(e),
                s = h.indexOf('.'),
                v ? ((i = 2), 16 == t ? (r = 4 * r - 3) : 8 == t && (r = 3 * r - 2)) : (i = t),
                s >= 0 &&
                  ((h = h.replace('.', '')),
                  (d = new g(1)),
                  (d.e = h.length - s),
            ...
            if (m[0]) {
              if (
                ...
                (p =
                  4 > n
                    ? (void 0 !== s || p) && (0 === n || n === (e.s < 0 ? 3 : 2))
                    : s > c ||
                      (s === c &&
                        (4 === n || p || (6 === n && 1 & m[r - 1]) || n === (e.s < 0 ? 8 : 7)))),
                (m.length = r),
                p)
              )
                for (; ++m[--r] > i - 1; ) (m[r] = 0), r || (++o, m.unshift(1));
              for (f = m.length; !m[f - 1]; --f);
              for (s = 0, h = ''; f > s; s++) h += xe.charAt(m[s]);
              if (v) {
                if (f > 1)
                  if (16 == t || 8 == t) {
                    for (s = 16 == t ? 4 : 3, --f; f % s; f++) h += '0';
                    for (m = u(h, i, t), f = m.length; !m[f - 1]; --f);
                    for (s = 1, h = '1.'; f > s; s++) h += xe.charAt(m[s]);
              ...
              else f > o && (h = h.slice(0, o) + '.' + h.slice(o));
            } else h = v ? '0p+0' : '0';
        ...
        function q(e, t) {
          ...
          return (
            e.s && t.s
              ? e.d || t.d
                ? !t.d || e.isZero()
                  ? ((r = t.s < 0 ? m(this, n, i) : new this(0)), (r.s = e.s))
                  : !e.d || t.isZero()
                  ? ((r = m(this, o, 1).times(0.5)), (r.s = e.s))
                  : t.s < 0
                  ? ((this.precision = o),
                    (this.rounding = 1),
                    (r = this.atan(je(e, t, o, 1))),
                    (t = m(this, o, 1)),
                    (this.precision = n),
                    (this.rounding = i),
                    (r = e.s < 0 ? r.minus(t) : r.plus(t)))
                  : (r = this.atan(je(e, t, o, 1)))
                : ((r = m(this, o, 1).times(t.s > 0 ? 0.25 : 0.75)), (r.s = e.s))
              : (r = new this(NaN)),
            r
          );
        }
        ...
        function F(e) {
          if (!e || 'object' != typeof e) throw Error(Ae + 'Object expected');
          var t,
            r,
            n,
            i = [
          ...
          for (t = 0; t < i.length; t += 3)
            if (void 0 !== (n = e[(r = i[t])])) {
              if (!(Te(n) === n && n >= i[t + 1] && n <= i[t + 2])) throw Error(Oe + r + ': ' + n);
              this[r] = n;
            }
          if (e.hasOwnProperty((r = 'crypto')))
            if (void 0 === (n = e[r])) this[r] = n;
            else {
              if (n !== !0 && n !== !1 && 0 !== n && 1 !== n) throw Error(Oe + r + ': ' + n);
              this[r] = !(!n || !Ee || (!Ee.getRandomValues && !Ee.randomBytes));
            }
          return this;
        }
        function D(e) {
        ...
        function G(e) {
          function t(e) {
            ...
            if (((o.constructor = t), e instanceof t))
              return (o.s = e.s), (o.e = e.e), void (o.d = (e = e.d) ? e.slice() : e);
            if (((i = typeof e), 'number' === i)) {
              if (0 === e) return (o.s = 0 > 1 / e ? -1 : 1), (o.e = 0), void (o.d = [0]);
              if ((0 > e ? ((e = -e), (o.s = -1)) : (o.s = 1), e === ~~e && 1e7 > e)) {
                for (r = 0, n = e; n >= 10; n /= 10) r++;
                return (o.e = r), void (o.d = [e]);
              }
              return 0 * e !== 0
                ? (e || (o.s = NaN), (o.e = NaN), void (o.d = null))
                : E(o, e.toString());
            }
            if ('string' !== i) throw Error(Oe + e);
            return (
              45 === e.charCodeAt(0) ? ((e = e.slice(1)), (o.s = -1)) : (o.s = 1),
              ke.test(e) ? E(o, e) : M(o, e)
            );
          }
          var r, n, i;
          if (
        ...
        function Y(e) {
          var t, r, n, i;
          if ('string' != typeof e || !e) throw Error(Oe + e);
          if (((n = e.length), (i = xe.indexOf(e.charAt(0))), 1 === n))
            return new this(i > 81 ? [-1 / 0, 1 / 0, NaN][i - 82] : i > 40 ? -(i - 41) : i);
          if (64 & i) (r = 16 & i), (t = r ? (7 & i) - 3 : (15 & i) - 7), (n = 1);
          else {
            if (2 === n)
              return (
                (i = 88 * i + xe.indexOf(e.charAt(1))),
                new this(i >= 2816 ? -(i - 2816) - 41 : i + 41)
              );
            if (((r = 32 & i), !(31 & i)))
              return (e = u(e.slice(1), 88, 10).join('')), new this(r ? '-' + e : e);
            (t = 15 & i),
              (n = t + 1),
              (t =
                1 === t
                  ? xe.indexOf(e.charAt(1))
                  : 2 === t
                  ? 88 * xe.indexOf(e.charAt(1)) + xe.indexOf(e.charAt(2))
                  : +u(e.slice(1, n), 88, 10).join('')),
              16 & i && (t = -t);
          }
          return (
            (e = u(e.slice(n), 88, 10).join('')),
            (t = t - e.length + 1),
            (e = e + 'e' + t),
            new this(r ? '-' + e : e)
          );
        ...
        function W() {
          ...
          for (Me = !1, e = 0; e < arguments.length; )
            if (((t = new this(arguments[e++])), t.d)) r.d && (r = r.plus(t.times(t)));
              ...
              if (t.s) return (Me = !0), new this(1 / 0);
              r = t;
            }
          return (Me = !0), r.sqrt();
        }
        ...
        function oe(e) {
          var t,
            ...
            u = [];
          if (
            (void 0 === e ? (e = this.precision) : a(e, 1, ye),
            (n = Math.ceil(e / Pe)),
            this.crypto === !1)
          )
            for (; n > o; ) u[o++] = (1e7 * Math.random()) | 0;
          else if (Ee && Ee.getRandomValues)
            for (t = Ee.getRandomValues(new Uint32Array(n)); n > o; )
              (i = t[o]),
                i >= 429e7
                  ? (t[o] = Ee.getRandomValues(new Uint32Array(1))[0])
                  : (u[o++] = i % 1e7);
          else if (Ee && Ee.randomBytes) {
            for (t = Ee.randomBytes((n *= 4)); n > o; )
              (i = t[o] + (t[o + 1] << 8) + (t[o + 2] << 16) + ((127 & t[o + 3]) << 24)),
                i >= 214e7 ? Ee.randomBytes(4).copy(t, o) : (u.push(i % 1e7), (o += 4));
            o = n / 4;
          } else {
            if (this.crypto) throw Error(Ae + 'crypto unavailable');
            for (; n > o; ) u[o++] = (1e7 * Math.random()) | 0;
          }
          for (
            n = u[--o], e %= Pe, n && e && ((i = Ce(10, Pe - e)), (u[o] = ((n / i) | 0) * i));
            0 === u[o];
            o--
          )
            u.pop();
        ...
        (Le.absoluteValue = Le.abs =
          ...
          (Le.comparedTo = Le.cmp =
            function (e) {
              var t,
                ...
                c = e.s;
              if (!a || !s)
                return u && c ? (u !== c ? u : a === s ? 0 : !a ^ (0 > u) ? 1 : -1) : NaN;
              if (!a[0] || !s[0]) return a[0] ? u : s[0] ? -c : 0;
              if (u !== c) return u;
              if (o.e !== e.e) return (o.e > e.e) ^ (0 > u) ? 1 : -1;
              for (n = a.length, i = s.length, t = 0, r = i > n ? n : i; r > t; ++t)
                if (a[t] !== s[t]) return (a[t] > s[t]) ^ (0 > u) ? 1 : -1;
            ...
            function () {
              ...
              return r.d
                ? r.d[0]
                  ? ((e = n.precision),
                    (t = n.rounding),
                    (n.precision = e + Math.max(r.e, r.sd()) + Pe),
                    (n.rounding = 1),
                    (r = c(n, _(n, r))),
                    (n.precision = e),
                    (n.rounding = t),
                    f(2 == ge || 3 == ge ? r.neg() : r, e, t, !0))
                  : new n(1)
                : new n(NaN);
            }),
          (Le.cubeRoot = Le.cbrt =
            function () {
              ...
              for (
                Me = !1,
                  a = p.s * Math.pow(p.s * p, 1 / 3),
                  a && Math.abs(a) != 1 / 0
                    ? (n = new h(a.toString()))
                    : ((r = o(p.d)),
                      (e = p.e),
                      (a = (e - r.length + 1) % 3) && (r += 1 == a || -2 == a ? '0' : '00'),
                      (a = Math.pow(r, 1 / 3)),
                      (e = Te((e + 1) / 3) - (e % 3 == (0 > e ? -1 : 2))),
                      a == 1 / 0
                        ? (r = '5e' + e)
                        : ((r = a.toExponential()), (r = r.slice(0, r.indexOf('e') + 1) + e)),
                      (n = new h(r)),
                      (n.s = p.s)),
                  s = (e = h.precision) + 3;
                ;
                ...
                if (
                  ...
                  (c = u.times(u).times(u)),
                  (l = c.plus(p)),
                  (n = je(l.plus(p).times(u), l.plus(c), s + 2, 1)),
                  o(u.d).slice(0, s) === (r = o(n.d)).slice(0, s))
                ) {
                  if (((r = r.slice(s - 3, s + 1)), '9999' != r && (i || '4999' != r))) {
                    (+r && (+r.slice(1) || '5' != r.charAt(0))) ||
                      (f(n, e + 1, 1), (t = !n.times(n).times(n).eq(p)));
                    break;
                  }
          ...
          (Le.decimalPlaces = Le.dp =
            function () {
              var e,
                t = this.d,
                r = NaN;
              if (t) {
                if (((e = t.length - 1), (r = (e - Te(this.e / Pe)) * Pe), (e = t[e])))
                  for (; e % 10 == 0; e /= 10) r--;
                0 > r && (r = 0);
              }
              return r;
          ...
          (Le.dividedToIntegerBy = Le.divToInt =
            function (e) {
              var t = this,
                r = t.constructor;
              return f(je(t, new r(e), 0, 1, 1), r.precision, r.rounding);
            }),
          (Le.equals = Le.eq =
            function (e) {
              return 0 === this.cmp(e);
          ...
          (Le.greaterThan = Le.gt =
            function (e) {
              return this.cmp(e) > 0;
            }),
          (Le.greaterThanOrEqualTo = Le.gte =
            function (e) {
              var t = this.cmp(e);
              return 1 == t || 0 === t;
            }),
          (Le.hyperbolicCosine = Le.cosh =
            function () {
              var e,
                t,
                r,
              ...
              (r = a.precision),
                ...
                (i = o.d.length),
                32 > i
                  ? ((e = Math.ceil(i / 3)), (t = Math.pow(4, -e).toString()))
                  : ((e = 16), (t = '2.3283064365386962890625e-10')),
                (o = O(a, 1, o.times(t), new a(1), !0));
              for (var u, c = e, l = new a(8); c--; )
                (u = o.times(o)), (o = s.minus(u.times(l.minus(u.times(l)))));
              return f(o, (a.precision = r), (a.rounding = n), !0);
            }),
          (Le.hyperbolicSine = Le.sinh =
            function () {
              var e,
                t,
                r,
              ...
              return r.isFinite()
                ? r.isZero()
                  ...
                  : ((e = n.precision),
                    ...
                    (n.precision = e + 7),
                    (n.rounding = 1),
                    je(r.sinh(), r.cosh(), (n.precision = e), (n.rounding = t)))
                : new n(r.s);
            }),
          (Le.inverseCosine = Le.acos =
            function () {
              var e,
                t = this,
                r = t.constructor,
              ...
              return -1 !== n
                ...
                : ((r.precision = i + 6),
                  (r.rounding = 1),
                  (t = t.asin()),
                  (e = m(r, i + 4, o).times(0.5)),
                  (r.precision = i),
                  (r.rounding = o),
                  e.minus(t));
            }),
          (Le.inverseHyperbolicCosine = Le.acosh =
            function () {
              var e,
                t,
                r = this,
          ...
          (Le.inverseHyperbolicSine = Le.asinh =
            function () {
              var e,
                t,
                r = this,
          ...
          (Le.inverseHyperbolicTangent = Le.atanh =
            function () {
              var e,
                t,
                r,
                ...
                ? i.e >= 0
                  ...
                  : ((e = o.precision),
                    ...
                    Math.max(n, e) < 2 * -i.e - 1
                      ? f(new o(i), e, t, !0)
                      : ((o.precision = r = n - i.e),
                        (i = je(i.plus(1), new o(1).minus(i), r + e, 1)),
                        (o.precision = e + 4),
                        (o.rounding = 1),
                        (i = i.ln()),
                        (o.precision = e),
            ...
            function () {
              ...
              return i.isZero()
                ...
                : ((t = i.abs().cmp(1)),
                  ...
                  -1 !== t
                    ? 0 === t
                      ? ((e = m(o, r + 4, n).times(0.5)), (e.s = i.s), e)
                      : new o(NaN)
                    : ((o.precision = r + 6),
                      (o.rounding = 1),
          ...
          (Le.inverseTangent = Le.atan =
            function () {
              ...
              if (c.isFinite()) {
                ...
                if (c.abs().eq(1) && qe >= p + 4)
                  return (a = m(l, p + 4, h).times(0.25)), (a.s = c.s), a;
              } else {
                if (!c.s) return new l(NaN);
                if (qe >= p + 4) return (a = m(l, p + 4, h).times(0.5)), (a.s = c.s), a;
              }
              for (
                l.precision = s = p + 10, l.rounding = 1, r = Math.min(28, (s / Pe + 2) | 0), e = r;
                e;
                --e
              )
                c = c.div(c.times(c).plus(1).sqrt().plus(1));
              for (
                Me = !1, t = Math.ceil(s / Pe), n = 1, u = c.times(c), a = new l(c), i = c;
                -1 !== e;
              ...
              return (
                r && (a = a.times(2 << (r - 1))),
                (Me = !0),
                f(a, (l.precision = p), (l.rounding = h), !0)
              );
            }),
          (Le.isFinite = function () {
            return !!this.d;
          }),
          (Le.isInteger = Le.isInt =
            function () {
          ...
          (Le.isNegative = Le.isNeg =
            function () {
              return this.s < 0;
            }),
          (Le.isPositive = Le.isPos =
            function () {
              return this.s > 0;
            }),
          (Le.isZero = function () {
              ...
              if (
                ...
                do
                  if (
                    ...
                    +o(l.d).slice(i + 1, i + 15) + 1 == 1e14 && (l = f(l, d + 1, 0));
                    break;
                  }
                while (s(l.d, (i += 10), g));
              return (Me = !0), f(l, d, g);
          ...
          (Le.minus = Le.sub =
            function (e) {
              ...
              if (((c = d.d), (m = e.d), (s = g.precision), (u = g.rounding), !c[0] || !m[0])) {
                if (m[0]) e.s = -e.s;
                else {
                  if (!c[0]) return new g(3 === u ? -0 : 0);
                  e = new g(d);
                }
                return Me ? f(e, s, u) : e;
              }
              if (((r = Te(e.e / Pe)), (l = Te(d.e / Pe)), (c = c.slice()), (o = l - r))) {
                for (
                  h = 0 > o,
                    h ? ((t = c), (o = -o), (a = m.length)) : ((t = m), (r = l), (a = c.length)),
                    n = Math.max(Math.ceil(s / Pe), a) + 2,
                    o > n && ((o = n), (t.length = 1)),
                    t.reverse(),
                    n = o;
                  n--;
                ...
                for (n = c.length, a = m.length, h = a > n, h && (a = n), n = 0; a > n; n++)
                  if (c[n] != m[n]) {
                    h = c[n] < m[n];
                    break;
                  }
              ...
              for (
                h && ((t = c), (c = m), (m = t), (e.s = -e.s)), a = c.length, n = m.length - a;
                n > 0;
                --n
              )
                c[a++] = 0;
            ...
            function (e) {
              ...
              return (
                ...
                !r.d || !e.s || (e.d && !e.d[0])
                  ...
                  : ((Me = !1),
                    9 == n.modulo
                      ? ((t = je(r, e.abs(), 0, 3, 1)), (t.s *= e.s))
                      : (t = je(r, e, 0, n.modulo, 1)),
                    (t = t.times(e)),
                    (Me = !0),
                    r.minus(t))
              );
            }),
          (Le.naturalExponential = Le.exp =
            function () {
              return b(this);
            }),
          (Le.naturalLogarithm = Le.ln =
            function () {
              return w(this);
            }),
          (Le.negated = Le.neg =
          ...
          (Le.plus = Le.add =
            function (e) {
              ...
              if (((e = new m(e)), !h.d || !e.d))
                return (
                  h.s && e.s ? h.d || (e = new m(e.d || h.s === e.s ? h : NaN)) : (e = new m(NaN)),
                  e
                );
              if (h.s != e.s) return (e.s = -e.s), h.minus(e);
              if (((c = h.d), (l = e.d), (s = m.precision), (u = m.rounding), !c[0] || !l[0]))
                return l[0] || (e = new m(h)), Me ? f(e, s, u) : e;
              if (((o = Te(h.e / Pe)), (n = Te(e.e / Pe)), (c = c.slice()), (i = o - n))) {
                for (
                  0 > i ? ((r = c), (i = -i), (a = l.length)) : ((r = l), (n = o), (a = c.length)),
                    o = Math.ceil(s / Pe),
                    a = o > a ? o + 1 : a + 1,
                    i > a && ((i = a), (r.length = 1)),
                    r.reverse();
              ...
              for (
                a = c.length,
                  i = l.length,
                  0 > a - i && ((i = a), (r = l), (l = c), (c = r)),
                  t = 0;
                i;

              )
                (t = ((c[--i] = c[i] + l[i] + t) / Ie) | 0), (c[i] %= Ie);
              for (t && (c.unshift(t), ++n), a = c.length; 0 == c[--a]; ) c.pop();
          ...
          (Le.precision = Le.sd =
            function (e) {
              var t,
                r = this;
              if (void 0 !== e && e !== !!e && 1 !== e && 0 !== e) throw Error(Oe + e);
              return r.d ? ((t = d(r.d)), e && r.e + 1 > t && (t = r.e + 1)) : (t = NaN), t;
            }),
          (Le.round = function () {
            var e = this,
              t = e.constructor;
              ...
              return r.isFinite()
                ? r.isZero()
                  ...
                  : ((e = n.precision),
                    ...
                    (n.precision = e),
                    (n.rounding = t),
                    f(ge > 2 ? r.neg() : r, e, t, !0))
                : new n(NaN);
            }),
          (Le.squareRoot = Le.sqrt =
            function () {
              var e,
                t,
                r,
                ...
                p = s.constructor;
              if (1 !== l || !u || !u[0])
                return new p(!l || (0 > l && (!u || u[0])) ? NaN : u ? s : 1 / 0);
              for (
                Me = !1,
                  l = Math.sqrt(+s),
                  0 == l || l == 1 / 0
                ...
                if (
                  ((a = n),
                  (n = a.plus(je(s, a, r + 2, 1)).times(0.5)),
                  o(a.d).slice(0, r) === (t = o(n.d)).slice(0, r))
                ) {
                  if (((t = t.slice(r - 3, r + 1)), '9999' != t && (i || '4999' != t))) {
                    (+t && (+t.slice(1) || '5' != t.charAt(0))) ||
                      (f(n, c + 1, 1), (e = !n.times(n).eq(s)));
                    break;
                  }
                  if (!i && (f(a, c + 1, 0), a.times(a).eq(s))) {
                    n = a;
                    break;
                  }
                  (r += 4), (i = 1);
              ...
              return r.isFinite()
                ? r.isZero()
                  ...
                  : ((e = n.precision),
                    ...
                    (r = r.sin()),
                    (r.s = 1),
                    (r = je(r, new n(1).minus(r.times(r)).sqrt(), e + 10, 0)),
                    (n.precision = e),
                    (n.rounding = t),
                    f(2 == ge || 4 == ge ? r.neg() : r, e, t, !0))
                : new n(NaN);
            }),
          (Le.times = Le.mul =
            function (e) {
              ...
              for (
                r = Te(l.e / Pe) + Te(e.e / Pe),
                  u = m.length,
                  c = d.length,
                  c > u && ((o = m), (m = d), (d = o), (a = u), (u = c), (c = a)),
                  o = [],
                  a = u + c,
                  n = a;
                n--;
              ...
              for (n = c; --n >= 0; ) {
                for (t = 0, i = u + n; i > n; )
                  (s = o[i] + d[n] * m[i - n - 1] + t), (o[i--] = s % Ie | 0), (t = (s / Ie) | 0);
                o[i] = (o[i] + t) % Ie | 0;
              }
              for (; !o[--a]; ) o.pop();
              for (t ? ++r : o.shift(), n = o.length; !o[--n]; ) o.pop();
              return (e.d = o), (e.e = p(o, r)), Me ? f(e, h.precision, h.rounding) : e;
            }),
          (Le.toBinary = function (e, t) {
            return T(this, 2, e, t);
          }),
          (Le.toDecimalPlaces = Le.toDP =
            function (e, t) {
              var r = this,
                n = r.constructor;
              return (
          ...
          (Le.toFraction = function (e) {
            ...
            if (
              ...
              (a = t.e = d(g) - m.e - 1),
              (s = a % Pe),
              (t.d[0] = Ce(10, 0 > s ? Pe + s : s)),
              null == e)
            )
              e = a > 0 ? t : f;
            else {
              if (((u = new v(e)), !u.isInt() || u.lt(f))) throw Error(Oe + u);
              e = u.gt(t) ? (a > 0 ? t : f) : u;
            }
            for (
              Me = !1, u = new v(o(g)), l = v.precision, v.precision = a = g.length * Pe * 2;
              (p = je(u, t, 0, 1, 1)), (i = r.plus(p.times(n))), 1 != i.cmp(e);
              ...
              (r = n),
                ...
                (u = i);
            return (
              (i = je(e.minus(r), n, 0, 1, 1)),
              (c = c.plus(i.times(f))),
              (r = r.plus(i.times(n))),
              (c.s = f.s = m.s),
              (h =
                je(f, n, a, 1).minus(m).abs().cmp(je(c, r, a, 1).minus(m).abs()) < 1
                  ? [f, n]
                  : [c, r]),
              (v.precision = l),
              (Me = !0),
          ...
          (Le.toJSON = function () {
            var e,
              ...
              f = this,
              l = f.s < 0;
            if (!f.d) return xe.charAt(f.s ? (l ? 82 : 83) : 84);
            if (((t = f.e), 1 === f.d.length && 4 > t && t >= 0 && ((a = f.d[0]), 2857 > a)))
              return 41 > a
                ? xe.charAt(l ? a + 41 : a)
                : ((a -= 41),
                  l && (a += 2816),
                  (n = (a / 88) | 0),
                  xe.charAt(n) + xe.charAt(a - 88 * n));
            if (((c = o(f.d)), (s = ''), !l && 8 >= t && t >= -7)) n = 64 + t + 7;
            else if (l && 4 >= t && t >= -3) n = 80 + t + 3;
            else if (c.length === t + 1) n = 32 * l;
            else if (((n = 32 * l + 16 * (0 > t)), (t = Math.abs(t)), 88 > t))
              (n += 1), (s = xe.charAt(t));
            else if (7744 > t)
              (n += 2), (a = (t / 88) | 0), (s = xe.charAt(a) + xe.charAt(t - 88 * a));
            else
              for (e = u(String(t), 10, 88), i = e.length, n += i, r = 0; i > r; r++)
                s += xe.charAt(e[r]);
          ...
          (Le.toNearest = function (e, t) {
            ...
            if (((r = new n(r)), null == e)) {
              ...
              if (((e = new n(e)), void 0 !== t && a(t, 0, 8), !r.d)) return e.s ? r : e;
          ...
          (Le.toPower = Le.pow =
            function (e) {
              var t,
                ...
                p = l.constructor,
                h = +(e = new p(e));
              if (!(l.d && e.d && l.d[0] && e.d[0])) return new p(Ce(+l, h));
              if (((l = new p(l)), l.eq(1))) return l;
              if (((n = p.precision), (a = p.rounding), e.eq(1))) return f(l, n, a);
              if (((t = Te(e.e / Pe)), (r = e.d.length - 1), (c = t >= r), (u = l.s), c)) {
                if ((r = 0 > h ? -h : h) <= Re)
                  return (i = v(p, l, r, n)), e.s < 0 ? new p(1).div(i) : f(i, n, a);
              } else if (0 > u) return new p(NaN);
              return (
                (u = 0 > u && 1 & e.d[Math.max(t, r)] ? -1 : 1),
                (r = Ce(+l, h)),
                (t =
                  0 != r && isFinite(r)
                    ? new p(r + '').e
                    : Te(h * (Math.log('0.' + o(l.d)) / Math.LN10 + l.e + 1))),
                t > p.maxE + 1 || t < p.minE - 1
                  ? new p(t > 0 ? u / 0 : 0)
                  : ((Me = !1),
                    (p.rounding = l.s = 1),
                    (r = Math.min(12, (t + '').length)),
                    (i = b(e.times(w(l, n + r)), n)),
                    (i = f(i, n + 5, 1)),
                    s(i.d, n, a) &&
                      ((t = n + 10),
                      (i = f(b(e.times(w(l, t + r)), t), t + 5, 1)),
                      +o(i.d).slice(n + 1, n + 15) + 1 == 1e14 && (i = f(i, n + 1, 0))),
                    (i.s = u),
                    (Me = !0),
                    (p.rounding = a),
                    f(i, n, a))
          ...
          (Le.toPrecision = function (e, t) {
            ...
            return (
              void 0 === e
                ? (r = l(n, n.e <= i.toExpNeg || n.e >= i.toExpPos))
                : (a(e, 1, ye),
                  void 0 === t ? (t = i.rounding) : a(t, 0, 8),
                  (n = f(new i(n), e, t)),
                  (r = l(n, e <= n.e || n.e <= i.toExpNeg, e))),
              n.isNeg() && !n.isZero() ? '-' + r : r
            );
          }),
          (Le.toSignificantDigits = Le.toSD =
            function (e, t) {
              var r = this,
                n = r.constructor;
              return (
                void 0 === e
                  ...
                  : (a(e, 1, ye), void 0 === t ? (t = n.rounding) : a(t, 0, 8)),
                f(new n(r), e, t)
              );
            }),
        ...
        var je = (function () {
          function e(e, t, r) {
            var n,
              i = 0,
              o = e.length;
            for (e = e.slice(); o--; ) (n = e[o] * t + i), (e[o] = n % r | 0), (i = (n / r) | 0);
          ...
          return function (n, i, o, a, s, u) {
            ...
            if (
              ...
              if (((E = (E / m + 2) | 0), (p = 0), 1 == T)) {
                ...
                for (
                  h = (u / (k[0] + 1)) | 0,
                    h > 1 && ((k = e(k, h, u)), (B = e(B, h, u)), (T = k.length), (O = B.length)),
                    A = T,
                    b = B.slice(0, T),
                    w = b.length;
                  T > w;
                  ...
                  b[w++] = 0;
                (C = k.slice()), C.unshift(0), (_ = k[0]), k[1] >= u / 2 && ++_;
                do
                  (h = 0),
                    (c = t(k, b, T, w)),
                    0 > c
                      ? ((N = b[0]),
                        ...
                        -1 == c &&
                          ((w = b.length),
                          (c = t(k, b, T, w)),
                          1 > c && (h++, r(b, w > T ? C : k, w, u))),
                        (w = b.length))
                      : 0 === c && (h++, (b = [0])),
                    (x[p++] = h),
                    c && b[0] ? (b[w++] = B[A] || 0) : ((b = [B[A]]), (w = 1));
                while ((A++ < O || void 0 !== b[0]) && E--);
                d = void 0 !== b[0];
              }
              x[0] || x.shift();
            }
            if (1 == m) (y.e = l), (de = d);
              ...
              for (p = 1, h = x[0]; h >= 10; h /= 10) p++;
              (y.e = p + l * m - 1), f(y, s ? o + y.e + 1 : o, a, d);
            }
            return y;
          };
        })();
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 0: '0', 1: '\\left(${args[0]}\\right)' }), o;
      }
      var i = r(19);
      ...
      function n(e, t, r, n, a) {
        ...
        return (
          ...
          (s.createProxy = function (e, t) {
            ...
            else for (var r in e) e.hasOwnProperty(r) && u(r, e[r]);
          }),
          s.createProxy(a),
          a.on('import', function (e, t, r) {
            void 0 === r && c(e, t);
          }),
          s
        );
    ...
    function (e, t, r) {
      ...
      (t.isString = function (e) {
        ...
        (t.format = function (e, r) {
          if ('number' == typeof e) return i(e, r);
          if (e && e.isBigNumber === !0) return o(e, r);
          if (e && e.isFraction === !0)
            return r && 'decimal' === r.fraction ? e.toString() : e.s * e.n + '/' + e.d;
          if (Array.isArray(e)) return n(e, r);
          if (t.isString(e)) return '"' + e + '"';
          if ('function' == typeof e) return e.syntax ? String(e.syntax) : 'function';
          if (e && 'object' == typeof e) {
            if ('function' == typeof e.format) return e.format(r);
            if (e && e.toString() !== {}.toString()) return e.toString();
            var a = [];
            for (var s in e) e.hasOwnProperty(s) && a.push('"' + s + '": ' + t.format(e[s], r));
            return '{' + a.join(', ') + '}';
          }
          return String(e);
        });
    ...
    function (e, t) {
      (t.format = function (e, r) {
        ...
        switch (
          (void 0 !== r &&
            (r.notation && (n = r.notation),
            'number' == typeof r ? (i = r) : r.precision && (i = r.precision)),
          n)
        ) {
          case 'fixed':
            return t.toFixed(e, i);
          ...
          case 'auto':
            ...
            r &&
              r.exponential &&
              (void 0 !== r.exponential.lower && (o = r.exponential.lower),
              void 0 !== r.exponential.upper && (a = r.exponential.upper));
            ...
            return (
              (s =
                u.gte(o) && u.lt(a) ? e.toSignificantDigits(i).toFixed() : t.toExponential(e, i)),
    ...
    function (e, t, r) {
            ...
            switch (arguments.length) {
              ...
              case 2:
                var r = arguments[0],
                  n = arguments[1];
                if (a(r)) {
                  if ((n && n.isUnit && n.hasBase('ANGLE') && (n = n.toNumber('rad')), a(n)))
                    return new i({ r: r, phi: n });
      ...
      var i = r(28),
        o = r(6).format,
        a = r(6).isNumber;
      (t.name = 'Complex'), (t.path = 'type'), (t.factory = n), (t.math = !0);
    },
    function (e, t, r) {
      var n, i;
      (function (e) {
        ...
        !(function (o) {
          ...
          function s(e, t) {
            return this instanceof s
              ? (f(e, t), (this.re = u.re), void (this.im = u.im))
              : new s(e, t);
          }
          var u = { re: 0, im: 0 };
          (Math.cosh =
          ...
          var c = function () {
            ...
            f = function (e, t) {
              if (void 0 === e || null === e) u.re = u.im = 0;
              else if (void 0 !== t) (u.re = e), (u.im = t);
              else
                switch (typeof e) {
                  case 'object':
                    'im' in e && 're' in e
                      ? ((u.re = e.re), (u.im = e.im))
                      : 'abs' in e && 'arg' in e
                      ? ((u.re = e.abs * Math.cos(e.arg)), (u.im = e.abs * Math.sin(e.arg)))
                      : 'r' in e && 'phi' in e
                      ? ((u.re = e.r * Math.cos(e.phi)), (u.im = e.r * Math.sin(e.phi)))
                      : c();
                    break;
                  case 'string':
                    u.im = u.re = 0;
                    ...
                    for (var o = 0; o < r.length; o++) {
                      ...
                      ' ' === a ||
                        ...
                        ('+' === a
                          ...
                          ? (n + i === 0 && c(),
                            ' ' === r[o + 1] || isNaN(r[o + 1])
                              ? (u.im += parseFloat((i % 2 ? '-' : '') + '1'))
                              : ((u.im += parseFloat((i % 2 ? '-' : '') + r[o + 1])), o++),
                            (n = i = 0))
                          : ((n + i === 0 || isNaN(a)) && c(),
                            'i' === r[o + 1] || 'I' === r[o + 1]
                              ? ((u.im += parseFloat((i % 2 ? '-' : '') + a)), o++)
                              : (u.re += parseFloat((i % 2 ? '-' : '') + a)),
                            (n = i = 0)));
                    }
                    n + i > 0 && c();
                    break;
          ...
          (s.prototype = {
            ...
            mul: function (e, t) {
              return (
                f(e, t),
                0 === u.im && 0 === this.im
                  ? new s(this.re * u.re, 0)
                  : new s(this.re * u.re - this.im * u.im, this.re * u.im + this.im * u.re)
              );
            },
            div: function (e, t) {
              f(e, t), (e = this.re), (t = this.im);
              var r,
                n,
                i = u.re,
                o = u.im;
              return 0 === i && 0 === o
                ? new s(0 !== e ? e / 0 : 0, 0 !== t ? t / 0 : 0)
                : 0 === o
                ? new s(e / i, t / i)
                : Math.abs(i) < Math.abs(o)
                ? ((n = i / o), (r = i * n + o), new s((e * n + t) / r, (t * n - e) / r))
                : ((n = o / i), (r = o * n + i), new s((e + t * n) / r, (t - e * n) / r));
            },
            pow: function (e, t) {
              if ((f(e, t), (e = this.re), (t = this.im), 0 === e && 0 === t)) return new s(0, 0);
              var r = Math.atan2(t, e),
                n = a(e, t);
              if (0 === u.im) {
                if (0 === t && e >= 0) return new s(Math.pow(e, u.re), 0);
                if (0 === e)
                  switch (u.re % 4) {
                    case 0:
                      return new s(Math.pow(t, u.re), 0);
                    case 1:
            ...
            sqrt: function () {
              ...
              return r >= 0 && 0 === n
                ? new s(Math.sqrt(r), 0)
                : ((e =
                    r >= 0 ? 0.5 * Math.sqrt(2 * (i + r)) : Math.abs(n) / Math.sqrt(2 * (i - r))),
                  (t =
                    0 >= r ? 0.5 * Math.sqrt(2 * (i - r)) : Math.abs(n) / Math.sqrt(2 * (i + r))),
                  new s(e, n >= 0 ? t : -t));
            },
            exp: function () {
            ...
            log: function () {
              var e = this.re,
                t = this.im;
              return new s(a(e, t), Math.atan2(t, e));
            },
            abs: function () {
              ...
              return 3e3 > e && 3e3 > t
                ? Math.sqrt(e * e + t * t)
                : (t > e ? ((e = t), (t = this.re / this.im)) : (t = this.im / this.re),
                  e * Math.sqrt(1 + t * t));
            },
            arg: function () {
            ...
            sin: function () {
              var e = this.re,
                t = this.im;
              return new s(Math.sin(e) * Math.cosh(t), Math.cos(e) * Math.sinh(t));
            },
            cos: function () {
              var e = this.re,
                t = this.im;
              return new s(Math.cos(e) * Math.cosh(t), -Math.sin(e) * Math.sinh(t));
            },
            tan: function () {
              var e = 2 * this.re,
                t = 2 * this.im,
                r = Math.cos(e) + Math.cosh(t);
              return new s(Math.sin(e) / r, Math.sinh(t) / r);
            },
            cot: function () {
              var e = 2 * this.re,
                t = 2 * this.im,
            ...
            sec: function () {
              var e = this.re,
                t = this.im,
                r = 0.5 * Math.cosh(2 * t) + 0.5 * Math.cos(2 * e);
              return new s((Math.cos(e) * Math.cosh(t)) / r, (Math.sin(e) * Math.sinh(t)) / r);
            },
            csc: function () {
              var e = this.re,
                t = this.im,
                r = 0.5 * Math.cosh(2 * t) - 0.5 * Math.cos(2 * e);
              return new s((Math.sin(e) * Math.cosh(t)) / r, (-Math.cos(e) * Math.sinh(t)) / r);
            },
            asin: function () {
              var e = this.re,
                t = this.im,
            ...
            atan: function () {
              ...
              return new s(-0.5 * n.im, 0.5 * n.re);
            },
            acot: function () {
              var e = this.re,
                t = this.im;
            ...
            sinh: function () {
              var e = this.re,
                t = this.im;
              return new s(Math.sinh(e) * Math.cos(t), Math.cosh(e) * Math.sin(t));
            },
            cosh: function () {
              var e = this.re,
                t = this.im;
              return new s(Math.cosh(e) * Math.cos(t), Math.sinh(e) * Math.sin(t));
            },
            tanh: function () {
              var e = 2 * this.re,
                t = 2 * this.im,
                r = Math.cosh(e) + Math.cos(t);
              return new s(Math.sinh(e) / r, Math.sin(t) / r);
            },
            coth: function () {
              var e = 2 * this.re,
                t = 2 * this.im,
            ...
            csch: function () {
              var e = this.re,
                t = this.im,
                r = Math.cos(2 * t) - Math.cosh(2 * e);
              return new s(
                (-2 * Math.sinh(e) * Math.cos(t)) / r,
                (2 * Math.cosh(e) * Math.sin(t)) / r
              );
            },
            sech: function () {
              var e = this.re,
                ...
                r = Math.cos(2 * t) + Math.cosh(2 * e);
              return new s(
                (2 * Math.cosh(e) * Math.cos(t)) / r,
                (-2 * Math.sinh(e) * Math.sin(t)) / r
              );
            },
            asinh: function () {
              var e = this.im;
            ...
            acosh: function () {
              ...
              return (
                t.im <= 0
                  ? ((e = t.re), (t.re = -t.im), (t.im = e))
                  : ((e = t.im), (t.im = -t.re), (t.re = e)),
                t
              );
            },
            atanh: function () {
              var e = this.re,
                ...
                u =
                  0 !== o
                    ? new s((i * n - t * t) / o, (t * n + i * t) / o)
                    : new s(-1 !== e ? e / 0 : 0, 0 !== t ? t / 0 : 0),
                c = u.re;
              return (
                (u.re = a(u.re, u.im) / 2), (u.im = Math.atan2(u.im, c) / 2), r && (u.im = -u.im), u
              );
            },
            acoth: function () {
              var e = this.re,
              ...
              return 0 !== r
                ? new s(e / r, -t / r).atanh()
                : new s(0 !== e ? e / 0 : 0, 0 !== t ? -t / 0 : 0).atanh();
            },
            acsch: function () {
              var e = this.re,
                t = this.im;
              ...
              return 0 !== r
                ? new s(e / r, -t / r).asinh()
                : new s(0 !== e ? e / 0 : 0, 0 !== t ? -t / 0 : 0).asinh();
            },
            asech: function () {
              var e = this.re,
                t = this.im;
              if (0 === e && 0 === t) return new s(1 / 0, 0);
              var r = e * e + t * t;
              return 0 !== r
                ? new s(e / r, -t / r).acosh()
                : new s(0 !== e ? e / 0 : 0, 0 !== t ? -t / 0 : 0).acosh();
            },
            inverse: function () {
              var e = this.re,
                t = this.im,
                r = e * e + t * t;
              return new s(0 !== e ? e / r : 0, 0 !== t ? -t / r : 0);
            },
            conjugate: function () {
            ...
            ceil: function (e) {
              return (
                (e = Math.pow(10, e || 0)),
                new s(Math.ceil(this.re * e) / e, Math.ceil(this.im * e) / e)
              );
            },
            floor: function (e) {
              return (
                (e = Math.pow(10, e || 0)),
                new s(Math.floor(this.re * e) / e, Math.floor(this.im * e) / e)
              );
            },
            round: function (e) {
              return (
                (e = Math.pow(10, e || 0)),
                new s(Math.round(this.re * e) / e, Math.round(this.im * e) / e)
              );
            },
            equals: function (e, t) {
              return (
                f(e, t),
                Math.abs(u.re - this.re) <= s.EPSILON && Math.abs(u.im - this.im) <= s.EPSILON
              );
            },
            clone: function () {
              return new s(this.re, this.im);
        ...
        var a = r(32),
          s = o('complex', {
            ...
            Object: function (t) {
              ...
              throw new Error(
                'Expected object with either properties re and im, or properties r and phi.'
              );
            },
            'Array | Matrix': function (e) {
              return i(e, s);
    ...
    function (e, t) {
      ...
      t.toSymbol = function (e, n) {
        if ((n = 'undefined' == typeof n ? !1 : n))
          return r.hasOwnProperty(e) ? r[e] : '\\mathrm{' + e + '}';
          ...
          var c = 2e3,
            ...
            l = function (e, t) {
              var r,
                ...
                y = 1e7;
              if (void 0 === e || null === e);
              else if (void 0 !== t) (n = e), (i = t), (o = n * i);
              else
                switch (typeof e) {
                  case 'object':
                    'd' in e && 'n' in e
                    ...
                    break;
                  case 'number':
                    if ((0 > e && ((o = e), (e = -e)), e % 1 === 0)) n = e;
                    else if (e > 0) {
                      for (
                        e >= 1 &&
                        ((h = Math.pow(10, Math.floor(1 + Math.log(e) / Math.LN10))), (e /= h));
                        y >= d && y >= v;
                      ...
                      d.length === m + 1
                        ...
                        ? ('.' !== d[m] && (u = a(d[m++], o)),
                          ...
                          (m + 1 === d.length ||
                            ('(' === d[m + 1] && ')' === d[m + 3]) ||
                            ("'" === d[m + 1] && "'" === d[m + 3])) &&
                            ((c = a(d[m], o)), (p = Math.pow(10, d[m].length)), m++),
                          (('(' === d[m] && ')' === d[m + 2]) ||
                            ("'" === d[m] && "'" === d[m + 2])) &&
                            ((l = a(d[m + 1], o)),
                            (h = Math.pow(10, d[m + 1].length) - 1),
                            (m += 3)))
                        : '/' === d[m + 1] || ':' === d[m + 1]
                        ? ((c = a(d[m], o)), (p = a(d[m + 2], 1)), (m += 3))
                        : '/' === d[m + 3] &&
                          ' ' === d[m + 1] &&
                          ((u = a(d[m], o)), (c = a(d[m + 2], o)), (p = a(d[m + 4], 1)), (m += 5)),
                      d.length <= m)
                    ) {
                      (i = p * h), (o = n = l + i * u + h * c);
                      break;
              ...
              if (0 === i) throw 'DIV/0';
              (f.s = 0 > o ? -1 : 1), (f.n = Math.abs(n)), (f.d = Math.abs(i));
            },
            p = function (e, t, r) {
            ...
            m = function (e, t, r) {
              for (var n = 1, i = p(10, r, t), o = 0; 300 > o; o++) {
                if (n === i) return o;
                (n = (10 * n) % t), (i = (10 * i) % t);
              }
              return 0;
            ...
            (u.prototype = {
              ...
              mod: function (e, t) {
                return isNaN(this.n) || isNaN(this.d)
                  ? new u(NaN)
                  : void 0 === e
                  ? new u((this.s * this.n) % this.d, 1)
                  : (l(e, t),
                    0 === f.n && 0 === this.d && u(0, 0),
                    new u((this.s * f.d * this.n) % (f.n * this.d), f.d * this.d));
              },
              gcd: function (e, t) {
              ...
              lcm: function (e, t) {
                return (
                  ...
                  0 === f.n && 0 === this.n
                    ? new u()
                    : new u((f.n * this.n) / d(f.n, this.n), d(f.d, this.d))
                );
              },
              ceil: function (e) {
                return (
                  ...
                  isNaN(this.n) || isNaN(this.d)
                    ? new u(NaN)
                    : new u(Math.ceil((e * this.s * this.n) / this.d), e)
                );
              },
              floor: function (e) {
                return (
                  ...
                  isNaN(this.n) || isNaN(this.d)
                    ? new u(NaN)
                    : new u(Math.floor((e * this.s * this.n) / this.d), e)
                );
              },
              round: function (e) {
                return (
                  ...
                  isNaN(this.n) || isNaN(this.d)
                    ? new u(NaN)
                    : new u(Math.round((e * this.s * this.n) / this.d), e)
                );
              },
              inverse: function () {
              ...
              pow: function (e) {
                return 0 > e
                  ? new u(Math.pow(this.s * this.d, -e), Math.pow(this.n, -e))
                  : new u(Math.pow(this.s * this.n, e), Math.pow(this.d, e));
              },
              equals: function (e, t) {
              ...
              toFraction: function (e) {
                ...
                return (
                  ...
                  1 === i
                    ? (r += n)
                    : (e && (t = Math.floor(n / i)) > 0 && ((r += t), (r += ' '), (n %= i)),
                      (r += n),
                      (r += '/'),
                      (r += i)),
                  r
              ...
              toContinued: function () {
                var e,
                  ...
                  r = this.d,
                  n = [];
                do n.push(Math.floor(t / r)), (e = t % r), (t = r), (r = e);
                while (1 !== t);
                return n;
              },
              toString: function () {
                ...
                for (
                  ...
                  if ((g < n.length ? (i += Number(n[g])) : ((l = 2), f++), s > 0))
                    if (f === c) (o[l] += a + '('), (a = '');
                    else if (f === s + c) {
                      o[l] += a + ')';
                      break;
    ...
    function (e, t, r) {
      ...
      function n(e, t, r) {
        var i,
          o = e.length;
        if (o != t[r]) throw new c(o, t[r]);
        if (r < t.length - 1) {
          var a = r + 1;
          for (i = 0; o > i; i++) {
            var s = e[i];
            if (!Array.isArray(s)) throw new c(t.length - 1, t.length, '<');
            n(e[i], t, a);
          }
        } else
          for (i = 0; o > i; i++) if (Array.isArray(e[i])) throw new c(t.length + 1, t.length, '>');
      }
      function i(e, r, n, o) {
        var a,
          s,
        ...
        if (((e.length = c), n < r.length - 1)) {
          var l = n + 1;
          for (a = 0; f > a; a++)
            (s = e[a]), Array.isArray(s) || ((s = [s]), (e[a] = s)), i(s, r, l, o);
          for (a = f; c > a; a++) (s = []), (e[a] = s), i(s, r, l, o);
        } else {
          for (a = 0; f > a; a++) for (; Array.isArray(e[a]); ) e[a] = e[a][0];
          if (o !== t.UNINITIALIZED) for (a = f; c > a; a++) e[a] = o;
        }
      }
      function o(e, t, r) {
        var n, i;
      ...
      (t.size = function (e) {
        ...
        (t.validateIndex = function (e, t) {
          if (!s.isNumber(e) || !s.isInteger(e))
            throw new TypeError('Index must be an integer (value: ' + e + ')');
          if (0 > e || ('number' == typeof t && e >= t)) throw new f(e, t);
        }),
        (t.UNINITIALIZED = {}),
        (t.resize = function (e, t, r) {
          ...
          t.forEach(function (e) {
            if (!s.isNumber(e) || !s.isInteger(e) || 0 > e)
              throw new TypeError(
                'Invalid size, must contain positive integers (size: ' + u.format(t) + ')'
              );
          });
          var n = void 0 !== r ? r : 0;
          return i(e, t, 0, n), e;
        ...
        (t.unsqueeze = function (e, r, n, i) {
          var o = i || t.size(e);
          if (n) for (var s = 0; n > s; s++) (e = [e]), o.unshift(1);
          for (e = a(e, r, 0); o.length < r; ) o.push(1);
          return e;
        }),
    ...
    function (e, t) {
      ...
      (r.prototype = new RangeError()),
        (r.prototype.constructor = RangeError),
        (r.prototype.name = 'DimensionError'),
        (r.prototype.isDimensionError = !0),
        (e.exports = r);
    },
    function (e, t) {
      'use strict';
      ...
      (r.prototype = new RangeError()),
        (r.prototype.constructor = RangeError),
        (r.prototype.name = 'IndexError'),
        (r.prototype.isIndexError = !0),
        (e.exports = r);
    },
    function (e, t) {
      'use strict';
    ...
    function (e, t) {
      (t.memoize = function (e, t) {
        return function r() {
          ...
          var o = t ? t(n) : JSON.stringify(n);
          return o in r.cache ? r.cache[o] : (r.cache[o] = e.apply(e, n));
        };
      }),
      ...
      function n(e, t, n, c) {
        function d(e, t) {
          if (!(this instanceof d))
            throw new SyntaxError('Constructor must be called with the new operator');
          if (t && !h(t)) throw new Error('Invalid datatype: ' + t);
          if (e && e.isMatrix === !0)
            'DenseMatrix' === e.type
              ? ((this._data = u.clone(e._data)),
                (this._size = u.clone(e._size)),
                (this._datatype = t || e._datatype))
              : ((this._data = e.toArray()),
                (this._size = e.size()),
                (this._datatype = t || e._datatype));
          else if (e && f(e.data) && f(e.size))
            (this._data = e.data), (this._size = e.size), (this._datatype = t || e.datatype);
          else if (f(e))
            (this._data = w(e)),
              (this._size = s.size(this._data)),
              s.validate(this._data, this._size),
              (this._datatype = t);
          else {
        ...
        function g(e, t) {
          ...
          var n = t.size();
          if (n.length != e._size.length) throw new o(n.length, e._size.length);
          for (var i = t.min(), a = t.max(), s = 0, u = e._size.length; u > s; s++)
            m(i[s], e._size[s]), m(a[s], e._size[s]);
        ...
        function y(e, t, r, n) {
          ...
          if ((r && r.isMatrix === !0 ? ((i = r.size()), (r = r.valueOf())) : (i = s.size(r)), c)) {
            ...
            if (i.length < a.length) {
              for (var f = 0, l = 0; 1 === a[f] && 1 === i[f]; ) f++;
              for (; 1 === a[f]; ) l++, f++;
              r = s.unsqueeze(r, a.length, l, i);
            }
        ...
        function x(e, t, r, n, i) {
          ...
          o
            ...
            : a.forEach(function (o, a) {
                m(o), x(e[o], t, r[a[0]], n, i + 1);
              });
        }
        function b(e, t, r) {
          for (var n = e._size.slice(0), i = !1; n.length < t.length; ) n.push(0), (i = !0);
          for (var o = 0, a = t.length; a > o; o++) t[o] > n[o] && ((n[o] = t[o]), (i = !0));
          i && E(e, n, r);
        }
        function w(e) {
        ...
        (d.prototype = new N()),
          ...
          (d.prototype.set = function (e, t, r) {
            ...
            b(this, s, r);
            var u = this._data;
            for (n = 0, i = e.length - 1; i > n; n++) (a = e[n]), m(a, u.length), (u = u[a]);
        ...
        return (
          ...
          (d.prototype.diagonal = function (e) {
            if (e) {
              if ((e.isBigNumber === !0 && (e = e.toNumber()), !l(e) || !p(e)))
            ...
            for (
              ...
              a[s] = this._data[s + r][s + t];
            return new d({ data: a, size: [o], datatype: this._datatype });
          }),
          (d.diagonal = function (t, r, n, i, o) {
            ...
            if (
              ((t = t.map(function (e) {
                if ((e && e.isBigNumber === !0 && (e = e.toNumber()), !l(e) || !p(e) || 1 > e))
                  throw new Error('Size values must be positive integers');
                return e;
              })),
              n)
            ) {
              if ((n && n.isBigNumber === !0 && (n = n.toNumber()), !l(n) || !p(n)))
                throw new TypeError('The parameter k must be an integer number');
            } else n = 0;
            i && h(o) && (i = c.convert(i, o));
            var a,
              u = n > 0 ? n : 0,
              m = 0 > n ? -n : 0,
              g = t[0],
            ...
            if (t.length > 0) {
              b = s.resize(b, t, i);
              for (var w = 0; y > w; w++) b[w + m][w + u] = a(w);
            }
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, d) {
        ...
        var v = n(r(38)),
          ...
          x = function (e, t, r) {
            'SparseMatrix' === t.type
              ? ((e._values = t._values ? s.clone(t._values) : void 0),
                (e._index = s.clone(t._index)),
                (e._ptr = s.clone(t._ptr)),
                (e._size = s.clone(t._size)),
                (e._datatype = r || t._datatype))
              : b(e, t.valueOf(), r || t._datatype);
          },
          b = function (e, t, r) {
            ...
            var n = t.length,
              ...
              o = y,
              a = 0;
            if ((h(r) && ((o = d.find(y, [r, r]) || y), (a = d.convert(0, r))), n > 0)) {
              var s = 0;
              do {
                ...
                for (var u = 0; n > u; u++) {
                  ...
                  if (f(c)) {
                    if ((0 === s && i < c.length && (i = c.length), s < c.length)) {
                      var l = c[s];
                      o(l, a) || (e._values.push(l), e._index.push(u));
                    }
                  } else
                    0 === s && 1 > i && (i = 1), o(c, a) || (e._values.push(c), e._index.push(u));
                }
                s++;
              } while (i > s);
            }
        ...
        (g.prototype = new v()),
          (g.prototype.type = 'SparseMatrix'),
          (g.prototype.isSparseMatrix = !0),
        ...
        var w = function (e, t) {
            ...
            var i,
              ...
              c = t.min(),
              f = t.max();
            for (i = 0, a = e._size.length; a > i; i++) m(c[i], e._size[i]), m(f[i], e._size[i]);
            var l = e._values,
              p = e._index,
              h = e._ptr,
              d = t.dimension(0),
            ...
            return (
              ...
              N.push(w.length),
              new g({ values: b, index: w, ptr: N, size: n, datatype: e._datatype })
            );
          },
          N = function (e, t, r, n) {
            if (!t || t.isIndex !== !0) throw new TypeError('Invalid index');
            var i,
              ...
              c = t.isScalar();
            if (
              (r && r.isMatrix === !0 ? ((i = r.size()), (r = r.toArray())) : (i = a.size(r)), c)
            ) {
              if (0 !== i.length) throw new TypeError('Scalar expected');
              e.set(t.min(), r, n);
            } else {
              ...
              if (i.length < u.length) {
                ...
                for (; 1 === u[f]; ) l++, f++;
                r = a.unsqueeze(r, u.length, l, i);
              }
              if (!s.deepEqual(u, i)) throw new o(u, i, '>');
              for (var p = t.min()[0], h = t.min()[1], m = i[0], d = i[1], g = 0; m > g; g++)
                for (var v = 0; d > v; v++) {
                  var y = r[g][v];
                  e.set([g + p, v + h], y, n);
                }
        ...
        (g.prototype.get = function (e) {
          ...
          var t = e[0],
            r = e[1];
          m(t, this._size[0]), m(r, this._size[1]);
          ...
          (g.prototype.set = function (e, t, r) {
            ...
            var n = e[0],
              ...
              c = 0;
            h(this._datatype) &&
              ((u = d.find(y, [this._datatype, this._datatype]) || y),
              (c = d.convert(0, this._datatype))),
              (n > a - 1 || i > s - 1) &&
                (O(this, Math.max(n + 1, a), Math.max(i + 1, s), r),
                (a = this._size[0]),
                (s = this._size[1])),
              m(n, a),
              m(i, s);
            ...
            return (
              l < this._ptr[i + 1] && this._index[l] === n
                ? u(t, c)
                  ? M(l, i, this._values, this._index, this._ptr)
                  : (this._values[l] = t)
                : A(l, n, i, t, this._values, this._index, this._ptr),
              this
            );
          });
        var E = function (e, t, r, n) {
            if (r - t === 0) return r;
            for (var i = t; r > i; i++) if (n[i] === e) return i;
            return t;
          },
        ...
        g.prototype.resize = function (e, t, r) {
          ...
          e.forEach(function (t) {
            if (!c.isNumber(t) || !c.isInteger(t) || 0 > t)
              throw new TypeError(
                'Invalid size, must contain positive integers (size: ' + u.format(e) + ')'
              );
          });
          var n = r ? this.clone() : this;
        ...
        var O = function (e, t, r, n) {
          var i = n || 0,
            ...
            a = 0;
          h(e._datatype) &&
            ((o = d.find(y, [e._datatype, e._datatype]) || y),
            (a = d.convert(0, e._datatype)),
            (i = d.convert(i, e._datatype)));
          var s,
            u,
            c,
            f = !o(i, a),
          ...
          if (r > p) {
            ...
            p > r &&
              (e._ptr.splice(r + 1, p - r),
              e._values.splice(e._ptr[r], e._values.length),
              e._index.splice(e._ptr[r], e._index.length));
          if (((p = r), t > l)) {
            if (f) {
              var m = 0;
              for (u = 0; p > u; u++) {
            ...
            for (u = 0; p > u; u++) {
              ...
              for (c = x; b > c; c++)
                (s = e._index[c]),
                  s > t - 1 && (e._values.splice(c, 1), e._index.splice(c, 1), v++);
            }
        ...
        (g.prototype.clone = function () {
          ...
          (g.prototype.map = function (e, t) {
            ...
            return _(this, 0, n - 1, 0, i - 1, o, t);
          });
        var _ = function (e, t, r, n, i, o, a) {
          var s = [],
            u = [],
            c = [],
            f = y,
            l = 0;
          h(e._datatype) &&
            ((f = d.find(y, [e._datatype, e._datatype]) || y), (l = d.convert(0, e._datatype)));
          for (
            var p = function (e, t, r) {
                (e = o(e, t, r)), f(e, l) || (s.push(e), u.push(t));
              },
              m = n;
            i >= m;
            m++
            ...
            c.push(s.length);
            for (var v = e._ptr[m], x = e._ptr[m + 1], b = t, w = v; x > w; w++) {
              var N = e._index[w];
              if (N >= t && r >= N) {
                if (!a) for (var E = b; N > E; E++) p(0, E - t, m - n);
                p(e._values[w], N - t, m - n);
              }
              b = N + 1;
            }
            if (!a) for (var M = b; r >= M; M++) p(0, M - t, m - n);
          }
          return (
            c.push(s.length), new g({ values: s, index: u, ptr: c, size: [r - t + 1, i - n + 1] })
          );
        };
        (g.prototype.forEach = function (e, t) {
          if (!this._values) throw new Error('Cannot invoke forEach on a Pattern only matrix');
          for (var r = this, n = this._size[0], i = this._size[1], o = 0; i > o; o++) {
            for (var a = this._ptr[o], s = this._ptr[o + 1], u = 0, c = a; s > c; c++) {
              var f = this._index[c];
              if (!t) for (var l = u; f > l; l++) e(0, [l, o], r);
              e(this._values[c], [f, o], r), (u = f + 1);
            }
            if (!t) for (var p = u; n > p; p++) e(0, [p, o], r);
          }
        }),
        ...
        var T = function (e, t, r, n, i) {
          var o,
            ...
            c = n[1],
            f = [];
          for (o = 0; u > o; o++) for (f[o] = [], a = 0; c > a; a++) f[o][a] = 0;
          for (a = 0; c > a; a++)
            for (var l = r[a], p = r[a + 1], h = l; p > h; h++)
              (o = t[h]), (f[o][a] = e ? (i ? s.clone(e[h]) : e[h]) : 1);
          return f;
        };
        return (
          (g.prototype.format = function (e) {
            for (
              ...
              for (var a = this._ptr[o], s = this._ptr[o + 1], c = a; s > c; c++) {
                var f = this._index[c];
                i +=
                  '\n    (' +
                  u.format(f, e) +
                  ...
                  u.format(o, e) +
                  ') ==> ' +
                  (this._values ? u.format(this._values[c], e) : 'X');
              }
            return i;
          }),
          ...
          (g.prototype.diagonal = function (e) {
            ...
            var t = e > 0 ? e : 0,
              ...
              u = [];
            u[0] = 0;
            for (var c = t; i > c && a.length < o; c++)
              for (var f = this._ptr[c], h = this._ptr[c + 1], m = f; h > m; m++) {
                var d = this._index[m];
                if (d === c - t + r) {
                  a.push(this._values[m]), (s[a.length - 1] = d - r);
                  break;
                }
              }
            return u.push(a.length), new g({ values: a, index: s, ptr: u, size: [o, 1] });
          }),
          ...
          (g.diagonal = function (e, t, r, n, i) {
            ...
            if (
              ...
              if ((r.isBigNumber === !0 && (r = r.toNumber()), !l(r) || !p(r)))
                throw new TypeError('The parameter k must be an integer number');
            } else r = 0;
            var o = y,
              a = 0;
            h(i) && ((o = d.find(y, [i, i]) || y), (a = d.convert(0, i)));
            var s,
              u = r > 0 ? r : 0,
              c = 0 > r ? -r : 0,
              m = e[0],
          ...
          (g.prototype.swapRows = function (e, t) {
            ...
            return (
              m(e, this._size[0]),
              m(t, this._size[0]),
              g._swapRows(e, t, this._size[1], this._values, this._index, this._ptr),
              this
            );
          }),
          (g._forEachRow = function (e, t, r, n, i) {
            for (var o = n[e], a = n[e + 1], s = o; a > s; s++) i(r[s], t[s]);
          }),
          (g._swapRows = function (e, t, r, n, i, o) {
            for (var a = 0; r > a; a++) {
              var s = o[a],
                u = o[a + 1],
                c = E(e, s, u, i),
              ...
              if (u > c && u > f && i[c] === e && i[f] === t) {
                ...
                i.splice(f, 0, t),
                  n && n.splice(f, 0, p),
                  i.splice(c >= f ? c + 1 : c, 1),
                  n && n.splice(c >= f ? c + 1 : c, 1);
              } else if (u > f && i[f] === t && (c >= u || i[c] !== e)) {
                var h = n ? n[f] : void 0;
                i.splice(c, 0, e),
                  n && n.splice(c, 0, h),
                  i.splice(f >= c ? f + 1 : f, 1),
                  n && n.splice(f >= c ? f + 1 : f, 1);
              }
            }
          }),
          (e.Matrix._storage.sparse = g),
          g
        );
      }
      var i = r(39),
      ...
      function n(e, t, n) {
        ...
        return (
          ...
          (i.prototype.accumulate = function (e, t) {
            ...
            r ? (r.value = o(r.value, t)) : ((r = this._heap.insert(e, t)), (this._values[e] = r));
          }),
          (i.prototype.forEach = function (e, t, r) {
            ...
            for (s && o.push(s); s && s.key <= t; )
              s.key >= e && (a(s.value, 0) || r(s.key, s.value, this)),
                (s = n.extractMinimum()),
                s && o.push(s);
            ...
            i(
              {
                ...
                'Array, any': function (e, t) {
                  return h(a(e), t, s, !1).valueOf();
                },
                'any, Array': function (e, t) {
                  return h(a(t), e, s, !0).valueOf();
                },
              },
              s.signatures
            )
          );
        return (m.toTex = { 2: '\\left(${args[0]}' + u.operators.add + '${args[1]}\\right)' }), m;
      }
      var i = r(3).extend;
          ...
          a = function (e, t, r, a) {
            ...
            if (u[0] !== h[0] || u[1] !== h[1])
              throw new RangeError(
                'Dimension mismatch. Matrix A (' + u + ') must match Matrix B (' + h + ')'
              );
            if (!f)
            ...
            for (g = 0; y > g; g++) {
              for (var M = g + 1, A = p[g], O = p[g + 1], _ = A; O > _; _++)
                (d = l[_]), (N[d] = a ? b(f[_], s[d][g]) : b(s[d][g], f[_])), (E[d] = M);
              for (d = 0; v > d; d++) E[d] === M ? (w[d][g] = N[d]) : (w[d][g] = s[d][g]);
            }
            return new o({ data: w, size: [v, y], datatype: x });
          };
        return a;
      }
      var i = r(42);
        ...
        var a = n(r(48)),
          ...
          u = function (e, t, r) {
            var n = e._values,
              ...
              d = t._size,
              g = t._datatype;
            if (f.length !== d.length) throw new i(f.length, d.length);
            if (f[0] !== d[0] || f[1] !== d[1])
              throw new RangeError(
                'Dimension mismatch. Matrix A (' + f + ') must match Matrix B (' + d + ')'
              );
            var v,
              y = f[0],
              x = f[1],
            ...
            'string' == typeof l &&
              l === g &&
              ((v = l), (b = o.find(a, [v, v])), (w = o.convert(0, v)), (N = o.find(r, [v, v])));
            var E,
              M,
              A,
              O,
      ...
      function r(e, t, r, n) {
        var i = e.DenseMatrix,
          o = function (e, t, r, o) {
            ...
            for (
              var d = [], g = new i({ data: d, size: [p, h], datatype: l }), v = [], y = [], x = 0;
              h > x;
              x++
            ) {
              ...
              for (var A = 0; p > A; A++)
                0 === x && (d[A] = []),
                  y[A] === b ? (d[A][x] = o ? m(t, v[A]) : m(v[A], t)) : (d[A][x] = t);
            }
            return g;
          };
        return o;
        ...
        var i = e.DenseMatrix,
          a = function (e, t, r) {
            var a = e._data,
              ...
              p = t._datatype,
              h = [];
            if (u.length !== l.length) throw new o(u.length, l.length);
            for (var m = 0; m < u.length; m++) {
              if (u[m] !== l[m])
                throw new RangeError(
                  'Dimension mismatch. Matrix A (' + u + ') must match Matrix B (' + l + ')'
                );
              h[m] = u[m];
            }
            var d,
            ...
            'string' == typeof c &&
              c === p &&
              ((d = c), (t = n.convert(t, d)), (g = n.find(r, [d, d])));
            var v = h.length > 0 ? s(g, 0, h, h[0], a, f) : [];
            return new i({ data: v, size: h, datatype: d });
          },
          s = function (e, t, r, n, i, o) {
            var a = [];
            if (t === r.length - 1) for (var u = 0; n > u; u++) a[u] = e(i[u], o[u]);
            else for (var c = 0; n > c; c++) a[c] = s(e, t + 1, r, r[t + 1], i[c], o[c]);
            return a;
          };
        return a;
      }
      ...
      function n(e, t, r, n) {
        var o = e.DenseMatrix,
          a = function (e, t, r, a) {
            ...
            var h = f.length > 0 ? s(p, 0, f, f[0], c, t, a) : [];
            return new o({ data: h, size: i(f), datatype: u });
          },
          s = function (e, t, r, n, i, o, a) {
            var u = [];
            if (t === r.length - 1) for (var c = 0; n > c; c++) u[c] = a ? e(o, i[c]) : e(i[c], o);
            else for (var f = 0; n > f; f++) u[f] = s(e, t + 1, r, r[t + 1], i[f], o, a);
            return u;
          };
        return a;
      }
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        (o.prototype.type = 'FibonacciHeap'),
          (o.prototype.isFibonacciHeap = !0),
          (o.prototype.insert = function (e, t) {
        ...
        var c = function (e, t, r) {
            t.key = r;
            var n = t.parent;
            return n && a(t.key, n.key) && (f(e, t, n), l(e, n)), a(t.key, e.key) && (e = t), e;
          },
          f = function (e, t, r) {
          ...
          h = function (e, t) {
            var r = Math.floor(Math.log(t) * u) + 1,
              ...
              i = 0,
              o = e;
            if (o) for (i++, o = o.right; o !== e; ) i++, (o = o.right);
            for (var c; i > 0; ) {
              for (var f = o.degree, l = o.right; ; ) {
                if (((c = n[f]), !c)) break;
                if (s(o.key, c.key)) {
                  var h = c;
                  (c = o), (o = h);
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        ...
        return (
          (m.toTex = { 2: '\\left(${args[0]}' + h.operators.smaller + '${args[1]}\\right)' }), m
        );
      }
      var i = r(6).nearlyEqual,
        o = r(49);
      ...
      function n(e, t, r, n) {
        var o = e.DenseMatrix,
          a = function (e, t, r, a) {
            ...
            'string' == typeof c &&
              c === m &&
              ((d = c), (y = n.convert(0, d)), (x = n.find(r, [d, d])));
            for (var b = [], w = 0; g > w; w++) b[w] = [];
            for (var N = [], E = [], M = 0; v > M; M++) {
              for (var A = M + 1, O = p[M], _ = p[M + 1], T = O; _ > T; T++) {
                var C = l[T];
                (N[C] = a ? x(f[T], s[C][M]) : x(s[C][M], f[T])), (E[C] = A);
              }
              for (var S = 0; g > S; S++)
                E[S] === A ? (b[S][M] = N[S]) : (b[S][M] = a ? x(y, s[S][M]) : x(s[S][M], y));
            }
            return new o({ data: b, size: [g, v], datatype: d });
          };
        return a;
      }
      var i = r(42);
      ...
      function n(e, t, r, n) {
        var o = e.DenseMatrix,
          a = function (e, t, r) {
            ...
            if (a[0] !== c[0] || a[1] !== c[1])
              throw new RangeError(
                'Dimension mismatch. Matrix A (' + a + ') must match Matrix B (' + c + ')'
              );
            var l,
              p = a[0],
              h = a[1],
            ...
            'string' == typeof u &&
              u === f &&
              ((l = u), (m = n.convert(0, l)), (d = n.find(r, [l, l])));
            var g,
              v,
              y = [];
            for (g = 0; p > g; g++) y[g] = [];
            var x = new o({ data: y, size: [p, h], datatype: l }),
              b = [],
              w = [],
              N = [],
              E = [];
            for (v = 0; h > v; v++) {
              var M = v + 1;
              for (s(e, v, N, b, M), s(t, v, E, w, M), g = 0; p > g; g++) {
                var A = N[g] === M ? b[g] : m,
                  O = E[g] === M ? w[g] : m;
                y[g][v] = d(A, O);
              }
          ...
          s = function (e, t, r, n, i) {
            for (var o = e._values, a = e._index, s = e._ptr, u = s[t], c = s[t + 1]; c > u; u++) {
              var f = a[u];
              (r[f] = i), (n[f] = o[u]);
            }
          };
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        ...
        return (
          (m.toTex = { 2: '\\left(${args[0]}' + h.operators.larger + '${args[1]}\\right)' }), m
        );
      }
      var i = r(6).nearlyEqual,
        o = r(49);
      ...
      function n(e, t, n) {
        function o(e, t) {
          ...
          if ((e && e.isMatrix === !0) || s(e)) {
            ...
            (this._data = r._data),
              (this._size = r._size),
              (this._datatype = r._datatype),
              (this._min = null),
              (this._max = null);
          } else if (e && s(e.data) && s(e.size))
            (this._data = e.data),
              (this._size = e.size),
              (this._datatype = e.datatype),
              (this._min = 'undefined' != typeof e.min ? e.min : null),
              (this._max = 'undefined' != typeof e.max ? e.max : null);
          else {
            if (e) throw new TypeError('Unsupported type of data (' + i.types.type(e) + ')');
            (this._data = []),
              (this._size = [0]),
        ...
        return (
          (o.prototype = new c()),
          (o.prototype.type = 'ImmutableDenseMatrix'),
          (o.prototype.isImmutableDenseMatrix = !0),
          (o.prototype.subset = function (e) {
            switch (arguments.length) {
              case 1:
                var t = c.prototype.subset.call(this, e);
                return t.isMatrix
                  ? new o({ data: t._data, size: t._size, datatype: t._datatype })
                  : t;
              case 2:
              case 3:
      ...
      function n(e) {
        function t(e) {
          ...
          for (var n = 0, i = arguments.length; i > n; n++) {
            ...
            } else if ('number' == typeof o) this._dimensions.push(r([o]));
            else {
              if ('string' != typeof o)
        ...
        function r(t) {
          for (var r = 0, n = t.length; n > r; r++)
            if ('number' != typeof t[r] || !o(t[r]))
              throw new TypeError('Index parameters must be positive integer numbers');
          return new e.ImmutableDenseMatrix(t);
        }
        return (
          (t.prototype.type = 'Index'),
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        function o(e, t, r) {
          ...
          (this.start = null != e ? parseFloat(e) : 0),
            (this.end = null != t ? parseFloat(t) : 0),
            (this.step = null != r ? parseFloat(r) : 1);
        }
        return (
          (o.prototype.type = 'Range'),
          (o.prototype.isRange = !0),
          (o.parse = function (e) {
            ...
            switch (r.length) {
              case 2:
                return new o(r[0], r[1]);
              case 3:
                return new o(r[0], r[2], r[1]);
              default:
                return null;
            }
          }),
          ...
          (o.prototype.size = function () {
            var e = 0,
              ...
              o = n - t;
            return (
              i.sign(r) == i.sign(o) ? (e = Math.ceil(o / r)) : 0 == o && (e = 0),
              isNaN(e) && (e = 0),
              [e]
            );
          }),
          ...
          (o.prototype.forEach = function (e) {
            var t = this.start,
              ...
              n = this.end,
              i = 0;
            if (r > 0) for (; n > t; ) e(t, [i], this), (t += r), i++;
            else if (0 > r) for (; t > n; ) e(t, [i], this), (t += r), i++;
          }),
          (o.prototype.map = function (e) {
            var t = [];
            return (
              this.forEach(function (r, n, i) {
                t[n[0]] = e(r, n, i);
              }),
              t
            );
          ...
          (o.prototype.format = function (e) {
            ...
            return (
              1 != this.step && (t += ':' + i.format(this.step, e)),
        ...
        return n('index', {
          '...number | string | BigNumber | Range | Array | Matrix': function (t) {
            var r = t.map(function (e) {
                return e && e.isBigNumber === !0
                  ? e.toNumber()
                  : e && (Array.isArray(e) || e.isMatrix === !0)
                  ? e.map(function (e) {
    ...
    function (e, t) {
      ...
      function r(e, t, r, n) {
        ...
        return (
          (o.toTex = { 0: '\\begin{bsparse}\\end{bsparse}', 1: '\\left(${args[0]}\\right)' }), o
        );
      }
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (a.toTex = { 0: '\\mathtt{""}', 1: '\\mathrm{string}\\left(${args[0]}\\right)' }), a;
      }
      var i = r(19),
        o = r(6);
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, s, u) {
        function c(e, t) {
          ...
          if (void 0 != t) {
            ...
            (this.units = [{ unit: $, prefix: q.NONE, power: 0 }]), (this.dimensions = []);
            for (var n = 0; n < j.length; n++) this.dimensions[n] = 0;
          }
          (this.value = void 0 != e ? this._normalize(e) : null),
            (this.fixPrefix = !1),
        ...
        function d() {
          var e,
            t = '';
          if (((e = P), '+' == R ? h() : '-' == R && ((t += R), h()), !l(R))) return m(e), null;
          if ('.' == R) {
          ...
          if ('E' == R || 'e' == R) {
            var r = '',
              n = P;
            if (((r += R), h(), ('+' != R && '-' != R) || ((r += R), h()), !p(R))) return m(n), t;
            for (t += r; p(R); ) (t += R), h();
          }
          return t;
        }
        function g() {
          for (
            var e = '', t = I.charCodeAt(P);
            (t >= 48 && 57 >= t) || (t >= 65 && 90 >= t) || (t >= 97 && 122 >= t);

          )
            (e += R), h(), (t = I.charCodeAt(P));
          return (
            (t = e.charCodeAt(0)), (t >= 65 && 90 >= t) || (t >= 97 && 122 >= t) ? e || null : null
          );
        }
        function v(e) {
          return R === e ? (h(), e) : null;
          ...
          for (var n in G)
            if (G.hasOwnProperty(n) && i(e, n)) {
              var t = G[n],
                ...
                a = e.substring(0, o),
                r = t.prefixes[a];
              if (void 0 !== r) return { unit: t, prefix: r };
            }
          return null;
        }
        function x(t) {
          if ('BigNumber' === t.number) {
            var r = a.pi(e.BigNumber);
        ...
        function b(e) {
          for (var t = 0; t < e.length; t++) {
            ...
            if (t > 0 && !n(r) && !i(r))
              throw new Error(
                'Invalid unit name (only alphanumeric characters are allowed): "' + e + '"'
              );
          }
        }
        var w = n(r(53)),
        ...
        (c.parse = function (r, n) {
          if (((n = n || {}), (I = r), (P = -1), (R = ''), 'string' != typeof I))
          ...
          for (var s = 1, u = !1, l = [], p = 1; ; ) {
            for (f(); '(' === R; ) l.push(s), (p *= s), (s = 1), h(), f();
            if (!R) break;
            var m = R,
              x = g();
            if (null == x)
              throw new SyntaxError(
                'Unexpected "' + m + '" in "' + I + '" at index ' + P.toString()
              );
            var b = y(x);
            ...
            if ((f(), v('^'))) {
              ...
              if (null == N)
                throw new SyntaxError(
                  'In "' + r + '", "^" must be followed by a floating-point number'
                );
              w *= N;
            }
            i.units.push({ unit: b.unit, prefix: b.prefix, power: w });
            for (var E = 0; E < j.length; E++) i.dimensions[E] += (b.unit.dimensions[E] || 0) * w;
            for (f(); ')' === R; ) {
              if (0 === l.length)
                throw new SyntaxError('Unmatched ")" in "' + I + '" at index ' + P.toString());
              (p /= l.pop()), h(), f();
            }
            if (
              ((u = !1),
              v('*') ? ((s = 1), (u = !0)) : v('/') ? ((s = -1), (u = !0)) : (s = 1),
              b.unit.base)
            ) {
              var M = b.unit.base.key;
              Z.auto[M] = { unit: b.unit, prefix: b.prefix };
            }
          }
          if ((f(), R)) throw new SyntaxError('Could not parse: "' + r + '"');
          if (u) throw new SyntaxError('Trailing characters: "' + r + '"');
          if (0 !== l.length) throw new SyntaxError('Unmatched "(" in "' + I + '"');
          ...
          (c.prototype._isDerived = function () {
            return 0 === this.units.length
              ? !1
              : this.units.length > 1 || Math.abs(this.units[0].power - 1) > 1e-15;
          }),
          (c.prototype._normalize = function (e) {
            ...
            if (this._isDerived()) {
              var a = e;
              o = c._getNumberConverter(z(e));
              for (var s = 0; s < this.units.length; s++)
                (t = o(this.units[s].unit.value)),
                  (i = o(this.units[s].prefix.value)),
                  (n = o(this.units[s].power)),
                  (a = E(a, A(E(t, i), n)));
              return a;
            }
            return (
          ...
          (c.prototype._denormalize = function (e, t) {
            ...
            if (this._isDerived()) {
              var s = e;
              a = c._getNumberConverter(z(e));
              for (var u = 0; u < this.units.length; u++)
                (r = a(this.units[u].unit.value)),
                  (o = a(this.units[u].prefix.value)),
                  (i = a(this.units[u].power)),
                  (s = M(s, A(E(r, o), i)));
              return s;
            }
            return (
              (a = c._getNumberConverter(z(e))),
              (r = a(this.units[0].unit.value)),
              (o = a(this.units[0].prefix.value)),
              (n = a(this.units[0].unit.offset)),
              void 0 == t ? N(M(M(e, r), o), n) : N(M(M(e, r), t), n)
            );
          }),
          ...
          (c.prototype.hasBase = function (e) {
            if (('string' == typeof e && (e = F[e]), !e)) return !1;
          ...
          (c.prototype.multiply = function (e) {
            ...
            for (var r = 0; r < e.units.length; r++) {
              var n = {};
              for (var i in e.units[r]) n[i] = e.units[r][i];
              t.units.push(n);
            }
            ...
            return (t.isUnitListSimplified = !1), U(t);
          }),
          ...
          (c.prototype.pow = function (e) {
            ...
            return (
              null != t.value ? (t.value = A(t.value, e)) : (t.value = null),
        ...
        (c.prototype.abs = function () {
          ...
          for (var t in e.units)
            ('VA' !== e.units[t].unit.name && 'VAR' !== e.units[t].unit.name) ||
              (e.units[t].unit = G.W);
          return e;
        }),
          (c.prototype.to = function (e) {
            var t,
              r = null == this.value ? this._normalize(1) : this.value;
            if ('string' == typeof e) {
              ...
              return (t.value = o(r)), (t.fixPrefix = !0), (t.isUnitListSimplified = !0), t;
            }
            if (e && e.isUnit) {
          ...
          (c.prototype.simplifyUnitListLazy = function () {
            if (!this.isUnitListSimplified && null != this.value) {
              ...
              if ('NONE' === e) this.units = [];
                ...
                var i;
                e && V.hasOwnProperty(e) && (i = V[e]);
                if (i) this.units = [{ unit: i.unit, prefix: i.prefix, power: 1 }];
                else {
                  for (var o = !1, a = 0; a < j.length; a++) {
                    var s = j[a];
                    Math.abs(this.dimensions[a] || 0) > 1e-12 &&
                      (V.hasOwnProperty(s)
                        ? t.push({
                            unit: V[s].unit,
                            prefix: V[s].prefix,
                  ...
                  r(92);
                  t.length < this.units.length && !o && (this.units = t);
                }
              }
              this.isUnitListSimplified = !0;
            }
          ...
          (c.prototype.formatUnits = function () {
            ...
            for (var e = '', t = '', r = 0, n = 0, i = 0; i < this.units.length; i++)
              this.units[i].power > 0
                ? (r++,
                  (e += ' ' + this.units[i].prefix.name + this.units[i].unit.name),
                  Math.abs(this.units[i].power - 1) > 1e-15 && (e += '^' + this.units[i].power))
                : this.units[i].power < 0 && n++;
            if (n > 0)
              for (var i = 0; i < this.units.length; i++)
                this.units[i].power < 0 &&
                  (r > 0
                    ? ((t += ' ' + this.units[i].prefix.name + this.units[i].unit.name),
                      Math.abs(this.units[i].power + 1) > 1e-15 &&
                        (t += '^' + -this.units[i].power))
                    : ((t += ' ' + this.units[i].prefix.name + this.units[i].unit.name),
                      (t += '^' + this.units[i].power)));
            (e = e.substr(1)),
              (t = t.substr(1)),
          ...
          (c.prototype.format = function (e) {
            ...
            'undefined' != typeof this.value &&
              null !== this.value &&
              this.value.isComplex &&
              ((t = Math.abs(this.value.re) < 1e-14), (r = Math.abs(this.value.im) < 1e-14));
            for (var n in this.units)
              this.units[n].unit &&
                ('VA' === this.units[n].unit.name && t
                  ? (this.units[n].unit = G.VAR)
                  : 'VAR' !== this.units[n].unit.name || t || (this.units[n].unit = G.VA));
            1 !== this.units.length ||
              this.fixPrefix ||
            ...
            var i = this._denormalize(this.value),
              o = null !== this.value ? S(i, e || {}) : '',
              a = this.formatUnits();
            return (
              this.value && this.value.isComplex && (o = '(' + o + ')'),
              a.length > 0 && o.length > 0 && (o += ' '),
              (o += a)
            );
          }),
          ...
          (c.prototype.splitUnit = function (e) {
            for (
              var t = this.clone(), r = [], n = 0;
              n < e.length && ((t = t.to(e[n])), n != e.length - 1);
              n++
            ) {
              var i = _(t.toNumeric()),
                o = new c(i, e[n].toString());
              r.push(o), (t = N(t, o));
            }
            return r.push(t), r;
          });
        ...
        q.SHORTLONG = {};
        for (var L in q.SHORT) q.SHORT.hasOwnProperty(L) && (q.SHORTLONG[L] = q.SHORT[L]);
        for (var L in q.LONG) q.LONG.hasOwnProperty(L) && (q.SHORTLONG[L] = q.LONG[L]);
        var j = [
            'MASS',
            'LENGTH',
            'TIME',
        ...
        for (var L in F) F[L].key = L;
        var D = {},
          $ = { name: '', base: D, value: 1, offset: 0, dimensions: [0, 0, 0, 0, 0, 0, 0, 0, 0] },
          G = {
            meter: { name: 'meter', base: F.LENGTH, prefixes: q.LONG, value: 1, offset: 0 },
            inch: { name: 'inch', base: F.LENGTH, prefixes: q.NONE, value: 0.0254, offset: 0 },
            foot: { name: 'foot', base: F.LENGTH, prefixes: q.NONE, value: 0.3048, offset: 0 },
            yard: { name: 'yard', base: F.LENGTH, prefixes: q.NONE, value: 0.9144, offset: 0 },
            mile: { name: 'mile', base: F.LENGTH, prefixes: q.NONE, value: 1609.344, offset: 0 },
            link: { name: 'link', base: F.LENGTH, prefixes: q.NONE, value: 0.201168, offset: 0 },
            rod: { name: 'rod', base: F.LENGTH, prefixes: q.NONE, value: 5.02921, offset: 0 },
            chain: { name: 'chain', base: F.LENGTH, prefixes: q.NONE, value: 20.1168, offset: 0 },
            angstrom: {
              name: 'angstrom',
              base: F.LENGTH,
              prefixes: q.NONE,
            ...
            m: { name: 'm', base: F.LENGTH, prefixes: q.SHORT, value: 1, offset: 0 },
            in: { name: 'in', base: F.LENGTH, prefixes: q.NONE, value: 0.0254, offset: 0 },
            ft: { name: 'ft', base: F.LENGTH, prefixes: q.NONE, value: 0.3048, offset: 0 },
            yd: { name: 'yd', base: F.LENGTH, prefixes: q.NONE, value: 0.9144, offset: 0 },
            mi: { name: 'mi', base: F.LENGTH, prefixes: q.NONE, value: 1609.344, offset: 0 },
            li: { name: 'li', base: F.LENGTH, prefixes: q.NONE, value: 0.201168, offset: 0 },
            rd: { name: 'rd', base: F.LENGTH, prefixes: q.NONE, value: 5.02921, offset: 0 },
            ch: { name: 'ch', base: F.LENGTH, prefixes: q.NONE, value: 20.1168, offset: 0 },
            mil: { name: 'mil', base: F.LENGTH, prefixes: q.NONE, value: 254e-7, offset: 0 },
            m2: { name: 'm2', base: F.SURFACE, prefixes: q.SQUARED, value: 1, offset: 0 },
            sqin: { name: 'sqin', base: F.SURFACE, prefixes: q.NONE, value: 64516e-8, offset: 0 },
            sqft: { name: 'sqft', base: F.SURFACE, prefixes: q.NONE, value: 0.09290304, offset: 0 },
            sqyd: { name: 'sqyd', base: F.SURFACE, prefixes: q.NONE, value: 0.83612736, offset: 0 },
            sqmi: {
              name: 'sqmi',
              base: F.SURFACE,
              prefixes: q.NONE,
            ...
            sqrd: { name: 'sqrd', base: F.SURFACE, prefixes: q.NONE, value: 25.29295, offset: 0 },
            sqch: { name: 'sqch', base: F.SURFACE, prefixes: q.NONE, value: 404.6873, offset: 0 },
            sqmil: {
              name: 'sqmil',
              base: F.SURFACE,
              prefixes: q.NONE,
            ...
            acre: { name: 'acre', base: F.SURFACE, prefixes: q.NONE, value: 4046.86, offset: 0 },
            hectare: { name: 'hectare', base: F.SURFACE, prefixes: q.NONE, value: 1e4, offset: 0 },
            m3: { name: 'm3', base: F.VOLUME, prefixes: q.CUBIC, value: 1, offset: 0 },
            L: { name: 'L', base: F.VOLUME, prefixes: q.SHORT, value: 0.001, offset: 0 },
            l: { name: 'l', base: F.VOLUME, prefixes: q.SHORT, value: 0.001, offset: 0 },
            litre: { name: 'litre', base: F.VOLUME, prefixes: q.LONG, value: 0.001, offset: 0 },
            cuin: {
              name: 'cuin',
              base: F.VOLUME,
              prefixes: q.NONE,
            ...
            drop: { name: 'drop', base: F.VOLUME, prefixes: q.NONE, value: 5e-8, offset: 0 },
            gtt: { name: 'gtt', base: F.VOLUME, prefixes: q.NONE, value: 5e-8, offset: 0 },
            minim: {
              name: 'minim',
              base: F.VOLUME,
              prefixes: q.NONE,
            ...
            cc: { name: 'cc', base: F.VOLUME, prefixes: q.NONE, value: 1e-6, offset: 0 },
            cup: { name: 'cup', base: F.VOLUME, prefixes: q.NONE, value: 0.0002365882, offset: 0 },
            pint: {
              name: 'pint',
              base: F.VOLUME,
              prefixes: q.NONE,
            ...
            floz: { name: 'floz', base: F.VOLUME, prefixes: q.NONE, value: 2957353e-11, offset: 0 },
            gi: { name: 'gi', base: F.VOLUME, prefixes: q.NONE, value: 0.0001182941, offset: 0 },
            cp: { name: 'cp', base: F.VOLUME, prefixes: q.NONE, value: 0.0002365882, offset: 0 },
            pt: { name: 'pt', base: F.VOLUME, prefixes: q.NONE, value: 0.0004731765, offset: 0 },
            qt: { name: 'qt', base: F.VOLUME, prefixes: q.NONE, value: 0.0009463529, offset: 0 },
            gal: { name: 'gal', base: F.VOLUME, prefixes: q.NONE, value: 0.003785412, offset: 0 },
            bbl: { name: 'bbl', base: F.VOLUME, prefixes: q.NONE, value: 0.1173478, offset: 0 },
            obl: { name: 'obl', base: F.VOLUME, prefixes: q.NONE, value: 0.1589873, offset: 0 },
            g: { name: 'g', base: F.MASS, prefixes: q.SHORT, value: 0.001, offset: 0 },
            gram: { name: 'gram', base: F.MASS, prefixes: q.LONG, value: 0.001, offset: 0 },
            ton: { name: 'ton', base: F.MASS, prefixes: q.SHORT, value: 907.18474, offset: 0 },
            tonne: { name: 'tonne', base: F.MASS, prefixes: q.SHORT, value: 1e3, offset: 0 },
            grain: { name: 'grain', base: F.MASS, prefixes: q.NONE, value: 6479891e-11, offset: 0 },
            dram: {
              name: 'dram',
              base: F.MASS,
              prefixes: q.NONE,
            ...
            stick: { name: 'stick', base: F.MASS, prefixes: q.NONE, value: 0.115, offset: 0 },
            stone: { name: 'stone', base: F.MASS, prefixes: q.NONE, value: 6.35029318, offset: 0 },
            gr: { name: 'gr', base: F.MASS, prefixes: q.NONE, value: 6479891e-11, offset: 0 },
            dr: {
              name: 'dr',
              base: F.MASS,
              prefixes: q.NONE,
            ...
            oz: { name: 'oz', base: F.MASS, prefixes: q.NONE, value: 0.028349523125, offset: 0 },
            lbm: { name: 'lbm', base: F.MASS, prefixes: q.NONE, value: 0.45359237, offset: 0 },
            cwt: { name: 'cwt', base: F.MASS, prefixes: q.NONE, value: 45.359237, offset: 0 },
            s: { name: 's', base: F.TIME, prefixes: q.SHORT, value: 1, offset: 0 },
            min: { name: 'min', base: F.TIME, prefixes: q.NONE, value: 60, offset: 0 },
            h: { name: 'h', base: F.TIME, prefixes: q.NONE, value: 3600, offset: 0 },
            second: { name: 'second', base: F.TIME, prefixes: q.LONG, value: 1, offset: 0 },
            sec: { name: 'sec', base: F.TIME, prefixes: q.LONG, value: 1, offset: 0 },
            minute: { name: 'minute', base: F.TIME, prefixes: q.NONE, value: 60, offset: 0 },
            hour: { name: 'hour', base: F.TIME, prefixes: q.NONE, value: 3600, offset: 0 },
            day: { name: 'day', base: F.TIME, prefixes: q.NONE, value: 86400, offset: 0 },
            week: { name: 'week', base: F.TIME, prefixes: q.NONE, value: 604800, offset: 0 },
            month: { name: 'month', base: F.TIME, prefixes: q.NONE, value: 2629800, offset: 0 },
            year: { name: 'year', base: F.TIME, prefixes: q.NONE, value: 31557600, offset: 0 },
            decade: { name: 'year', base: F.TIME, prefixes: q.NONE, value: 315576e3, offset: 0 },
            century: {
              name: 'century',
              base: F.TIME,
              prefixes: q.NONE,
            ...
            rad: { name: 'rad', base: F.ANGLE, prefixes: q.NONE, value: 1, offset: 0 },
            deg: { name: 'deg', base: F.ANGLE, prefixes: q.NONE, value: null, offset: 0 },
            grad: { name: 'grad', base: F.ANGLE, prefixes: q.NONE, value: null, offset: 0 },
            cycle: { name: 'cycle', base: F.ANGLE, prefixes: q.NONE, value: null, offset: 0 },
            arcsec: { name: 'arcsec', base: F.ANGLE, prefixes: q.NONE, value: null, offset: 0 },
            arcmin: { name: 'arcmin', base: F.ANGLE, prefixes: q.NONE, value: null, offset: 0 },
            A: { name: 'A', base: F.CURRENT, prefixes: q.SHORT, value: 1, offset: 0 },
            ampere: { name: 'ampere', base: F.CURRENT, prefixes: q.LONG, value: 1, offset: 0 },
            K: { name: 'K', base: F.TEMPERATURE, prefixes: q.NONE, value: 1, offset: 0 },
            degC: { name: 'degC', base: F.TEMPERATURE, prefixes: q.NONE, value: 1, offset: 273.15 },
            degF: {
              name: 'degF',
              base: F.TEMPERATURE,
              prefixes: q.NONE,
            ...
            kelvin: { name: 'kelvin', base: F.TEMPERATURE, prefixes: q.NONE, value: 1, offset: 0 },
            celsius: {
              name: 'celsius',
              base: F.TEMPERATURE,
              prefixes: q.NONE,
            ...
            cd: { name: 'cd', base: F.LUMINOUS_INTENSITY, prefixes: q.NONE, value: 1, offset: 0 },
            candela: {
              name: 'candela',
              base: F.LUMINOUS_INTENSITY,
              prefixes: q.NONE,
              value: 1,
              offset: 0,
            },
            N: { name: 'N', base: F.FORCE, prefixes: q.SHORT, value: 1, offset: 0 },
            newton: { name: 'newton', base: F.FORCE, prefixes: q.LONG, value: 1, offset: 0 },
            dyn: { name: 'dyn', base: F.FORCE, prefixes: q.SHORT, value: 1e-5, offset: 0 },
            dyne: { name: 'dyne', base: F.FORCE, prefixes: q.LONG, value: 1e-5, offset: 0 },
            lbf: {
              name: 'lbf',
              base: F.FORCE,
              prefixes: q.NONE,
            ...
            kip: { name: 'kip', base: F.FORCE, prefixes: q.LONG, value: 4448.2216, offset: 0 },
            J: { name: 'J', base: F.ENERGY, prefixes: q.SHORT, value: 1, offset: 0 },
            joule: { name: 'joule', base: F.ENERGY, prefixes: q.SHORT, value: 1, offset: 0 },
            erg: { name: 'erg', base: F.ENERGY, prefixes: q.NONE, value: 1e-5, offset: 0 },
            Wh: { name: 'Wh', base: F.ENERGY, prefixes: q.SHORT, value: 3600, offset: 0 },
            BTU: { name: 'BTU', base: F.ENERGY, prefixes: q.BTU, value: 1055.05585262, offset: 0 },
            eV: {
              name: 'eV',
              base: F.ENERGY,
              prefixes: q.SHORT,
            ...
            W: { name: 'W', base: F.POWER, prefixes: q.SHORT, value: 1, offset: 0 },
            watt: { name: 'W', base: F.POWER, prefixes: q.LONG, value: 1, offset: 0 },
            hp: { name: 'hp', base: F.POWER, prefixes: q.NONE, value: 745.6998715386, offset: 0 },
            VAR: { name: 'VAR', base: F.POWER, prefixes: q.SHORT, value: k.I, offset: 0 },
            VA: { name: 'VA', base: F.POWER, prefixes: q.SHORT, value: 1, offset: 0 },
            Pa: { name: 'Pa', base: F.PRESSURE, prefixes: q.SHORT, value: 1, offset: 0 },
            psi: {
              name: 'psi',
              base: F.PRESSURE,
              prefixes: q.NONE,
            ...
            atm: { name: 'atm', base: F.PRESSURE, prefixes: q.NONE, value: 101325, offset: 0 },
            bar: { name: 'bar', base: F.PRESSURE, prefixes: q.NONE, value: 1e5, offset: 0 },
            torr: { name: 'torr', base: F.PRESSURE, prefixes: q.NONE, value: 133.322, offset: 0 },
            mmHg: { name: 'mmHg', base: F.PRESSURE, prefixes: q.NONE, value: 133.322, offset: 0 },
            mmH2O: { name: 'mmH2O', base: F.PRESSURE, prefixes: q.NONE, value: 9.80665, offset: 0 },
            cmH2O: { name: 'cmH2O', base: F.PRESSURE, prefixes: q.NONE, value: 98.0665, offset: 0 },
            coulomb: {
              name: 'coulomb',
              base: F.ELECTRIC_CHARGE,
              prefixes: q.LONG,
              value: 1,
              offset: 0,
            },
            C: { name: 'C', base: F.ELECTRIC_CHARGE, prefixes: q.SHORT, value: 1, offset: 0 },
            farad: {
              name: 'farad',
              base: F.ELECTRIC_CAPACITANCE,
              prefixes: q.LONG,
              value: 1,
              offset: 0,
            },
            F: { name: 'F', base: F.ELECTRIC_CAPACITANCE, prefixes: q.SHORT, value: 1, offset: 0 },
            volt: {
              name: 'volt',
              base: F.ELECTRIC_POTENTIAL,
              prefixes: q.LONG,
              value: 1,
              offset: 0,
            },
            V: { name: 'V', base: F.ELECTRIC_POTENTIAL, prefixes: q.SHORT, value: 1, offset: 0 },
            ohm: {
              name: 'ohm',
              base: F.ELECTRIC_RESISTANCE,
            ...
            henry: {
              name: 'henry',
              base: F.ELECTRIC_INDUCTANCE,
              prefixes: q.LONG,
              value: 1,
              offset: 0,
            },
            H: { name: 'H', base: F.ELECTRIC_INDUCTANCE, prefixes: q.SHORT, value: 1, offset: 0 },
            siemens: {
              name: 'siemens',
              base: F.ELECTRIC_CONDUCTANCE,
              prefixes: q.LONG,
              value: 1,
              offset: 0,
            },
            S: { name: 'S', base: F.ELECTRIC_CONDUCTANCE, prefixes: q.SHORT, value: 1, offset: 0 },
            weber: { name: 'weber', base: F.MAGNETIC_FLUX, prefixes: q.LONG, value: 1, offset: 0 },
            Wb: { name: 'Wb', base: F.MAGNETIC_FLUX, prefixes: q.SHORT, value: 1, offset: 0 },
            tesla: {
              name: 'tesla',
              base: F.MAGNETIC_FLUX_DENSITY,
              prefixes: q.LONG,
              value: 1,
              offset: 0,
            },
            T: { name: 'T', base: F.MAGNETIC_FLUX_DENSITY, prefixes: q.SHORT, value: 1, offset: 0 },
            b: { name: 'b', base: F.BIT, prefixes: q.BINARY_SHORT, value: 1, offset: 0 },
            bits: { name: 'bits', base: F.BIT, prefixes: q.BINARY_LONG, value: 1, offset: 0 },
            B: { name: 'B', base: F.BIT, prefixes: q.BINARY_SHORT, value: 8, offset: 0 },
            bytes: { name: 'bytes', base: F.BIT, prefixes: q.BINARY_LONG, value: 8, offset: 0 },
          },
          H = {
            meters: 'meter',
            inches: 'inch',
        ...
        var Z = {
          si: {
            NONE: { unit: $, prefix: q.NONE[''] },
            LENGTH: { unit: G.m, prefix: q.SHORT[''] },
            MASS: { unit: G.g, prefix: q.SHORT.k },
            TIME: { unit: G.s, prefix: q.SHORT[''] },
            CURRENT: { unit: G.A, prefix: q.SHORT[''] },
            TEMPERATURE: { unit: G.K, prefix: q.SHORT[''] },
            LUMINOUS_INTENSITY: { unit: G.cd, prefix: q.SHORT[''] },
            AMOUNT_OF_SUBSTANCE: { unit: G.mol, prefix: q.SHORT[''] },
            ANGLE: { unit: G.rad, prefix: q.SHORT[''] },
            BIT: { unit: G.bit, prefix: q.SHORT[''] },
            FORCE: { unit: G.N, prefix: q.SHORT[''] },
            ENERGY: { unit: G.J, prefix: q.SHORT[''] },
            POWER: { unit: G.W, prefix: q.SHORT[''] },
            PRESSURE: { unit: G.Pa, prefix: q.SHORT[''] },
            ELECTRIC_CHARGE: { unit: G.C, prefix: q.SHORT[''] },
            ELECTRIC_CAPACITANCE: { unit: G.F, prefix: q.SHORT[''] },
            ELECTRIC_POTENTIAL: { unit: G.V, prefix: q.SHORT[''] },
            ELECTRIC_RESISTANCE: { unit: G.ohm, prefix: q.SHORT[''] },
            ELECTRIC_INDUCTANCE: { unit: G.H, prefix: q.SHORT[''] },
            ELECTRIC_CONDUCTANCE: { unit: G.S, prefix: q.SHORT[''] },
            MAGNETIC_FLUX: { unit: G.Wb, prefix: q.SHORT[''] },
            MAGNETIC_FLUX_DENSITY: { unit: G.T, prefix: q.SHORT[''] },
            FREQUENCY: { unit: G.Hz, prefix: q.SHORT[''] },
          },
        };
        (Z.cgs = JSON.parse(JSON.stringify(Z.si))),
          (Z.cgs.LENGTH = { unit: G.m, prefix: q.SHORT.c }),
          (Z.cgs.MASS = { unit: G.g, prefix: q.SHORT[''] }),
          (Z.cgs.FORCE = { unit: G.dyn, prefix: q.SHORT[''] }),
          (Z.cgs.ENERGY = { unit: G.erg, prefix: q.NONE[''] }),
          (Z.us = JSON.parse(JSON.stringify(Z.si))),
          (Z.us.LENGTH = { unit: G.ft, prefix: q.NONE[''] }),
          (Z.us.MASS = { unit: G.lbm, prefix: q.NONE[''] }),
          (Z.us.TEMPERATURE = { unit: G.degF, prefix: q.NONE[''] }),
          (Z.us.FORCE = { unit: G.lbf, prefix: q.NONE[''] }),
          (Z.us.ENERGY = { unit: G.BTU, prefix: q.BTU[''] }),
          (Z.us.POWER = { unit: G.hp, prefix: q.NONE[''] }),
          (Z.us.PRESSURE = { unit: G.psi, prefix: q.NONE[''] }),
          (Z.auto = JSON.parse(JSON.stringify(Z.si)));
        var V = Z.auto;
        (c.setUnitSystem = function (e) {
          if (!Z.hasOwnProperty(e))
            throw new Error(
              'Unit system ' + e + ' does not exist. Choices are: ' + Object.keys(Z).join(', ')
            );
          V = Z[e];
        }),
          (c.getUnitSystem = function () {
            for (var e in Z) if (Z[e] === V) return e;
          }),
          (c.typeConverters = {
            BigNumber: function (t) {
              return new e.BigNumber(t + '');
        ...
        for (var W in H)
          if (H.hasOwnProperty(W)) {
            var Y = G[H[W]],
              X = {};
            for (var L in Y) Y.hasOwnProperty(L) && (X[L] = Y[L]);
            (X.name = W), (G[W] = X);
          }
        return (
          (c.createUnit = function (e, t) {
            if ('object' != typeof e)
              throw new TypeError("createUnit expects first parameter to be of type 'Object'");
            if (t && t.override)
              for (var r in e)
                if ((e.hasOwnProperty(r) && c.deleteUnit(r), e[r].aliases)) {
                  console.log(e[r].aliases);
                  for (var n = 0; n < e[r].aliases.length; n++) c.deleteUnit(e[r].aliases[n]);
                }
            var i;
            for (var r in e) e.hasOwnProperty(r) && (i = c.createUnitSingle(r, e[r]));
            return i;
          }),
          (c.createUnitSingle = function (e, t, r) {
            ...
            if (G.hasOwnProperty(e))
              throw new Error(
                'Cannot create unit "' + e + '": a unit with that name already exists'
              );
            b(e);
            var n,
              i,
            ...
            if (t && 'Unit' === t.type) o = t.clone();
              ...
              (n = t.definition), (i = t.prefixes), (s = t.offset), (a = t.aliases);
            }
            if (a)
              for (var u = 0; u < a.length; u++)
                if (G.hasOwnProperty(a[u]))
                  throw new Error(
                    'Cannot create alias "' + a[u] + '": a unit with that name already exists'
                  );
            if (n && 'string' == typeof n && !o)
              try {
                o = c.parse(n, { allowNoUnits: !0 });
              } catch (f) {
                throw (
                  ((f.message = 'Could not create unit "' + e + '" from "' + n + '": ' + f.message),
                  f)
                );
              }
            ...
            (a = a || []),
              (s = s || 0),
              (i = i && i.toUpperCase ? q[i.toUpperCase()] || q.NONE : q.NONE);
            var l = {};
            if (o) {
              l = {
                name: e,
              ...
              if (!p) {
                var d = e + '_STUFF',
                  g = { dimensions: o.dimensions.slice(0) };
                (g.key = d), (F[d] = g), (V[d] = { unit: l, prefix: q.NONE[''] }), (l.base = d);
              }
            } else {
              var d = e + '_STUFF';
              if (j.indexOf(d) >= 0)
              ...
              j.push(d);
              for (var v in F) F.hasOwnProperty(v) && (F[v].dimensions[j.length - 1] = 0);
              for (var g = { dimensions: [] }, u = 0; u < j.length; u++) g.dimensions[u] = 0;
              (g.dimensions[j.length - 1] = 1),
                (g.key = d),
                (F[d] = g),
                (l = {
                  name: e,
                  value: 1,
                  dimensions: F[d].dimensions.slice(0),
                  prefixes: i,
                  offset: s,
                  base: d,
                }),
                (V[d] = { unit: l, prefix: q.NONE[''] });
            }
            c.UNITS[e] = l;
            for (var u = 0; u < a.length; u++) {
              var y = a[u],
                x = {};
              for (var w in l) l.hasOwnProperty(w) && (x[w] = l[w]);
      ...
      var i = r(23).endsWith,
        o = r(3).clone,
        a = r(76);
      (t.name = 'Unit'), (t.path = 'type'), (t.factory = n), (t.math = !0);
    },
    function (e, t, r) {
      function n(e) {
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        var a = r(32),
          ...
          g = o('subtract', {
            ...
            'Unit, Unit': function (e, t) {
              ...
              if (!e.equalBase(t)) throw new Error('Units do not match');
              var r = e.clone();
              return (r.value = g(r.value, t.value)), (r.fixPrefix = !1), r;
            },
            'Matrix, Matrix': function (e, t) {
              var r = e.size(),
                n = t.size();
        ...
        return (
          (g.toTex = { 2: '\\left(${args[0]}' + a.operators.subtract + '${args[1]}\\right)' }), g
        );
      }
      var i = r(42);
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        ...
        return (s.toTex = { 1: a.operators.unaryMinus + '\\left(${args[0]}\\right)' }), s;
      }
      var i = r(19);
        ...
        var o = n(r(80)),
          a = i('divide', {
            ...
            'Unit, number | Fraction | BigNumber': function (e, t) {
              var r = e.clone();
              return (r.value = a(null === r.value ? r._normalize(1) : r.value, t)), r;
            },
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        function s(r, n) {
          if (t.predictable && !i(n) && 0 > r)
            try {
              var o = m(n),
                a = d(o);
              if ((n === a || Math.abs((n - a) / n) < 1e-14) && o.d % 2 === 1)
                return (o.n % 2 === 0 ? 1 : -1) * Math.pow(-r, n);
            } catch (s) {}
          return i(n) || r >= 0 || t.predictable ? Math.pow(r, n) : new e.Complex(r, 0).pow(n, 0);
        }
        function u(e, t) {
          if (!i(t) || 0 > t)
          ...
          for (var n = l(r[0]).valueOf(), a = e; t >= 1; )
            1 == (1 & t) && (n = p(a, n)), (t >>= 1), (a = p(a, a));
          return n;
        }
        function c(e, t) {
        ...
        var f = r(32),
          ...
          g = a('pow', {
            ...
            'BigNumber, BigNumber': function (r, n) {
              return n.isInteger() || r >= 0 || t.predictable
                ? r.pow(n)
                : new e.Complex(r.toNumber(), 0).pow(n.toNumber(), 0);
            },
        ...
        function u(t, r, n) {
          var a =
            t && t.isBigNumber === !0
              ...
              : null;
          if (
            (t && t.isBigNumber === !0 && (t = t.toNumber()),
            r && r.isBigNumber === !0 && (r = r.toNumber()),
            !o(t) || 1 > t)
          )
          ...
          for (var l = i.resize([], c, u), p = r > t ? t : r, h = 0; p > h; h++) l[h][h] = s;
          return l;
        }
        var c = n(r(52)),
          f = a('eye', {
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        var s = r(32),
          ...
          y = function (e, t, r) {
            ...
            o &&
              ...
              o === u &&
              'string' == typeof o &&
              ((n = o), (l = a.find(c, [n, n])), (p = a.find(f, [n, n])));
            for (var h = p(i[0], s[0]), m = 1; r > m; m++) h = l(h, p(i[m], s[m]));
            return h;
          },
          x = function (e, t) {
            switch (t.storage()) {
          ...
          b = function (e, t) {
            ...
            o &&
              ...
              o === l &&
              'string' == typeof o &&
              ((r = o), (d = a.find(c, [r, r])), (g = a.find(f, [r, r])));
            for (var v = [], y = 0; h > y; y++) {
              for (var x = g(n[0], s[0][y]), b = 1; p > b; b++) x = d(x, g(n[b], s[b][y]));
              v[y] = x;
            }
          ...
          E = function (e, t) {
            ...
            o &&
              ...
              o === u &&
              'string' == typeof o &&
              ((r = o), (h = a.find(c, [r, r])), (d = a.find(f, [r, r])));
            for (var g = [], v = 0; l > v; v++) {
              for (var y = n[v], x = d(y[0], s[0]), b = 1; p > b; b++) x = h(x, d(y[b], s[b]));
              g[v] = x;
            }
          ...
          M = function (e, t) {
            ...
            o &&
              ...
              o === l &&
              'string' == typeof o &&
              ((r = o), (g = a.find(c, [r, r])), (v = a.find(f, [r, r])));
            for (var y = [], x = 0; p > x; x++) {
              var b = n[x];
              y[x] = [];
              for (var w = 0; d > w; w++) {
                for (var N = v(b[0], s[0][w]), E = 1; h > E; E++) N = g(N, v(b[E], s[E][w]));
                y[x][w] = N;
              }
            }
          ...
          A = function (e, t) {
            ...
            for (
              var N = [],
                E = [],
                M = [],
                A = new d({ values: N, index: E, ptr: M, size: [g, v], datatype: m }),
                O = 0;
              v > O;
              O++
            ) {
              ...
              var _ = u[O],
                T = u[O + 1];
              if (T > _)
                for (var C = 0, S = 0; g > S; S++) {
                  for (var z, B = S + 1, k = _; T > k; k++) {
                    var I = s[k];
                    C !== B ? ((z = x(r[S][I], o[k])), (C = B)) : (z = y(z, x(r[S][I], o[k])));
                  }
          ...
          O = function (e, t) {
            ...
            for (var A = 0; m > A; A++) {
              var O = u[A];
              if (!w(O, N))
                for (var _ = i[A], T = i[A + 1], C = _; T > C; C++) {
                  var S = n[C];
                  M[S]
                    ? (E[S] = x(E[S], b(O, r[C])))
                    : ((M[S] = !0), v.push(S), (E[S] = b(O, r[C])));
                }
            }
            ...
            return (
              (y[1] = v.length), new d({ values: g, index: v, ptr: y, size: [h, 1], datatype: s })
            );
          },
          _ = function (e, t) {
            var r = e._values,
            ...
            for (
              var w = [],
                N = [],
                E = [],
                M = new d({ values: w, index: N, ptr: E, size: [h, g], datatype: s }),
                A = [],
                O = [],
                _ = 0;
              g > _;
              ...
              E[_] = N.length;
              for (var T = _ + 1, C = 0; m > C; C++) {
                var S = u[C][_];
                if (!x(S, b))
                  for (var z = i[C], B = i[C + 1], k = z; B > k; k++) {
                    var I = n[k];
                    O[I] !== T
                      ? ((O[I] = T), N.push(I), (A[I] = y(S, r[k])))
                      : (A[I] = v(A[I], y(S, r[k])));
                  }
              }
          ...
          T = function (e, t) {
            ...
            s &&
              ...
              s === h &&
              'string' == typeof s &&
              ((r = s), (y = a.find(c, [r, r])), (x = a.find(f, [r, r])));
            for (
              var b,
                w,
                N,
                ...
                C = [],
                S = [],
                z = new d({ values: T, index: C, ptr: S, size: [m, g], datatype: r }),
                B = v ? [] : void 0,
                k = [],
                I = 0;
              g > I;
              ...
              for (M = p[I], A = p[I + 1], E = M; A > E; E++)
                if (((_ = l[E]), v))
                  for (w = o[_], N = o[_ + 1], b = w; N > b; b++)
                    (O = i[b]),
                      k[O] !== P
                        ? ((k[O] = P), C.push(O), (B[O] = x(u[E], n[b])))
                        : (B[O] = y(B[O], x(u[E], n[b])));
                else
                  for (w = o[_], N = o[_ + 1], b = w; N > b; b++)
                    (O = i[b]), k[O] !== P && ((k[O] = P), C.push(O));
              if (v)
                for (var R = S[I], U = C.length, q = R; U > q; q++) {
                  var L = C[q];
                  T[q] = B[L];
                }
            }
        ...
        return (
          (g.toTex = { 2: '\\left(${args[0]}' + s.operators.multiply + '${args[1]}\\right)' }), g
        );
      }
      var i = r(3).extend,
        o = r(40);
          ...
          s = function (e, t, r, n) {
            ...
            for (
              var y = [],
                x = [],
                b = [],
                w = new a({ values: y, index: x, ptr: b, size: [h, m], datatype: p }),
                N = 0;
              m > N;
              N++
            ) {
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\left|${args[0]}\\right|' }), o;
      }
      var i = r(19);
        ...
        var o = n('fix', {
          ...
          Complex: function (t) {
            return new e.Complex(
              t.re > 0 ? Math.floor(t.re) : Math.ceil(t.re),
              t.im > 0 ? Math.floor(t.im) : Math.ceil(t.im)
            );
          },
          BigNumber: function (e) {
      ...
      function n(e, t, n, i) {
        var o = n(r(52)),
          ...
          h = i('equal', {
            ...
            'Array, any': function (e, t) {
              return l(o(e), t, a, !1).valueOf();
            },
            'any, Array': function (e, t) {
              return l(o(t), e, a, !0).valueOf();
            },
          });
    ...
    function (e, t, r) {
      'use strict';
      function n(e, t, r, n) {
        var o = n('format', { any: i.format, 'any, Object | function | number': i.format });
      ...
      (function (e, n) {
        ...
        function u(e, r, n) {
          ...
          if (0 === a.length) {
            ...
            if (N(r)) return e.stylize(RegExp.prototype.toString.call(r), 'regexp');
          ...
          if (
            (N(r) && (v = ' ' + RegExp.prototype.toString.call(r)),
            M(r) && (v = ' ' + Date.prototype.toUTCString.call(r)),
            A(r) && (v = ' ' + f(r)),
        ...
        function l(e, t, r, n, i) {
          for (var o = [], a = 0, s = t.length; s > a; ++a)
            z(t, String(a)) ? o.push(p(e, t, r, n, String(a), !0)) : o.push('');
          return (
          ...
          if (
            ...
            s ||
              (e.seen.indexOf(c.value) < 0
                ? ((s = g(r) ? u(e, c.value, null) : u(e, c.value, r - 1)),
                  s.indexOf('\n') > -1 &&
                    (s = o
                      ? s
                          .split('\n')
        ...
        (t.debuglog = function (e) {
          if ((w(k) && (k = n.env.NODE_DEBUG || ''), (e = e.toUpperCase()), !I[e]))
    ...
    function (e, t) {
      function r() {
        (c = !1), a.length ? (u = a.concat(u)) : (f = -1), u.length && n();
      }
      function n() {
        if (!c) {
          var e = setTimeout(r);
      ...
      function n(e, t, r, n) {
        var i = n('createUnit', {
          ...
          'string, Unit | string | Object, Object': function (t, r, n) {
            var i = {};
            return (i[t] = r), e.Unit.createUnit(i, n);
          },
          'string, Unit | string | Object': function (t, r) {
            var n = {};
            return (n[t] = r), e.Unit.createUnit(n, {});
          },
          string: function (t) {
            var r = {};
            return (r[t] = {}), e.Unit.createUnit(r, {});
          },
        });
        return i;
      }
      r(19);
      (t.name = 'createUnit'), (t.factory = n);
    },
    function (e, t, r) {
      'use strict';
      function n(e, t, r, n) {
    ...
    function (e, t, r) {
      'use strict';
      function n(e, t, a, s, u) {
        u.on('config', function (r, i) {
          r.number !== i.number && n(e, t, a, s, u);
        }),
          (u['true'] = !0),
          (u['false'] = !1),
          (u['null'] = null),
          (u.uninitialized = r(40).UNINITIALIZED),
          'BigNumber' === t.number
            ? ((u.Infinity = new e.BigNumber(1 / 0)),
              (u.NaN = new e.BigNumber(NaN)),
              i.lazy(u, 'pi', function () {
                return o.pi(e.BigNumber);
              }),
              i.lazy(u, 'tau', function () {
                return o.tau(e.BigNumber);
              }),
              i.lazy(u, 'e', function () {
                return o.e(e.BigNumber);
              }),
              i.lazy(u, 'phi', function () {
                return o.phi(e.BigNumber);
              }),
              i.lazy(u, 'E', function () {
                return u.e;
              }),
    ...
    function (e, t, r) {
      e.exports = [r(103), r(277), r(306), r(308), r(334), r(279), r(305)];
    },
    function (e, t, r) {
      function n(e, t, n, i) {
        var o = {};
        return (
          ...
          (o.planckConstant = { description: 'Planck constant', examples: ['planckConstant'] }),
          ...
          (o.coulomb = { description: "Coulomb's constant", examples: ['coulomb'] }),
          (o.elementaryCharge = {
            description: 'Elementary charge',
            examples: ['elementaryCharge'],
          }),
          (o.bohrMagneton = { description: 'Borh magneton', examples: ['bohrMagneton'] }),
          ...
          (o.klitzing = { description: 'Von Klitzing constant', examples: ['klitzing'] }),
          (o.bohrRadius = { description: 'Borh radius', examples: ['bohrRadius'] }),
          (o.classicalElectronRadius = {
            description: 'Classical electron radius',
            examples: ['classicalElectronRadius'],
          }),
          (o.electronMass = { description: 'Electron mass', examples: ['electronMass'] }),
          (o.fermiCoupling = {
          ...
          (o.hartreeEnergy = { description: 'Hartree energy', examples: ['hartreeEnergy'] }),
          (o.protonMass = { description: 'Proton mass', examples: ['protonMass'] }),
          (o.deuteronMass = { description: 'Deuteron Mass', examples: ['deuteronMass'] }),
          (o.neutronMass = { description: 'Neutron mass', examples: ['neutronMass'] }),
          (o.quantumOfCirculation = {
            description: 'Quantum of circulation',
            examples: ['quantumOfCirculation'],
          }),
          (o.rydberg = { description: 'Rydberg constant', examples: ['rydberg'] }),
          (o.thomsonCrossSection = {
            description: 'Thomson cross section',
            examples: ['thomsonCrossSection'],
          }),
          (o.weakMixingAngle = { description: 'Weak mixing angle', examples: ['weakMixingAngle'] }),
          (o.efimovFactor = { description: 'Efimov factor', examples: ['efimovFactor'] }),
          (o.atomicMass = { description: 'Atomic mass constant', examples: ['atomicMass'] }),
          (o.avogadro = { description: "Avogadro's number", examples: ['avogadro'] }),
          (o.boltzmann = { description: 'Boltzmann constant', examples: ['boltzmann'] }),
          (o.faraday = { description: 'Faraday constant', examples: ['faraday'] }),
          (o.firstRadiation = {
          ...
          (o.gasConstant = { description: 'Gas constant', examples: ['gasConstant'] }),
          ...
          (o.molarMass = { description: 'Molar mass constant', examples: ['molarMass'] }),
          (o.molarMassC12 = {
          ...
          (o.planckLength = { description: 'Planck length', examples: ['planckLength'] }),
          (o.planckMass = { description: 'Planck mass', examples: ['planckMass'] }),
          (o.planckTime = { description: 'Planck time', examples: ['planckTime'] }),
          (o.planckCharge = { description: 'Planck charge', examples: ['planckCharge'] }),
          (o.planckTemperature = {
          ...
          (o.bitXor = r(169)),
          (o.leftShift = r(170)),
          (o.rightArithShift = r(171)),
          (o.rightLogShift = r(172)),
          (o.bellNumbers = r(173)),
          (o.catalan = r(174)),
          (o.composition = r(175)),
          (o.stirlingS2 = r(176)),
          ...
          (o.transpose = r(212)),
          (o.zeros = r(213)),
          (o.combinations = r(214)),
          (o.factorial = r(215)),
          (o.gamma = r(216)),
          (o.kldivergence = r(217)),
          (o.multinomial = r(218)),
          (o.permutations = r(219)),
          (o.pickRandom = r(220)),
          (o.random = r(221)),
          (o.randomInt = r(222)),
          (o.compare = r(223)),
    ...
    function (e, t) {
      e.exports = {
        ...
        description:
          'Sort the items in a matrix. Compare can be a string "asc" or "desc", or a custom sort function.',
        examples: [
          'sort([5, 10, 1])',
          'sort(["C", "B", "A", "D"])',
    ...
    function (e, t) {
      e.exports = {
        ...
        description:
          'Compute the standard deviation of all values, defined as std(A) = sqrt(var(A)). Optional parameter normalization can be "unbiased" (default), "uncorrected", or "biased".',
        examples: [
          'std(2, 4, 6)',
          'std([2, 4, 6, 8])',
    ...
    function (e, t, r) {
      e.exports = [r(278), r(301), r(302), r(303), r(304)];
    },
    function (e, t, r) {
      'use strict';
      function n(e, t, n, o) {
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        function s(t, r) {
          ...
          if (((de = r && r.nodes ? r.nodes : {}), 'string' == typeof t)) return (ge = t), x();
        ...
        function u() {
          (ve = 0), (ye = ge.charAt(0)), (we = 0), (Ne = null);
        }
        function c() {
          ve++, (ye = ge.charAt(ve));
        }
        ...
        function p() {
          for (be = pe.NULL, xe = ''; ' ' == ye || '	' == ye || ('\n' == ye && we); ) c();
          if ('#' == ye) for (; '\n' != ye && '' != ye; ) c();
          if ('' == ye) return void (be = pe.DELIMITER);
          if ('\n' == ye && !we) return (be = pe.DELIMITER), (xe = ye), void c();
          var e = ye + f(),
            t = e + l();
          if (3 == t.length && he[t]) return (be = pe.DELIMITER), (xe = t), c(), c(), void c();
          if (2 == e.length && he[e]) return (be = pe.DELIMITER), (xe = e), c(), void c();
          if (he[ye]) return (be = pe.DELIMITER), (xe = ye), void c();
          if (!v(ye)) {
            if (g()) {
              for (; g() || y(ye); ) (xe += ye), c();
              return void (be = me.hasOwnProperty(xe) ? pe.DELIMITER : pe.SYMBOL);
            }
            for (be = pe.UNKNOWN; '' != ye; ) (xe += ye), c();
            throw X('Syntax error in part "' + xe + '"');
          }
          if (((be = pe.NUMBER), '.' == ye)) (xe += ye), c(), y(ye) || (be = pe.UNKNOWN);
          else {
            for (; y(ye); ) (xe += ye), c();
            '.' == ye && ((xe += ye), c());
          }
          ...
          if (((e = f()), 'E' == ye || 'e' == ye))
            if (y(e) || '-' == e || '+' == e) {
              if (((xe += ye), c(), ('+' != ye && '-' != ye) || ((xe += ye), c()), !y(ye)))
                throw X('Digit expected, got "' + ye + '"');
              for (; y(ye); ) (xe += ye), c();
              if ('.' == ye) throw X('Digit expected, got "' + ye + '"');
            } else if ('.' == e) throw (c(), X('Digit expected, got "' + ye + '"'));
        }
        function h() {
          do p();
          while ('\n' == xe);
        ...
        function x() {
          ...
          var e = b();
          if ('' != xe)
            throw be == pe.DELIMITER
              ? J('Unexpected operator ' + xe)
              : X('Unexpected part "' + xe + '"');
          return e;
        }
        function b() {
          var e,
            t,
            r = [];
          if ('' == xe) return new ne('undefined', 'undefined');
          for ('\n' != xe && ';' != xe && (e = w()); '\n' == xe || ';' == xe; )
            0 == r.length && e && ((t = ';' != xe), r.push({ node: e, visible: t })),
              p(),
              '\n' != xe &&
                ';' != xe &&
                '' != xe &&
                ((e = w()), (t = ';' != xe), r.push({ node: e, visible: t }));
          return r.length > 0 ? new te(r) : e;
        }
        function w() {
          var e,
            t,
            ...
            i = N();
          if ('=' == xe) {
            if (i && i.isSymbolNode) return (e = i.name), h(), (r = w()), new ee(new le(e), r);
            if (i && i.isAccessorNode) return h(), (r = w()), new ee(i.object, i.index, r);
            if (
              i &&
              i.isFunctionNode &&
              ((n = !0),
              (t = []),
              (e = i.name),
              i.args.forEach(function (e, r) {
                e && e.isSymbolNode ? (t[r] = e.name) : (n = !1);
              }),
              n)
            )
              return h(), (r = w()), new ie(e, t, r);
        ...
        function N() {
          for (var e = E(); '?' == xe; ) {
            ...
            var r = e,
              n = w();
            if (':' != xe) throw X('False part of conditional expression expected');
            (Ne = null), h();
            var i = w();
            (e = new re(r, n, i)), (Ne = t);
          }
        ...
        function E() {
          for (var e = M(); 'or' == xe; ) h(), (e = new se('or', 'or', [e, M()]));
          return e;
        }
        function M() {
          for (var e = A(); 'xor' == xe; ) h(), (e = new se('xor', 'xor', [e, A()]));
          return e;
        }
        function A() {
          for (var e = O(); 'and' == xe; ) h(), (e = new se('and', 'and', [e, O()]));
          return e;
        }
        function O() {
          for (var e = _(); '|' == xe; ) h(), (e = new se('|', 'bitOr', [e, _()]));
          return e;
        }
        function _() {
          for (var e = T(); '^|' == xe; ) h(), (e = new se('^|', 'bitXor', [e, T()]));
          return e;
        }
        function T() {
          for (var e = C(); '&' == xe; ) h(), (e = new se('&', 'bitAnd', [e, C()]));
          return e;
        }
        function C() {
          var e, t, r, n, i;
          for (
            ...
            (r = xe), (n = t[r]), h(), (i = [e, S()]), (e = new se(r, n, i));
          return e;
        }
        function S() {
          var e, t, r, n, i;
          for (
            e = z(), t = { '<<': 'leftShift', '>>': 'rightArithShift', '>>>': 'rightLogShift' };
            xe in t;

          )
            (r = xe), (n = t[r]), h(), (i = [e, z()]), (e = new se(r, n, i));
          return e;
        }
        function z() {
          var e, t, r, n, i;
          for (e = B(), t = { to: 'to', in: 'to' }; xe in t; )
            (r = xe),
              (n = t[r]),
              h(),
              'in' === r && '' === xe
                ? (e = new se('*', 'multiply', [e, new le('in')], !0))
                : ((i = [e, B()]), (e = new se(r, n, i)));
          return e;
        }
        function B() {
          var e,
            t = [];
          if (((e = ':' == xe ? new ne('1', 'number') : k()), ':' == xe && Ne !== we)) {
            for (t.push(e); ':' == xe && t.length < 3; )
              h(),
                ')' == xe || ']' == xe || ',' == xe || '' == xe
                  ? t.push(new le('end'))
                  : t.push(k());
            e = 3 == t.length ? new fe(t[0], t[2], t[1]) : new fe(t[0], t[1]);
          }
          return e;
        }
        function k() {
          var e, t, r, n, i;
          for (e = I(), t = { '+': 'add', '-': 'subtract' }; xe in t; )
            (r = xe), (n = t[r]), h(), (i = [e, I()]), (e = new se(r, n, i));
          return e;
        }
        function I() {
          var e, t, r, n, i;
          for (
            ...
            if (xe in r) (n = xe), (i = r[n]), h(), (t = P()), (e = new se(n, i, [e, t]));
            else {
              if (
                !(
                  be == pe.SYMBOL ||
                  ('in' == xe && e && e.isConstantNode) ||
                  (be == pe.NUMBER && !t.isConstantNode) ||
                  '(' == xe
                )
              )
                break;
              (t = P()), (e = new se('*', 'multiply', [e, t], !0));
            }
          return e;
        }
        function P() {
          var e,
            t,
            r = { '-': 'unaryMinus', '+': 'unaryPlus', '~': 'bitNot', not: 'not' }[xe];
          return r ? ((e = xe), h(), (t = [P()]), new se(e, r, t)) : R();
        }
        function R() {
          var e, t, r, n;
          return (
        ...
        function U() {
          var e, t, r, n, i;
          for (e = q(), t = { '!': 'factorial', "'": 'transpose' }; xe in t; )
            (r = xe), (n = t[r]), p(), (i = [e]), (e = new se(r, n, i)), (e = j(e));
          return e;
        }
        function q() {
          var e,
            t = [];
          if (be == pe.SYMBOL && de[xe]) {
            if (((e = de[xe]), p(), '(' == xe)) {
              if (((t = []), m(), p(), ')' != xe)) for (t.push(w()); ',' == xe; ) p(), t.push(w());
              if (')' != xe) throw X('Parenthesis ) expected');
              d(), p();
            }
            return new e(t);
          }
        ...
        function L() {
          var e, t;
          return be == pe.SYMBOL || (be == pe.DELIMITER && xe in me)
            ? ((t = xe), p(), (e = new le(t)), (e = j(e)))
            : F();
        }
        function j(e, t) {
          for (var r; !(('(' != xe && '[' != xe && '.' != xe) || (t && -1 === t.indexOf(xe))); )
            if (((r = []), '(' == xe)) {
              if (!e.isSymbolNode && !e.isAccessorNode) return e;
              if ((m(), p(), ')' != xe)) for (r.push(w()); ',' == xe; ) p(), r.push(w());
              if (')' != xe) throw X('Parenthesis ) expected');
              d(), p(), (e = new ce(e, r));
            } else if ('[' == xe) {
              if ((m(), p(), ']' != xe)) for (r.push(w()); ',' == xe; ) p(), r.push(w());
              if (']' != xe) throw X('Parenthesis ] expected');
              d(), p(), (e = new Q(e, new oe(r)));
            } else {
              if ((p(), be != pe.SYMBOL)) throw X('Property name expected after dot');
              r.push(new ne(xe)), p();
              var n = !0;
              e = new Q(e, new oe(r, n));
            }
          return e;
        }
        function F() {
          var e, t;
          return '"' == xe ? ((t = D()), (e = new ne(t, 'string')), (e = j(e))) : $();
        }
        function D() {
          for (var e = ''; '' != ye && '"' != ye; ) '\\' == ye && ((e += ye), c()), (e += ye), c();
          if ((p(), '"' != xe)) throw X('End of string " expected');
          return p(), e;
        }
        function $() {
          var e, t, r, n;
          if ('[' == xe) {
            if ((m(), p(), ']' != xe)) {
              var i = G();
              if (';' == xe) {
                for (r = 1, t = [i]; ';' == xe; ) p(), (t[r] = G()), r++;
                if (']' != xe) throw X('End of matrix ] expected');
                d(), p(), (n = t[0].items.length);
                for (var o = 1; r > o; o++)
                  if (t[o].items.length != n)
                    throw J('Column dimensions mismatch (' + t[o].items.length + ' != ' + n + ')');
                e = new K(t);
              } else {
                if (']' != xe) throw X('End of matrix ] expected');
                d(), p(), (e = i);
            ...
            do
              if ((p(), '}' != xe)) {
                if ('"' == xe) e = D();
                  ...
                  if (be != pe.SYMBOL) throw X('Symbol or string expected as object key');
                  (e = xe), p();
                }
                if (':' != xe) throw X('Colon : expected after object key');
                p(), (t[e] = w());
              }
            while (',' == xe);
            if ('}' != xe) throw X('Comma , or bracket } expected after object value');
            p();
            var r = new ae(t);
            return (r = j(r));
          }
        ...
        function Z() {
          var e;
          return be == pe.NUMBER ? ((e = xe), p(), new ne(e, 'number')) : V();
        }
        function V() {
          var e;
          if ('(' == xe) {
            if ((m(), p(), (e = w()), ')' != xe)) throw X('Parenthesis ) expected');
            return d(), p(), (e = new ue(e)), (e = j(e));
          }
          return Y();
        }
        function Y() {
          throw X('' == xe ? 'Unexpected end of expression' : 'Value expected');
        }
        function W() {
          return ve - xe.length + 1;
        }
        function X(e) {
          var t = W(),
        ...
        var Q = n(r(280)),
          ...
          fe = n(r(295)),
          le = n(r(296)),
          pe = { NULL: 0, DELIMITER: 1, NUMBER: 2, SYMBOL: 3, UNKNOWN: 4 },
          he = {
            ',': !0,
            '(': !0,
            ')': !0,
          ...
          me = { mod: !0, to: !0, in: !0, and: !0, xor: !0, or: !0, not: !0 },
          de = {},
          ge = '',
          ve = 0,
          ye = '',
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        return (
          (o.prototype = new s()),
          (o.prototype.type = 'AccessorNode'),
          (o.prototype.isAccessorNode = !0),
          (o.prototype._compile = function (e, t) {
            ...
            return this.index.isObjectProperty()
              ? r + '["' + this.index.getObjectProperty() + '"]'
              : this.index.needsSize()
              ? '(function () {  var object = ' +
                r +
                ';  var size = math.size(object).valueOf();  return access(object, ' +
                n +
                ');})()'
              : 'access(' + r + ', ' + n + ')';
          }),
          ...
          (o.prototype.clone = function () {
            return new o(this.object, this.index);
          }),
          ...
          (o.prototype._toTex = function (e) {
            ...
            return a(this.object) && (t = '\\left(' + t + '\\right)'), t + this.index.toTex(e);
          }),
          o
        );
      }
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n, o) {
        ...
        function s(e) {
          for (var t in e)
            if (e.hasOwnProperty(t) && t in i)
              throw new Error(
                'Scope contains an illegal symbol, "' + t + '" is a reserved keyword'
              );
        }
        return (
          ...
          (a.prototype.type = 'Node'),
          (a.prototype.isNode = !0),
          (a.prototype.compile = function () {
            if (arguments.length > 0)
              throw new Error(
                'Calling compile(math) is deprecated. Call the function as compile() instead.'
              );
            var e = { math: o.expression.transform, args: {}, _validateScope: s },
              t = {},
              r = this._compile(e, t),
              ...
              i =
                n.join(' ') +
                'return {  "eval": function (scope) {    if (scope) _validateScope(scope);    scope = scope || {};    return ' +
                r +
                ';  }};',
          ...
          (a.prototype._ifNode = function (e) {
    ...
    function (e, t, r) {
      ...
      t.transform = function (e) {
        return e && e.isIndexError
          ? new n(e.index + 1, e.min + 1, void 0 !== e.max ? e.max + 1 : void 0)
          : e;
      };
    },
    function (e, t, r) {
      ...
      function n(e, t, n, c) {
        function f(e, t) {
          ...
          if (1 != t.size().length) throw new u(t.size().length, 1);
          var r = e.length;
          s(t.min()[0], r), s(t.max()[0], r);
          var n = t.dimension(0),
            i = '';
          return (
        ...
        function l(e, t, r, n) {
          ...
          var i = t.dimension(0),
            o = i.size()[0];
          if (o != r.length) throw new u(i.size()[0], r.length);
          var a = e.length;
          s(t.min()[0]), s(t.max()[0]);
          for (var c = [], f = 0; a > f; f++) c[f] = e.charAt(f);
          if (
            ...
            for (f = a - 1, o = c.length; o > f; f++) c[f] || (c[f] = n);
          return c.join('');
        }
        var p = n(r(52)),
          h = c('subset', {
            ...
            'Array, Index, any, any': function (e, t, r, n) {
              return p(a(e)).subset(t, r, n).valueOf();
            },
      ...
      function i(e, t) {
        if (1 !== t.size().length) throw new u(t.size(), 1);
        var r = t.dimension(0);
        if ('string' != typeof r)
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        function o(e) {
          ...
          var t = function () {
            throw new Error(
              'Property `ArrayNode.nodes` is deprecated, use `ArrayNode.items` instead'
            );
          };
        ...
        return (
          (o.prototype = new a()),
          (o.prototype.type = 'ArrayNode'),
          (o.prototype.isArrayNode = !0),
          (o.prototype._compile = function (e, t) {
          ...
          (o.prototype.clone = function () {
            return new o(this.items.slice(0));
          }),
          (o.prototype._toString = function (e) {
      ...
      function n(e, t, n, i) {
        function o(e, t, r) {
          ...
          if (
            ...
            (this.index = r ? t : null),
            (this.value = r ? r : t),
            !e || (!e.isSymbolNode && !e.isAccessorNode))
          )
            throw new TypeError('SymbolNode or AccessorNode expected as "object"');
          if (e && e.isSymbolNode && 'end' === e.name)
        ...
        function a(e, t) {
          ...
          var r = f.getPrecedence(e, t),
            n = f.getPrecedence(e.value, t);
          return 'all' === t || (null !== n && r >= n);
        }
        var s = n(r(281)),
          u = (n(r(286)), n(r(52)), n(r(288))),
          c = n(r(283)),
          f = (r(282), r(289));
        return (
          (o.prototype = new s()),
          ...
          (o.prototype._compile = function (e, t) {
            ...
            if (this.index) {
              if (this.index.isObjectProperty())
                return n + '["' + this.index.getObjectProperty() + '"] = ' + o;
              if (this.object.isSymbolNode)
                return (
                  (r = this.index.needsSize() ? 'var size = math.size(object).valueOf();' : ''),
                  '(function () {  var object = ' +
                    n +
                    ';  var value = ' +
                    o +
              ...
              r = this.index.needsSize() ? 'var size = math.size(object).valueOf();' : '';
              var a = this.object.object._compile(e, t);
              if (this.object.index.isObjectProperty()) {
                var s = '["' + this.object.index.getObjectProperty() + '"]';
                return (
                  '(function () {  var parent = ' +
                  a +
                  ';  var object = parent' +
              ...
              var f = this.object.index.needsSize()
                  ? 'var size = math.size(parent).valueOf();'
                  : '',
                l = this.object.index._compile(e, t);
              return (
                '(function () {  var parent = ' +
                a +
                ';  ' +
                ...
                '  var parentIndex = ' +
                l +
                ';  var object = access(parent, parentIndex);  var value = ' +
                o +
                ';  ' +
                r +
                '  assign(parent, parentIndex, assign(object, ' +
                i +
                ', value));  return value;})()'
              );
            }
            if (!this.object.isSymbolNode) throw new TypeError('SymbolNode expected as object');
            return 'scope["' + this.object.name + '"] = ' + o;
          }),
          (o.prototype.forEach = function (e) {
          ...
          (o.prototype._toString = function (e) {
            ...
            return a(this, e && e.parenthesis) && (n = '(' + n + ')'), t + r + ' = ' + n;
          }),
          (o.prototype._toTex = function (e) {
            var t = this.object.toTex(e),
            ...
            return (
              a(this, e && e.parenthesis) && (n = '\\left(' + n + '\\right)'), t + r + ':=' + n
            );
          }),
          o
        );
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        ...
        return function (e, t, r) {
          try {
            if (Array.isArray(e)) return s(e).subset(t, r).valueOf();
            if (e && 'function' == typeof e.subset) return e.subset(t, r);
            if ('string' == typeof e) return a(e, t, r);
            if ('object' == typeof e) {
              if (!t.isObjectProperty())
                throw TypeError('Cannot apply a numeric index as object property');
              return (e[t.getObjectProperty()] = r), e;
            }
            throw new TypeError('Cannot apply index: unsupported type of object');
          } catch (n) {
            throw i(n);
    ...
    function (e, t) {
      ...
      function r(e, t) {
        ...
        for (var n = r.getIdentifier(), i = 0; i < o.length; i++) if (n in o[i]) return i;
        return null;
      }
      function n(e, t) {
        var n = e;
      ...
      var o = [
        ...
        { ConditionalNode: { latexLeftParens: !1, latexRightParens: !1, latexParens: !1 } },
      ...
      (e.exports.properties = o),
        (e.exports.getPrecedence = r),
        (e.exports.getAssociativity = n),
        (e.exports.isAssociativeWith = i);
    },
    function (e, t, r) {
      'use strict';
      function n(e, t, n, i) {
        ...
        return (
          (o.prototype = new a()),
          (o.prototype.type = 'BlockNode'),
          (o.prototype.isBlockNode = !0),
          (o.prototype._compile = function (e, t) {
            e.ResultSet = s;
            ...
            return (
              '(function () {var results = [];' + r.join('') + 'return new ResultSet(results);})()'
            );
          }),
          (o.prototype.forEach = function (e) {
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        ...
        return (
          (a.prototype = new s()),
          (a.prototype.type = 'ConditionalNode'),
          (a.prototype.isConditionalNode = !0),
          (a.prototype._compile = function (e, t) {
            return (
              (e.testCondition = function (t) {
                if ('number' == typeof t || 'boolean' == typeof t || 'string' == typeof t)
                  return !!t;
                if (t) {
                  if (t.isBigNumber === !0) return !t.isZero();
                  if (t.isComplex === !0) return !(!t.re && !t.im);
                  if (t.isUnit === !0) return !!t.value;
                }
                if (null === t || void 0 === t) return !1;
                throw new TypeError('Unsupported type of condition "' + e.math['typeof'](t) + '"');
              }),
              'testCondition(' +
                this.condition._compile(e, t) +
                ') ? ( ' +
                this.trueExpr._compile(e, t) +
                ') : ( ' +
                this.falseExpr._compile(e, t) +
                ')'
            );
          }),
          (a.prototype.forEach = function (e) {
          ...
          (a.prototype._toString = function (e) {
            ...
            ('all' === t || 'OperatorNode' === this.condition.type || (null !== o && r >= o)) &&
              (n = '(' + n + ')');
            var a = this.trueExpr.toString(e),
              s = i.getPrecedence(this.trueExpr, t);
            ('all' === t || 'OperatorNode' === this.trueExpr.type || (null !== s && r >= s)) &&
              (a = '(' + a + ')');
            var u = this.falseExpr.toString(e),
              c = i.getPrecedence(this.falseExpr, t);
            return (
              ('all' === t || 'OperatorNode' === this.falseExpr.type || (null !== c && r >= c)) &&
                (u = '(' + u + ')'),
              n + ' ? ' + a + ' : ' + u
            );
          }),
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        ...
        var s = n(r(281)),
          u = { number: !0, string: !0, boolean: !0, undefined: !0, null: !0 };
        return (
          (a.prototype = new s()),
          (a.prototype.type = 'ConstantNode'),
          (a.prototype.isConstantNode = !0),
          (a.prototype._compile = function (e, t) {
            switch (this.valueType) {
              case 'number':
                var r = e.math.config().number;
                return 'BigNumber' === r
                  ? 'math.bignumber("' + this.value + '")'
                  : 'Fraction' === r
                  ? 'math.fraction("' + this.value + '")'
                  : this.value.replace(/^(0*)[0-9]/, function (e, t) {
          ...
          (a.prototype.clone = function () {
            return new a(this.value, this.valueType);
          }),
          (a.prototype._toString = function (e) {
            switch (this.valueType) {
              case 'string':
          ...
          (a.prototype._toTex = function (e) {
            ...
            switch (this.valueType) {
              ...
              case 'number':
                return (
                  (t = r.toLowerCase().indexOf('e')),
                  -1 !== t ? r.substring(0, t) + '\\cdot10^{' + r.substring(t + 1) + '}' : r
                );
              default:
                return r;
            }
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, s) {
        ...
        function c(e, t) {
          var r = a.getPrecedence(e, t),
            n = a.getPrecedence(e.expr, t);
          return 'all' === t || (null !== n && r >= n);
        }
        var f = n(r(281));
        return (
          (u.prototype = new f()),
          (u.prototype.type = 'FunctionAssignmentNode'),
          (u.prototype.isFunctionAssignmentNode = !0),
          (u.prototype._compile = function (e, t) {
            e.typed = s;
          ...
          (u.prototype.map = function (e) {
            ...
            return new u(this.name, this.params.slice(0), t);
          }),
          ...
          (u.prototype._toString = function (e) {
            ...
            return (
              c(this, t) && (r = '(' + r + ')'),
              'function ' + this.name + '(' + this.params.join(', ') + ') = ' + r
            );
          }),
          (u.prototype._toTex = function (e) {
            var t = e && e.parenthesis ? e.parenthesis : 'keep',
              r = this.expr.toTex(e);
            return (
              c(this, t) && (r = '\\left(' + r + '\\right)'),
              '\\mathrm{' +
                this.name +
                '}\\left(' +
                this.params.map(o.toSymbol).join(',') +
                '\\right):=' +
                r
            );
          }),
      ...
      var i = r(282),
        o = r(32),
        a = r(289);
      (t.name = 'FunctionAssignmentNode'), (t.path = 'expression.node'), (t.factory = n);
    },
    function (e, t, r) {
      'use strict';
      function n(e, t, n, i) {
        ...
        var a = n(r(281)),
          s = (n(r(295)), n(r(296)), n(r(67))),
          u = Array.isArray;
        return (
          (o.prototype = new a()),
          (o.prototype.type = 'IndexNode'),
          (o.prototype.isIndexNode = !0),
          (o.prototype._compile = function (e, t) {
            var r = Object.create(t);
            e.range = function (e, t, r) {
              return new s(
                e && e.isBigNumber === !0 ? e.toNumber() : e,
                t && t.isBigNumber === !0 ? t.toNumber() : t,
                r && r.isBigNumber === !0 ? r.toNumber() : r
              );
            };
            var n = this.dimensions.map(function (t, n) {
              return t && t.isRangeNode
                ? t.needsEnd()
                  ? ((r.end = !0),
                    '(function () {var end = size[' +
                      n +
                      ']; return range(' +
                      t.start._compile(e, r) +
                      ', ' +
                      t.end._compile(e, r) +
                      ', ' +
                      (t.step ? t.step._compile(e, r) : '1') +
                      '); })()')
                  : 'range(' +
                    t.start._compile(e, r) +
                    ', ' +
                    ...
                    (t.step ? t.step._compile(e, r) : '1') +
                    ')'
                : t.isSymbolNode && 'end' === t.name
                ? ((r.end = !0),
                  '(function () {var end = size[' + n + ']; return ' + t._compile(e, r) + '; })()')
                : t._compile(e, r);
            });
          ...
          (o.prototype.needsSize = function () {
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        ...
        function s(e, t) {
          ...
          if (((n.start = (null !== o && r >= o) || 'all' === t), e.step)) {
            var a = i.getPrecedence(e.step, t);
            n.step = (null !== a && r >= a) || 'all' === t;
          }
        ...
        return (
          (a.prototype = new u()),
          (a.prototype.type = 'RangeNode'),
          (a.prototype.isRangeNode = !0),
          (a.prototype.needsEnd = function () {
          ...
          (a.prototype._compile = function (e, t) {
            return (
              'math.range(' +
              this.start._compile(e, t) +
              ', ' +
              this.end._compile(e, t) +
              (this.step ? ', ' + this.step._compile(e, t) : '') +
              ')'
            );
          }),
          (a.prototype.forEach = function (e) {
          ...
          (a.prototype._toTex = function (e) {
            ...
            return r.end && (o = '\\left(' + o + '\\right)'), (n += ':' + o);
          }),
          a
        );
      }
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o, a) {
        ...
        return (
          (s.prototype = new c()),
          (s.prototype.type = 'SymbolNode'),
          (s.prototype.isSymbolNode = !0),
          ...
          (s.prototype._toTex = function (e) {
            var t = !1;
            'undefined' == typeof a[this.name] && f.isValuelessUnit(this.name) && (t = !0);
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        return (
          (o.prototype = new a()),
          (o.prototype.type = 'ObjectNode'),
          (o.prototype.isObjectNode = !0),
          (o.prototype._compile = function (e, t) {
            var r = [];
            for (var n in this.properties)
              this.properties.hasOwnProperty(n) &&
                r.push('"' + n + '": ' + this.properties[n]._compile(e, t));
            return '{' + r.join(', ') + '}';
          }),
          (o.prototype.forEach = function (e) {
            for (var t in this.properties)
              this.properties.hasOwnProperty(t) &&
                e(this.properties[t], 'properties["' + t + '"]', this);
          }),
          (o.prototype.map = function (e) {
            var t = {};
            for (var r in this.properties)
              this.properties.hasOwnProperty(r) &&
                (t[r] = this._ifNode(e(this.properties[r], 'properties["' + r + '"]', this)));
            return new o(t);
          }),
          (o.prototype.clone = function () {
            var e = {};
          ...
          (o.prototype._toString = function (e) {
            ...
            for (var r in this.properties)
              this.properties.hasOwnProperty(r) &&
                t.push('"' + r + '": ' + this.properties[r].toString(e));
            return '{' + t.join(', ') + '}';
          }),
          (o.prototype._toTex = function (e) {
            var t = [];
            for (var r in this.properties)
              this.properties.hasOwnProperty(r) &&
                t.push('\\mathbf{' + r + ':} & ' + this.properties[r].toTex(e) + '\\\\');
      ...
      r(23);
      (t.name = 'ObjectNode'), (t.path = 'expression.node'), (t.factory = n);
    },
    function (e, t, r) {
      'use strict';
      function n(e, t, n, a, s) {
        function u(e, t, r, n) {
          ...
          (this.implicit = n === !0), (this.op = e), (this.fn = t), (this.args = r || []);
        }
        function c(e, t, r, n) {
          var i = o.getPrecedence(e, t),
            a = o.getAssociativity(e, t);
          if ('all' === t || r.length > 2) {
            var s = [];
            return (
          ...
          switch (r.length) {
            case 0:
              return [];
            case 1:
              var u = o.getPrecedence(r[0], t);
              if (n && null !== u) {
                var c, f;
                if (
                  ('keep' === t
                    ? ((c = r[0].getIdentifier()), (f = e.getIdentifier()))
                    : ((c = r[0].getContent().getIdentifier()),
                      (f = e.getContent().getIdentifier())),
                  o.properties[i][f].latexLeftParens === !1)
                )
                  return [!1];
                if (o.properties[u][c].latexParens === !1) return [!1];
              }
              return null === u ? [!1] : i >= u ? [!0] : [!1];
            case 2:
              var l,
                p = o.getPrecedence(r[0], t),
                h = o.isAssociativeWith(e, r[0], t);
              l = null === p ? !1 : p !== i || 'right' !== a || h ? i > p : !0;
              var m,
                d = o.getPrecedence(r[1], t),
                g = o.isAssociativeWith(e, r[1], t);
              if (((m = null === d ? !1 : d !== i || 'left' !== a || g ? i > d : !0), n)) {
                var f, v, y;
                'keep' === t
                  ? ((f = e.getIdentifier()),
                  ...
                  null !== p &&
                    (o.properties[i][f].latexLeftParens === !1 && (l = !1),
                    o.properties[p][v].latexParens === !1 && (l = !1)),
                  null !== d &&
                    (o.properties[i][f].latexRightParens === !1 && (m = !1),
                    o.properties[d][y].latexParens === !1 && (m = !1));
              }
              return [l, m];
          }
        }
        var f = n(r(281));
        n(r(292)), n(r(296)), n(r(299));
        return (
          (u.prototype = new f()),
          (u.prototype.type = 'OperatorNode'),
          (u.prototype.isOperatorNode = !0),
          (u.prototype._compile = function (e, t) {
            if (!e.math[this.fn])
          ...
          (u.prototype._toString = function (e) {
            ...
            switch (n.length) {
              case 1:
                var a = o.getAssociativity(this, t),
                  s = n[0].toString(e);
                return (
                  i[0] && (s = '(' + s + ')'),
                  'right' === a ? this.op + s : 'left' === a ? s + this.op : s + this.op
                );
              case 2:
                ...
                return (
                  i[0] && (u = '(' + u + ')'),
                  i[1] && (f = '(' + f + ')'),
                  this.implicit && 'OperatorNode:multiply' === this.getIdentifier() && 'hide' == r
                    ? u + ' ' + f
                    : u + ' ' + this.op + ' ' + f
                );
              default:
          ...
          (u.prototype._toTex = function (e) {
            var t = e && e.parenthesis ? e.parenthesis : 'keep',
              ...
              n = this.args,
              a = c(this, t, n, !0),
              s = i.operators[this.fn];
            switch (((s = 'undefined' == typeof s ? this.op : s), n.length)) {
              case 1:
                var u = o.getAssociativity(this, t),
                  f = n[0].toTex(e);
                return (
                  a[0] && (f = '\\left(' + f + '\\right)'),
                  'right' === u ? s + f : 'left' === u ? f + s : f + s
                );
              case 2:
                var l = n[0],
                  p = l.toTex(e);
                ...
                var d;
                switch (
                  ((d = 'keep' === t ? l.getIdentifier() : l.getContent().getIdentifier()),
                  this.getIdentifier())
                ) {
                  ...
                  case 'OperatorNode:multiply':
                    if (this.implicit && 'hide' === r) return p + '~' + m;
                }
                return p + s + m;
              default:
                return (
      ...
      function n(e, t, n, o, a) {
        function s(e, t) {
          ...
          if (
            ('string' == typeof e &&
              (console.warn(
                'WARNING: passing a string to FunctionNode is deprecated, pass a SymbolNode instead.'
              ),
              (e = new f(e))),
            !e || !e.isNode)
          )
        ...
        function u(e, t, r) {
          for (
            var n,
              i = '',
              o = new RegExp('\\$(?:\\{([a-z_][a-z_0-9]*)(?:\\[([0-9]+)\\])?\\}|\\$)', 'ig'),
              a = 0;
            null !== (n = o.exec(e));
                ...
                switch (typeof s) {
                  ...
                  case 'object':
                    if (s.isNode) i += s.toTex(r);
                      ...
                      if (!Array.isArray(s))
                        throw new TypeError(
                          'Template: ' + n[1] + ' has to be a Node, String or array of Nodes'
                        );
                      i += s
                        .map(function (e, t) {
        ...
        var c = n(r(281)),
          f = n(r(296));
        (s.prototype = new c()),
          (s.prototype.type = 'FunctionNode'),
          (s.prototype.isFunctionNode = !0),
          (s.prototype._compile = function (e, t) {
            var r,
            ...
            if (this.fn.isSymbolNode) {
              var o = this.fn.name,
                a = e.math[o],
                s = 'function' == typeof a && 1 == a.rawArgs;
              return s
                ? ((r = this._getUniqueArgumentsName(e)),
                  (e[r] = this.args),
                  n + '(' + r + ', math, scope)')
                : n + '(' + i.join(', ') + ')';
            }
            if (this.fn.isAccessorNode && this.fn.index.isObjectProperty()) {
              (r = this._getUniqueArgumentsName(e)), (e[r] = this.args);
              var u = this.fn.object._compile(e, t),
                c = this.fn.index.getObjectProperty();
              return (
                '(function () {var object = ' +
                u +
                ';return (object["' +
        ...
        (s.prototype.toString = function (e) {
          ...
          return (
            e &&
              ...
              e.handler.hasOwnProperty(r) &&
              (t = e.handler[r](this, e)),
            'undefined' != typeof t ? t : l.call(this, e)
          );
        }),
          (s.prototype._toString = function (e) {
        ...
        return (
          (s.prototype.toTex = function (e) {
            ...
            return (
              e &&
                'object' == typeof e.handler &&
                e.handler.hasOwnProperty(this.name) &&
                (t = e.handler[this.name](this, e)),
              'undefined' != typeof t ? t : p.call(this, e)
            );
          }),
          (s.prototype._toTex = function (e) {
            var t,
            ...
            !a[this.name] ||
              ('function' != typeof a[this.name].toTex &&
                'object' != typeof a[this.name].toTex &&
                'string' != typeof a[this.name].toTex) ||
              (t = a[this.name].toTex);
            var n;
            switch (typeof t) {
              case 'function':
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        return (
          (o.prototype = new a()),
          (o.prototype.type = 'ParenthesisNode'),
          (o.prototype.isParenthesisNode = !0),
          (o.prototype._compile = function (e, t) {
          ...
          (o.prototype._toTex = function (e) {
            return !e || (e && !e.parenthesis) || (e && 'keep' === e.parenthesis)
              ? '\\left(' + this.content.toTex(e) + '\\right)'
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        var o = n(r(279));
        return i('parse', { 'string | Array | Matrix': o, 'string | Array | Matrix, Object': o });
      }
    ...
    function (e, t, r) {
      e.exports = [r(309), r(311), r(313), r(315), r(316), r(318), r(324), r(329), r(331), r(333)];
    },
    function (e, t, r) {
      'use strict';
      function n(e, t, n, o) {
        ...
        return o('concat', {
          '...any': function (e) {
            ...
            'number' == typeof r
              ? (e[t] = r - 1)
              : r && r.isBigNumber === !0 && (e[t] = r.minus(1));
            try {
    ...
    function (e, t, r) {
          ...
          p = f('concat', {
            '...Array | Matrix | number | BigNumber': function (e) {
              ...
              for (t = 0; n > t; t++) {
                ...
                if (
                  (m && m.isMatrix === !0 && (p = !0),
                  'number' == typeof m || (m && m.isBigNumber === !0))
                ) {
                  if (t !== n - 1) throw new Error('Dimension must be specified as last argument');
                  if (((r = f), (f = m.valueOf()), !a(f)))
                    throw new TypeError('Integer number expected for dimension');
                  if (0 > f || (t > 0 && f > r)) throw new u(f, r + 1);
                } else {
                  var d = o(m).valueOf(),
                    g = s.size(d);
                  if (((h[t] = d), (r = f), (f = g.length - 1), t > 0 && f != r))
                    throw new c(r + 1, f + 1);
                }
              }
              if (0 == h.length) throw new SyntaxError('At least one matrix expected');
              for (var v = h.shift(); h.length; ) v = i(v, h.shift(), f, 0);
              return p ? l(v) : v;
            },
            '...string': function (e) {
              return e.join('');
      ...
      function i(e, t, r, n) {
        if (r > n) {
          ...
          for (var o = [], a = 0; a < e.length; a++) o[a] = i(e[a], t[a], r, n + 1);
          return o;
        }
        return e.concat(t);
      }
    ...
    function (e, t, r) {
      ...
      var o = r(45).maxArgumentCount;
      (t.name = 'forEach'), (t.factory = n);
    },
    function (e, t, r) {
      'use strict';
      function n(e, t, n) {
        ...
        return function () {
          for (var t = [], r = 0, n = arguments.length; n > r; r++) {
            ...
            else if (i && (i.isArray === !0 || i.isMatrix))
              i = i.map(function (e) {
                return e - 1;
              });
        ...
        return a('max', {
          '...any': function (e) {
            if (2 == e.length && o(e[0])) {
              ...
              'number' == typeof t
                ? (e[1] = t - 1)
                : t && t.isBigNumber === !0 && (e[1] = t.minus(1));
            }
            try {
    ...
    function (e, t, r) {
      ...
      function n(e, t, r) {
        ...
        if (0 >= t) {
          if (Array.isArray(e[0])) {
            for (u = i(e), a = [], o = 0; o < u.length; o++) a[o] = n(u[o], t - 1, r);
            return a;
          }
          for (s = e[0], o = 1; o < e.length; o++) s = r(s, e[o]);
          return s;
        }
        for (a = [], o = 0; o < e.length; o++) a[o] = n(e[o], t - 1, r);
        return a;
      }
      function i(e) {
        var t,
      ...
      e.exports = function (e, t, r) {
        ...
        if (0 > t || t >= i.length) throw new a(t, i.length);
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        ...
        return (p.toTex = { 2: '\\frac{${args[0]}}{${args[1]}}' }), p;
      }
      var i = r(3).extend;
      ...
      function n(e, t, n, o) {
        function a(e, t, r) {
          ...
          if (2 == t) {
            ...
            return [
              [u(e[1][1], m), u(l(e[0][1]), m)],
              [u(l(e[1][0]), m), u(e[0][0], m)],
            ];
          }
          var d = e.concat();
          for (n = 0; t > n; n++) d[n] = d[n].concat();
          for (var g = h(t).valueOf(), v = 0; r > v; v++) {
            for (n = v; t > n && 0 == d[n][v]; ) n++;
            if (n == t || 0 == d[n][v])
              throw Error('Cannot calculate inverse, determinant is zero');
            n != v &&
              ((s = d[v]), (d[v] = d[n]), (d[n] = s), (s = g[v]), (g[v] = g[n]), (g[n] = s));
            var y = d[v],
              x = g[v];
            for (n = 0; t > n; n++) {
              var b = d[n],
              ...
              if (n != v) {
                if (0 != b[v]) {
                  for (o = u(l(b[v]), y[v]), i = v; r > i; i++) b[i] = c(b[i], f(o, y[i]));
                  for (i = 0; r > i; i++) w[i] = c(w[i], f(o, x[i]));
                }
              } else {
                for (o = y[v], i = v; r > i; i++) b[i] = u(b[i], o);
                for (i = 0; r > i; i++) w[i] = u(w[i], o);
              }
            }
          }
          return g;
          ...
          m = o('inv', {
            'Array | Matrix': function (e) {
              ...
              switch (t.length) {
                case 1:
                  if (1 == t[0])
                    return e.isMatrix === !0 ? s([u(1, e.valueOf()[0])]) : [u(1, e[0])];
                  throw new RangeError('Matrix must be square (size: ' + i.string.format(t) + ')');
                case 2:
                  var r = t[0],
                    n = t[1];
                  if (r == n)
                    return e.isMatrix === !0 ? s(a(e.valueOf(), r, n), e.storage()) : a(e, r, n);
                  throw new RangeError('Matrix must be square (size: ' + i.string.format(t) + ')');
                default:
                  throw new RangeError(
                    'Matrix must be two dimensional (size: ' + i.string.format(t) + ')'
                  );
              }
            },
            any: function (e) {
          ...
          h = i('det', {
            ...
            'Array | Matrix': function (e) {
              ...
              switch (
                ...
                default:
                  throw new RangeError(
                    'Matrix must be two dimensional (size: ' + a.format(t) + ')'
                  );
              }
            },
          });
      ...
      function n(e, t, n, i) {
        ...
        return i('range', {
          '...any': function (e) {
            var t = e.length - 1,
              r = e[t];
            return 'boolean' != typeof r && e.push(!0), o.apply(null, e);
          },
        });
      }
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        function s(e, t, r) {
          var n = [],
            i = e;
          if (r > 0) for (; t > i; ) n.push(i), (i += r);
          else if (0 > r) for (; i > t; ) n.push(i), (i += r);
          return n;
        }
        function u(e, t, r) {
          var n = [],
        ...
        function c(e, t, r) {
          var n = [],
            i = e;
          if (r.gt(h)) for (; i.lt(t); ) n.push(i), (i = i.plus(r));
          else if (r.lt(h)) for (; i.gt(t); ) n.push(i), (i = i.plus(r));
          return n;
        }
        function f(e, t, r) {
          var n = [],
            i = e;
          if (r.gt(h)) for (; i.lte(t); ) n.push(i), (i = i.plus(r));
          else if (r.lt(h)) for (; i.gte(t); ) n.push(i), (i = i.plus(r));
          return n;
        }
        function l(e) {
          var t = e.split(':'),
        ...
        var p = n(r(52)),
          ...
          d = i('range', {
            ...
            'number, number, boolean': function (e, t, r) {
              return o(r ? u(e, t, 1) : s(e, t, 1));
            },
            'number, number, number, boolean': function (e, t, r, n) {
              return o(n ? u(e, t, r) : s(e, t, r));
            },
            'BigNumber, BigNumber': function (e, t) {
              return o(c(e, t, m));
            },
          ...
          (s.prototype.toString = function () {
            ...
            if (
              ...
              for (var r = 0; r < e.examples.length; r++) {
                ...
                i && !i.isHelp && (t += '        ' + o.format(i, { precision: 14 }) + '\n');
              }
              t += '\n';
            }
    ...
    function (e, t, r) {
      e.exports = [r(337), r(338), r(358), r(360), r(362)];
    },
    function (e, t, r) {
      'use strict';
      function n(e, t, n, i) {
        var a = n(r(52)),
            ...
            for (r = 0; a > r; r++) {
              if (r > 0)
                for (t = 0; i > t; t++) {
                  var N = Math.min(t, r),
                    E = 0;
                  for (n = 0; N > n; n++) E = u(E, f(d[t][n], d[n][r]));
                  d[t][r] = l(d[t][r], E);
                }
              var M = r,
                A = 0,
              ...
              if ((r !== M && ((w[r] = [w[M], (w[M] = w[r])][0]), g._swapRows(r, M, d)), i > r))
                for (t = r + 1; i > t; t++) {
                  var C = d[t][r];
                  h(C, 0) || (d[t][r] = c(d[t][r], O));
                }
            }
            for (r = 0; a > r; r++)
              for (t = 0; i > t; t++)
                0 === r && (a > t && (x[t] = []), (v[t] = [])),
                  r > t
                    ? (a > t && (x[t][r] = d[t][r]), i > r && (v[t][r] = 0))
                    : t !== r
                    ? (a > t && (x[t][r] = 0), i > r && (v[t][r] = d[t][r]))
                    : (a > t && (x[t][r] = d[t][r]), i > r && (v[t][r] = 1));
            var S = new g({ data: v, size: y }),
              z = new g({ data: x, size: b }),
              B = [];
            for (t = 0, m = w.length; m > t; t++) B[w[t]] = t;
            return {
              L: S,
              U: z,
              p: B,
          ...
          b = function (e) {
            var t,
              ...
              O = [],
              _ = [];
            for (t = 0; i > t; t++) (O[t] = t), (_[t] = t);
            var T = function (e, t) {
              var r = _[e],
                n = _[t];
              (O[r] = t), (O[n] = e), (_[e] = n), (_[t] = r);
            };
            for (r = 0; o > r; r++) {
              var C = new v();
              ...
              var S = g[r],
                z = g[r + 1];
              for (n = S; z > n; n++) (t = l[n]), C.set(O[t], u[n]);
              r > 0 &&
                C.forEach(0, r - 1, function (e, t) {
              ...
              C.forEach(r + 1, i - 1, function (e, t) {
                ...
                r !== B &&
                  (d._swapRows(r, B, w[1], y, x, b),
                  d._swapRows(r, B, A[1], N, E, M),
                  C.swap(r, B),
                  T(r, B)),
                C.forEach(0, i - 1, function (e, t) {
                  r >= e
                    ? (N.push(t), E.push(e))
                    : ((t = c(t, k)), h(t, 0) || (y.push(t), x.push(e)));
                });
            }
            return (
              M.push(N.length),
              b.push(y.length),
              {
                L: new d({ values: y, index: x, ptr: b, size: w }),
                U: new d({ values: N, index: E, ptr: M, size: A }),
                p: O,
                toString: function () {
                  return 'L: ' + this.L.toString() + '\nU: ' + this.U.toString() + '\nP: ' + this.p;
                },
        ...
        var i = n(r(340)),
          ...
          c = function (e, t, r) {
            var n,
              ...
              p = l[1],
              h = {};
            if (((h.q = i(e, t)), e && !h.q)) return null;
            if (r) {
              var m = e ? o(t, null, h.q, 0) : t;
              h.parent = a(m, 1);
              var d = s(h.parent, p);
              if (((h.cp = u(m, h.parent, d, 1)), m && h.parent && h.cp && f(m, h)))
                for (h.unz = 0, n = 0; p > n; n++) h.unz += h.cp[n];
            } else (h.unz = 4 * c[p] + p), (h.lnz = h.unz);
            return h;
          },
          f = function (e, t) {
            var r = e._ptr,
            ...
            var s,
              ...
              y = o + a,
              x = o + 2 * a;
            for (u = 0; a > u; u++) (d[v + u] = -1), (d[y + u] = -1), (d[x + u] = 0);
            for (s = 0; o > s; s++) m[s] = -1;
            for (u = a - 1; u >= 0; u--)
              for (f = r[u], l = r[u + 1], c = f; l > c; c++) m[n[c]] = u;
            for (s = o - 1; s >= 0; s--)
              (h[s] = -1),
                (u = m[s]),
                -1 != u &&
                  (0 === d[x + u]++ && (d[y + u] = s), (d[g + s] = d[v + u]), (d[v + u] = s));
            for (t.lnz = 0, t.m2 = o, u = 0; a > u; u++)
    ...
    function (e, t, r) {
      ...
      function n(e, t, n) {
        var i = n(r(341)),
          ...
          f = function (e, t) {
            ...
            for (
              var g,
                ...
                G = 7 * (s + 1),
                H = P,
                Z = p(s, k, R, U, j, H, L, G, q, $, F, D),
                V = h(s, k, R, D, F, $, c, q, j, H, L),
                Y = 0;
              s > V;

            ) {
              for (y = -1; s > Y && -1 == (y = R[j + Y]); Y++);
              -1 != R[L + y] && (H[R[L + y]] = -1), (R[j + Y] = R[L + y]);
              var W = R[F + y],
                X = R[q + y];
              V += X;
              var J = 0;
                ...
                for (
                  ...
                  (g = B[N++]),
                    (M = R[q + g]) <= 0 ||
                      ...
                      (B[ee++] = g),
                      -1 != R[L + g] && (H[R[L + g]] = H[g]),
                      -1 != H[g] ? (R[L + H[g]] = R[L + g]) : (R[j + R[D + g]] = R[L + g]));
                w != y && ((k[w] = i(y)), (R[$ + w] = 0));
              }
              for (
                0 !== W && (I = ee),
              ...
              for (A = K; ee > A; A++) {
                for (
                  g = B[A], _ = k[g], T = _ + R[F + g] - 1, C = _, S = 0, z = 0, Q = _;
                  T >= Q;
                  Q++
                )
                  if (((w = B[Q]), 0 !== R[$ + w])) {
                    var re = R[$ + w] - Z;
                    re > 0 ? ((z += re), (B[C++] = w), (S += w)) : ((k[w] = i(y)), (R[$ + w] = 0));
                  }
                R[F + g] = C - _ + 1;
                var ne = C,
                  ie = _ + R[U + g];
              ...
              for (R[D + y] = J, u = Math.max(u, J), Z = m(Z + u, u, R, $, s), A = K; ee > A; A++)
                if (((g = B[A]), !(R[q + g] >= 0)))
                  for (
                    ...
                    var ae = g;
                    for (v = R[L + g]; -1 != v; ) {
                      var se = R[U + v] === E && R[F + v] === O;
                      for (Q = k[v] + 1; se && Q <= k[v] + E - 1; Q++) R[$ + B[Q]] != Z && (se = 0);
                      se
                        ? ((k[v] = i(g)),
                          (R[q + g] += R[q + v]),
                          (R[q + v] = 0),
              ...
              for (Q = K, A = K; ee > A; A++)
                (g = B[A]),
                  (M = -R[q + g]) <= 0 ||
                    ...
                    (B[Q++] = g));
              (R[q + y] = X),
                0 === (R[U + y] = Q - K) && ((k[y] = -1), (R[$ + y] = 0)),
                0 !== W && (I = Q);
            }
            for (g = 0; s > g; g++) k[g] = i(k[g]);
            for (v = 0; s >= v; v++) R[j + v] = -1;
            for (v = s; v >= 0; v--) R[q + v] > 0 || ((R[L + v] = R[j + k[v]]), (R[j + k[v]] = v));
            for (w = s; w >= 0; w--)
              R[q + w] <= 0 || (-1 != k[w] && ((R[L + w] = R[j + k[w]]), (R[j + k[w]] = w)));
            for (y = 0, g = 0; s >= g; g++) -1 == k[g] && (y = a(g, y, R, j, L, P, $));
            return P.splice(P.length - 1, 1), P;
          },
          l = function (e, t, r, n, i) {
            var o = c(t);
            if (1 === e && n === r) return s(t, o);
            if (2 == e) {
              for (var a = o._index, f = o._ptr, l = 0, p = 0; r > p; p++) {
                var h = f[p];
                if (((f[p] = l), !(f[p + 1] - h > i)))
                  for (var m = f[p + 1]; m > h; h++) a[l++] = a[h];
              }
              return (f[r] = l), (t = c(o)), u(o, t);
            }
            return u(o, t);
          },
          p = function (e, t, r, n, i, o, a, s, u, c, f, l) {
            ...
            for (var h = 0; e >= h; h++)
              (r[i + h] = -1),
                ...
                (r[l + h] = r[n + h]);
            var d = m(0, 0, r, c, e);
            return (r[f + e] = -2), (t[e] = -1), (r[c + e] = 0), d;
          },
          h = function (e, t, r, n, o, a, s, u, c, f, l) {
            for (var p = 0, h = 0; e > h; h++) {
              var m = r[n + h];
              if (0 === m) (r[o + h] = -2), p++, (t[h] = -1), (r[a + h] = 0);
              else if (m > s) (r[u + h] = 0), (r[o + h] = -1), p++, (t[h] = i(e)), r[u + e]++;
              else {
                var d = r[c + m];
                -1 != d && (f[d] = h), (r[l + h] = r[c + m]), (r[c + m] = h);
              }
            }
            return p;
          },
          m = function (e, t, r, n, i) {
            if (2 > e || 0 > e + t) {
              for (var o = 0; i > o; o++) 0 !== r[n + o] && (r[n + o] = 1);
              e = 2;
            }
            return e;
          },
    ...
    function (e, t) {
      ...
      function r() {
        var e = function (e, t, r) {
          for (
            var n = e._values, i = e._index, o = e._ptr, a = e._size, s = a[1], u = 0, c = 0;
            s > c;
            c++
          ) {
            var f = o[c];
          ...
          return (o[s] = u), i.splice(u, i.length - u), n && n.splice(u, n.length - u), u;
        };
        return e;
      }
      ...
      function r() {
        var e = function (e, t, r, n, i, o, a) {
          ...
          for (r[a] = e; s >= 0; ) {
            var u = r[a + s],
              c = r[n + u];
            -1 == c ? (s--, (o[t++] = u)) : ((r[n + u] = r[i + c]), ++s, (r[a + s] = c));
          }
          return t;
        };
        return e;
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        var s = r(32),
            ...
            Matrix: function (e) {
              ...
              switch (r.length) {
                ...
                case 2:
                  ...
                  if (0 === i)
                    throw new RangeError(
                      'Cannot transpose a 2D matrix with no columns (size: ' + o(r) + ')'
                    );
                  switch (e.storage()) {
                    case 'dense':
                      t = p(e, n, i);
                ...
                default:
                  throw new RangeError(
                    'Matrix must be a vector or two dimensional (size: ' + o(this._size) + ')'
                  );
              }
              return t;
            },
          ...
          p = function (e, t, r) {
            for (var n, o = e._data, a = [], s = 0; r > s; s++) {
              n = a[s] = [];
              for (var u = 0; t > u; u++) n[u] = i(o[u][s]);
            }
            return new c({ data: a, size: [r, t], datatype: e._datatype });
          },
          h = function (e, t, r) {
            for (
              var n = e._values,
              ...
              l[p] = 0;
            var h, m, d;
            for (h = 0, m = o.length; m > h; h++) l[o[h]]++;
            for (var g = 0, v = 0; t > v; v++) c.push(g), (g += l[v]), (l[v] = c[v]);
            for (c.push(g), d = 0; r > d; d++)
              for (var y = a[d], x = a[d + 1], b = y; x > b; b++) {
                var w = l[o[b]]++;
                (u[w] = d), n && (s[w] = i(n[b]));
              }
        ...
        var t = e.SparseMatrix,
          r = function (e, r, n, i) {
            for (
              ...
              m[g] = d;
              for (var v = n ? n[g] : g, y = s[v], x = s[v + 1], b = y; x > b; b++) {
                var w = r ? r[a[b]] : a[b];
                (h[d] = w), p && (p[d] = o[b]), d++;
              }
            }
    ...
    function (e, t) {
      ...
      function r() {
        var e = function (e, t) {
          ...
          for (var h = 0; u > h; h++) {
            (c[h] = -1), (f[l + h] = -1);
            for (var m = o[h], d = o[h + 1], g = m; d > g; g++) {
              var v = i[g];
              for (r = t ? f[p + v] : v; -1 != r && h > r; r = n)
        ...
        var i = n(r(343)),
          o = function (e, t) {
            ...
            var r,
              ...
              u = t,
              c = 2 * t;
            for (r = 0; t > r; r++) a[s + r] = -1;
            for (r = t - 1; r >= 0; r--)
              -1 != e[r] && ((a[u + r] = a[s + e[r]]), (a[s + e[r]] = r));
            for (r = 0; t > r; r++) -1 == e[r] && (n = i(r, n, a, s, u, o, c));
            return o;
          };
        return o;
      }
          ...
          a = function (e, t, r, n) {
            ...
            for (u = 0; d > u; u++)
              for (s = r[u], M[s] = -1 == v[w + s] ? 1 : 0; -1 != s && -1 == v[w + s]; s = t[s])
                v[w + s] = u;
            if (n) {
              for (u = 0; d > u; u++) v[r[u]] = u;
              for (a = 0; m > a; a++) {
                for (u = d, l = _[a], p = _[a + 1], f = l; p > f; f++) u = Math.min(u, v[O[f]]);
                (v[E + a] = v[N + u]), (v[N + u] = a);
              }
            }
            for (a = 0; d > a; a++) v[y + a] = a;
            for (u = 0; d > u; u++) {
              for (
                s = r[u], -1 != t[s] && M[t[s]]--, c = n ? v[N + u] : s;
                -1 != c;
                c = n ? v[E + c] : -1
              )
                for (f = _[c]; f < _[c + 1]; f++) {
                  a = O[f];
                  var T = o(a, s, v, w, x, b, y);
                  T.jleaf >= 1 && M[s]++, 2 == T.jleaf && M[T.q]--;
                }
              -1 != t[s] && (v[y + s] = t[s]);
            }
            for (s = 0; d > s; s++) -1 != t[s] && (M[t[s]] += M[s]);
            return M;
          };
        return a;
      }
    ...
    function (e, t) {
      ...
      function r() {
        var e = function (e, t, r, n, i, o, a) {
          ...
          if (((r[i + e] = r[n + t]), (c = r[o + e]), (r[o + e] = t), -1 === c)) (l = 1), (f = e);
          else {
            for (l = 2, f = c; f != r[a + f]; f = r[a + f]);
            for (s = c; s != f; s = u) (u = r[a + s]), (r[a + s] = f);
          }
          return { jleaf: l, q: f };
        };
        return e;
        ...
        var i = n(r(86)),
          ...
          l = function (e, t, r) {
            ...
            var d,
              ...
              O = [],
              _ = [];
            for (d = 0; p > d; d++) (O[d] = 0), (A[d] = -1), (x[d + 1] = 0);
            (h = 0), (m = 0);
            for (var T = 0; p > T; T++) {
              (x[T] = h), (E[T] = m);
              var C = n ? n[T] : T,
              ...
              A[C] < 0 && u(i(O[C]), a(B, r)) && (z = C);
              var I = O[z];
              for (N[m] = T, w[m++] = I, A[z] = T, y[h] = z, v[h++] = 1, g = S; p > g; g++)
                (d = _[g]), A[d] < 0 && ((y[h] = d), (v[h++] = o(O[d], I))), (O[d] = 0);
            }
            for (x[p] = h, E[p] = m, g = 0; h > g; g++) y[g] = A[y[g]];
            return (
              v.splice(h, v.length - h),
              y.splice(h, y.length - h),
              w.splice(m, w.length - m),
      ...
      function n(e, t, n, a) {
        var s = n(r(52)),
          ...
          m = a('largerEq', {
            ...
            'BigNumber, BigNumber': function (e, r) {
              return e.gte(r) || o(e, r, t.epsilon);
            },
            'Fraction, Fraction': function (e, t) {
              return -1 !== e.compare(t);
            },
        ...
        return (
          (m.toTex = { 2: '\\left(${args[0]}' + h.operators.largerEq + '${args[1]}\\right)' }), m
        );
      }
      var i = r(6).nearlyEqual,
        o = r(49);
      ...
      function n(e, t, n) {
        var i = n(r(81)),
          ...
          u = function (e, t, r, n, u, c, f) {
            ...
            for (p = N[r], h = N[r + 1], l = p; h > l; l++) u[w[l]] = b[l];
            for (var M = E; x > M; M++) {
              var A = n[M],
                O = c ? c[A] : A;
              if (!(0 > O))
        ...
        var i = n(r(354)),
          ...
          s = function (e, t, r, n, s) {
            var u,
              ...
              d = p[1],
              g = d;
            for (c = m[r], f = m[r + 1], u = c; f > u; u++) {
              var v = h[u];
              o(l, v) || (g = i(v, e, g, n, s));
            }
            for (u = g; d > u; u++) a(l, n[u]);
            return g;
          };
        return s;
      }
        ...
        var i = n(r(355)),
          ...
          s = function (e, t, r, n, s) {
            ...
            for (n[0] = e; d >= 0; ) {
              e = n[d];
              var g = s ? s[e] : e;
              i(p, e) || (o(p, e), (n[m + d] = 0 > g ? 0 : a(p[g])));
              var v = 1;
              for (c = n[m + d], f = 0 > g ? 0 : a(p[g + 1]); f > c; c++)
                if (((u = l[c]), !i(p, u))) {
                  (n[m + d] = c), (n[++d] = u), (v = 0);
                  break;
                }
      ...
      function n(e, t, n, i) {
        var o = n(r(52)),
          ...
          h = function (e, t) {
            t = f(e, t, !0);
            for (
              var r = t._data, n = e._size[0], i = e._size[1], o = [], p = e._data, h = 0;
              i > h;
              h++
            ) {
              var m,
              ...
              if (c(d, 0)) m = 0;
                ...
                m = a(d, g);
                for (var v = h + 1; n > v; v++) r[v] = [u(r[v][0] || 0, s(m, p[v][h]))];
              }
              o[h] = [m];
            }
            return new l({ data: o, size: [n, 1] });
          },
          m = function (e, t) {
            t = f(e, t, !0);
            for (
              ...
              if (c(y, 0)) g[v] = [0];
                ...
                if (c(x, 0))
                  throw new Error('Linear system cannot be solved since matrix is singular');
                var E = a(y, x);
                for (n = 0, N = w.length; N > n; n++)
                  (r = w[n]), (i[r] = [u(i[r][0] || 0, s(E, b[n]))]);
                g[v] = [E];
              }
            }
            return new l({ data: g, size: [o, 1] });
          };
        return p;
      }
      ...
      function n(e) {
        var t = e.DenseMatrix,
          r = function (e, r, n) {
            var i = e.size();
            if (2 !== i.length)
              throw new RangeError('Matrix must be two dimensional (size: ' + o.format(i) + ')');
            var u = i[0],
              c = i[1];
            ...
            if (r && r.isMatrix === !0) {
              ...
              if (2 === h.length) {
                ...
                for (var m = r._values, d = r._index, g = r._ptr, v = g[1], y = g[0]; v > y; y++)
                  (l = d[y]), (f[l][0] = m[y]);
                return new t({ data: f, size: [u, 1], datatype: r._datatype });
              }
      ...
      function n(e, t, n, o) {
        var a = n(r(52)),
          ...
          d = function (e, t, r, n, i) {
            (e = m(e)), (t = m(t)), (i = f(e, i, !1)), r && (i._data = c(r, i._data));
            var o = p(e, i),
              a = l(t, o);
            return n && (a._data = c(n, a._data)), a;
          };
        return h;
      }
      var i = Array.isArray;
      ...
      function r() {
        var e = function (e, t, r) {
          var n,
            r = t.length,
            i = [];
          if (e) for (n = 0; r > n; n++) i[e[n]] = t[n];
          else for (n = 0; r > n; n++) i[n] = t[n];
          return i;
        };
        return e;
      }
      ...
      function n(e, t, n, i) {
        var o = n(r(52)),
          ...
          h = function (e, t) {
            t = f(e, t, !0);
            for (
              var r = t._data, n = e._size[0], i = e._size[1], o = [], p = e._data, h = i - 1;
              h >= 0;
              h--
            ) {
              var m,
              ...
              if (c(d, 0)) m = 0;
                ...
                if (c(g, 0))
                  throw new Error('Linear system cannot be solved since matrix is singular');
                m = a(d, g);
                for (var v = h - 1; v >= 0; v--) r[v] = [u(r[v][0] || 0, s(m, p[v][h]))];
              }
              o[h] = [m];
            }
            return new l({ data: o, size: [n, 1] });
      ...
      function n(e, t, n, a) {
        function s(r, n) {
          ...
          if (n) {
            var u = [
              s,
              new e.Complex(o(a), 0).mul(new e.Complex(0, i + (2 * Math.PI) / 3).exp()),
              new e.Complex(o(a), 0).mul(new e.Complex(0, i - (2 * Math.PI) / 3).exp()),
            ];
        ...
        function u(t) {
          ...
          var i;
          i =
            t.value && t.value.isBigNumber
              ? new e.BigNumber(1).div(3)
              : t.value && t.value.isFraction
              ? new e.Fraction(1, 3)
              : 1 / 3;
          var r = t.pow(i);
          return n && (r.value = c(r.value)), r;
        }
        var c = n(r(78)),
          f = n(r(365)),
          l = n(r(52)),
        ...
        o =
          ...
          function (e) {
            ...
            return (
              r && (e = -e),
              isFinite(e)
                ? ((t = Math.exp(Math.log(e) / 3)), (t = (e / (t * t) + 2 * t) / 3))
                : (t = e),
              r ? -t : t
            );
          };
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\left\\lceil${args[0]}\\right\\rceil' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\left(${args[0]}\\right)^3' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        return (
          (d.toTex = { 2: '\\left(${args[0]}' + s.operators.dotDivide + '${args[1]}\\right)' }), d
        );
      }
      ...
      function n(e, t, n, o) {
        var a = n(r(48)),
          ...
          u = function (e, t, r, n) {
            ...
            if (c[0] !== m[0] || c[1] !== m[1])
              throw new RangeError(
                'Dimension mismatch. Matrix A (' + c + ') must match Matrix B (' + m + ')'
              );
            if (!l)
              throw new Error('Cannot perform operation on Dense Matrix and Pattern Sparse Matrix');
            var g,
            ...
            'string' == typeof f &&
              f === d &&
              ((g = f), (x = o.find(a, [g, g])), (b = o.convert(0, g)), (w = o.find(r, [g, g])));
            for (var N = [], E = [], M = [], A = 0; y > A; A++) {
              M[A] = E.length;
              for (var O = h[A], _ = h[A + 1], T = O; _ > T; T++) {
                var C = p[T],
            ...
            return (
              (M[y] = E.length), new s({ values: N, index: E, ptr: M, size: [v, y], datatype: g })
            );
          };
        return u;
      }
      ...
      function n(e, t, n, i) {
        var o = n(r(52)),
          ...
          h = i('dotMultiply', {
            ...
            'Array, any': function (e, t) {
              return p(o(e), t, a, !1).valueOf();
            },
            'any, Array': function (e, t) {
              return p(o(t), e, a, !0).valueOf();
            },
          });
        return (
          (h.toTex = { 2: '\\left(${args[0]}' + s.operators.dotMultiply + '${args[1]}\\right)' }), h
        );
      }
      ...
      function n(e, t, n, i) {
        var o = n(r(52)),
          ...
          m = i('dotPow', {
            ...
            'Array, any': function (e, t) {
              return h(o(e), t, m, !1).valueOf();
            },
            'any, Array': function (e, t) {
              return h(o(t), e, m, !0).valueOf();
            },
          });
        return (
          (m.toTex = { 2: '\\left(${args[0]}' + s.operators.dotPow + '${args[1]}\\right)' }), m
        );
      }
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\exp\\left(${args[0]}\\right)' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\left\\lfloor${args[0]}\\right\\rfloor' }), o;
      }
      var i = r(19);
        ...
        var s = n(r(52)),
          ...
          h = o('gcd', {
            ...
            'Array | Matrix | number | BigNumber, Array | Matrix | number | BigNumber, ...Array | Matrix | number | BigNumber':
              function (e, t, r) {
                for (var n = h(e, t), i = 0; i < r.length; i++) n = h(n, r[i]);
                return n;
              },
          });
      ...
      function n(e, t, n, o) {
        function a(e) {
          for (var t = 0, r = 0, n = 0; n < e.length; n++) {
            var i = s(e[n]);
            p(r, i)
              ? ((t = f(t, f(c(r, i), c(r, i)))), (t = u(t, 1)), (r = i))
              : (t = u(t, h(i) ? f(c(i, r), c(i, r)) : i));
          }
          return f(r, l(t));
        }
        var s = n(r(86)),
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (a.toTex = { 1: '\\sqrt{${args[0]}}' }), a;
      }
      var i = r(19);
      ...
      function n(e, t, n, a) {
        var s = n(r(48)),
          ...
          c = function (e, t, r) {
            ...
            if (c[0] !== p[0] || c[1] !== p[1])
              throw new RangeError(
                'Dimension mismatch. Matrix A (' + c + ') must match Matrix B (' + p + ')'
              );
            var m,
              d = c[0],
              g = c[1],
            ...
            'string' == typeof f &&
              f === h &&
              ((m = f), (v = a.find(s, [m, m])), (y = a.convert(0, m)), (x = a.find(r, [m, m])));
            for (
              var b = n && l ? [] : void 0,
                w = [],
                N = [],
                E = new u({ values: b, index: w, ptr: N, size: [d, g], datatype: m }),
                M = b ? [] : void 0,
                A = [],
                O = [],
                _ = 0;
              ...
              N[_] = w.length;
              var T = _ + 1;
              if ((i(e, _, A, M, O, T, E, x), i(t, _, A, M, O, T, E, x), M))
                for (var C = N[_]; C < w.length; ) {
                  var S = w[C];
                  if (O[S] === T) {
                    var z = M[S];
                    v(z, y) ? w.splice(C, 1) : (b.push(z), C++);
                  } else w.splice(C, 1);
                }
              else
                for (var B = N[_]; B < w.length; ) {
                  var k = w[B];
                  O[k] !== T ? w.splice(B, 1) : B++;
                }
            }
    ...
    function (e, t) {
      'use strict';
      e.exports = function (e, t, r, n, i, o, a, s, u, c, f) {
        var l,
          p,
          h,
          m,
          ...
          y = a._index;
        if (n)
          for (p = v[t], h = v[t + 1], l = p; h > l; l++)
            (m = g[l]),
              r[m] !== o
                ? ((r[m] = o),
                  y.push(m),
                  c ? ((n[m] = u ? s(d[l], f) : s(f, d[l])), (i[m] = o)) : (n[m] = d[l]))
                : ((n[m] = u ? s(d[l], n[m]) : s(n[m], d[l])), (i[m] = o));
        else
          for (p = v[t], h = v[t + 1], l = p; h > l; l++)
            (m = g[l]), r[m] !== o ? ((r[m] = o), y.push(m)) : (i[m] = o);
      };
    },
    function (e, t, r) {
      'use strict';
        ...
        var a = n(r(81)),
          s = o('log', {
            ...
            BigNumber: function (r) {
              return !r.isNegative() || t.predictable
                ? r.ln()
                : new e.Complex(r.toNumber(), 0).log();
            },
            'Array | Matrix': function (e) {
              return i(e, s);
            },
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        var a = n('log10', {
          number: function (r) {
            return r >= 0 || t.predictable ? o(r) : new e.Complex(r, 0).log().div(Math.LN10);
          },
          Complex: function (t) {
          ...
          BigNumber: function (r) {
            return !r.isNegative() || t.predictable
              ? r.log()
              : new e.Complex(r.toNumber(), 0).log().div(Math.LN10);
          },
          'Array | Matrix': function (e) {
            return i(e, a);
          },
        });
        return (a.toTex = { 1: '\\log_{10}\\left(${args[0]}\\right)' }), a;
      }
      var i = r(19),
        o =
          Math.log10 ||
      ...
      function n(e, t, n, i) {
        ...
        var a = n(r(86)),
          ...
          v = i('norm', {
            ...
            'number | Complex | BigNumber | boolean | null, number | BigNumber | string': function (
              e
            ) {
              return v(e);
            },
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        function s(t, r) {
          ...
          var u = t.abs().pow(a.div(r));
          return (u = t.isNeg() ? u.neg() : u), new e.BigNumber((s ? a.div(u) : u).toPrecision(n));
        }
        var u = n(r(52)),
          c = n(r(54)),
          f = n(r(369)),
      ...
      function o(e, t) {
        ...
        for (var r = e.arg(), n = e.abs(), i = [], o = Math.pow(n, 1 / t), a = 0; t > a; a++)
          i.push({ r: o, phi: (r + 2 * Math.PI * a) / t });
        return i;
      }
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\left(${args[0]}\\right)^2' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        ...
        return (s.toTex = { 1: a.operators.unaryPlus + '\\left(${args[0]}\\right)' }), s;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        ...
        function s(r, n) {
          ...
          var m;
          return (
            (m = r.lt(s) ? [r.neg(), l.neg(), h.neg()] : [r, r.isZero() ? 0 : l, h]),
            'Array' === t.matrix ? m : u(m)
          );
        }
        var u = n(r(52)),
          c = o('xgcd', { 'number, number': a, 'BigNumber, BigNumber': s });
    ...
    function (e, t, r) {
      e.exports = [r(395), r(399), r(400), r(402), r(404), r(407), r(409)];
    },
    function (e, t, r) {
      'use strict';
      function n(e, t, n, a) {
        ...
        return (
          (m.toTex = { 2: '\\left(${args[0]}' + s.operators.bitAnd + '${args[1]}\\right)' }), m
        );
      }
      var i = r(6).isInteger,
        o = r(396);
    ...
    function (e, t, r) {
      function n(e) {
        for (var t = e.d, r = t[0] + '', n = 1; n < t.length; ++n) {
          for (var i = t[n] + '', o = 7 - i.length; o--; ) i = '0' + i;
          r += i;
        }
        var a;
        for (a = r.length - 1; '0' == r.charAt(a); --a);
        var s = e.e,
          u = r.slice(0, a + 1 || 1),
          c = u.length;
        if (s > 0)
        ...
        for (var f = [0], n = 0; n < u.length; ) {
          ...
          for (var a = 0; a < f.length; ++a)
            f[a] > 1 && (null == f[a + 1] && (f[a + 1] = 0), (f[a + 1] += f[a] >> 1), (f[a] &= 1));
        }
        return f.reverse();
      }
      var i = r(398);
      e.exports = function (e, t, r) {
        ...
        var l, p, h;
        o.length <= a.length ? ((l = o), (p = a), (h = u)) : ((l = a), (p = o), (h = c));
        var m = l.length,
          d = p.length,
          g = 1 ^ r(u, c),
          v = new s(1 ^ g),
          ...
          x = new s(2),
          b = s.precision;
        for (s.config({ precision: 1e9 }); m > 0; )
          r(l[--m], p[--d]) == g && (v = v.plus(y)), (y = y.times(x));
        for (; d > 0; ) r(h, p[--d]) == g && (v = v.plus(y)), (y = y.times(x));
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        ...
        return (
          (m.toTex = { 2: '\\left(${args[0]}' + s.operators.bitXor + '${args[1]}\\right)' }), m
        );
      }
      var i = r(6).isInteger,
        o = r(403);
    ...
    function (e, t, r) {
      ...
      e.exports = function (e, t) {
        ...
        return e.eq(o)
          ...
          : e.isFinite() || t.isFinite()
          ? new r(e.isNegative() == t.isNegative() ? 1 / 0 : -(1 / 0))
          : o;
      };
    },
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        ...
        return (
          (y.toTex = { 2: '\\left(${args[0]}' + s.operators.leftShift + '${args[1]}\\right)' }), y
        );
      }
      var i = r(6).isInteger,
        o = r(405);
      ...
      e.exports = function (e, t) {
        ...
        return e.isNaN() || t.isNaN() || (t.isNegative() && !t.isZero())
          ...
          ? t.lt(55)
            ...
            : e.div(new r(2).pow(t)).floor()
          : new r(e.isNegative() ? -1 : e.isFinite() ? 0 : NaN);
      };
    },
    function (e, t, r) {
      'use strict';
      function n(e, t, n, o) {
        ...
        return (
          (v.toTex = { 2: '\\left(${args[0]}' + a.operators.rightLogShift + '${args[1]}\\right)' }),
          v
        );
      }
      var i = r(6).isInteger;
    ...
    function (e, t, r) {
      e.exports = [r(411), r(417), r(412), r(418)];
    },
    function (e, t, r) {
      'use strict';
      function n(e, t, n, i) {
        var o = n(r(51)),
          ...
          c = i('bellNumbers', {
            'number | BigNumber': function (e) {
              ...
              for (var t = 0, r = 0; e >= r; r++) t = o(t, a(e, r));
              return t;
            },
          });
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, u) {
        function c(r) {
          ...
          for (
            var n = t.precision + (0 | Math.log(r.toNumber())),
              i = e.BigNumber.clone({ precision: n }),
              o = new i(r),
              a = r.toNumber() - 1;
            a > 1;
        ...
        var f = n(r(84)),
          ...
          p = u('gamma', {
            number: function (e) {
              ...
              if (0.5 > e) return Math.PI / (Math.sin(Math.PI * e) * p(1 - e));
              ...
              --e, (r = s[0]);
              for (var h = 1; h < s.length; ++h) r += s[h] / (e + h);
              return (
                (t = e + a + 0.5), Math.sqrt(2 * Math.PI) * Math.pow(t, e + 0.5) * Math.exp(-t) * r
              );
            },
            Complex: function (t) {
              var r, n;
              ...
              for (var i = 1; i < s.length; ++i) {
                var o = t.re + i,
                  u = o * o + t.im * t.im;
                0 != u
                  ? ((n.re += (s[i] * o) / u), (n.im += -(s[i] * t.im) / u))
                  : (n.re = s[i] < 0 ? -(1 / 0) : 1 / 0);
              }
              r = new e.Complex(t.re + a + 0.5, t.im);
              var c = Math.sqrt(2 * Math.PI);
              t.re += 0.5;
              var h = l(r, t);
              0 == h.im ? (h.re *= c) : 0 == h.re ? (h.im *= c) : ((h.re *= c), (h.im *= c));
              var m = Math.exp(-r.re);
              return (r.re = m * Math.cos(-r.im)), (r.im = m * Math.sin(-r.im)), f(f(h, r), n);
            },
            BigNumber: function (t) {
              if (t.isInteger())
      ...
      function n(e, t, r, n) {
        var a = n('combinations', {
          ...
          'BigNumber, BigNumber': function (t, r) {
            ...
            for (
              n = t.minus(r), r.lt(n) && (n = r), o = u, a = u, s = t.minus(n);
              a.lte(s);
              a = a.plus(1)
            )
              o = o.times(n.plus(a)).dividedBy(a);
            return o;
          },
        });
        return (a.toTex = { 2: '\\binom{${args[0]}}{${args[1]}}' }), a;
      }
      function i(e) {
    ...
    function (e, t, r) {
      e.exports = [r(420), r(421), r(422), r(423)];
    },
    function (e, t, r) {
      'use strict';
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\arg\\left(${args[0]}\\right)' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\Im\\left\\lbrace${args[0]}\\right\\rbrace' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\Re\\left\\lbrace${args[0]}\\right\\rbrace' }), o;
      }
      var i = r(19);
      (t.name = 're'), (t.factory = n);
    },
    function (e, t, r) {
      e.exports = [r(425), r(426)];
    },
    function (e, t, r) {
      'use strict';
      function n(e, t, n, i) {
        ...
        function u(e, r, n, i) {
          var o = e,
            ...
            u = d(a, i),
            c = s[0] * u[1] - u[0] * s[1];
          if (l(c) < t.epsilon) return null;
          var f = (u[0] * o[1] - u[1] * o[0] - u[0] * a[1] + u[1] * a[0]) / c;
          return p(m(s, f), o);
        }
        function c(e, t, r, n, i, o, a, s, u, c, f, l) {
          var p = (e - a) * (c - a) + (t - s) * (f - s) + (r - u) * (l - u),
            h = (c - a) * (n - e) + (f - s) * (i - t) + (l - u) * (o - r),
            m = (e - a) * (n - e) + (t - s) * (i - t) + (r - u) * (o - r),
            d = (c - a) * (c - a) + (f - s) * (f - s) + (l - u) * (l - u),
            g = (n - e) * (n - e) + (i - t) * (i - t) + (o - r) * (o - r),
            v = (p * h - m * d) / (g * d - h * h),
            y = (p + v * h) / d,
            x = e + v * (n - e),
            b = t + v * (i - t),
        ...
        function f(e, t, r, n, i, o, a, s, u, c) {
          var f = (c - e * a - t * s - r * u) / (n * a + i * s + o * u - e - t - r),
            l = e + f * (n - e),
            p = t + f * (i - t),
            h = r + f * (o - r);
          return [l, p, h];
        ...
        var l = n(r(86)),
          ...
          g = i('intersect', {
            'Array, Array, Array': function (e, t, r) {
              ...
              if (!s(r)) throw new TypeError('Array with 4 numbers expected as third argument');
            ...
            'Array, Array, Array, Array': function (e, t, r, n) {
              if (2 === e.length) {
                ...
                if (!o(r)) throw new TypeError('Array with 2 numbers expected for third argument');
                if (!o(n)) throw new TypeError('Array with 2 numbers expected for fourth argument');
                return u(e, t, r, n);
              }
              if (3 === e.length) {
                if (!a(e)) throw new TypeError('Array with 3 numbers expected for first argument');
    ...
    function (e, t, r) {
          ...
          s('distance', {
            ...
            'Object, Object, Object': function (e, t, r) {
              if (
                ...
                if (
                  e.hasOwnProperty('pointX') &&
                  e.hasOwnProperty('pointY') &&
                  t.hasOwnProperty('lineOnePtX') &&
                  t.hasOwnProperty('lineOnePtY') &&
                  r.hasOwnProperty('lineTwoPtX') &&
                  r.hasOwnProperty('lineTwoPtY')
                ) {
            ...
            'Object, Object': function (e, t) {
              if (2 == Object.keys(e).length && 3 == Object.keys(t).length) {
                ...
                if (!o(t))
                  throw new TypeError(
                    'Values of xCoeffLine, yCoeffLine and constant should be numbers'
                  );
                if (
                  e.hasOwnProperty('pointX') &&
                  e.hasOwnProperty('pointY') &&
                  t.hasOwnProperty('xCoeffLine') &&
                  t.hasOwnProperty('yCoeffLine') &&
                  t.hasOwnProperty('yCoeffLine')
                )
              ...
              if (2 == Object.keys(e).length && 2 == Object.keys(t).length) {
                ...
                if (
                  e.hasOwnProperty('pointOneX') &&
                  e.hasOwnProperty('pointOneY') &&
                  t.hasOwnProperty('pointTwoX') &&
                  t.hasOwnProperty('pointTwoY')
                )
              ...
              if (3 == Object.keys(e).length && 3 == Object.keys(t).length) {
                if (!o(e))
                  throw new TypeError(
                    'Values of pointOneX, pointOneY and pointOneZ should be numbers'
                  );
                if (!o(t))
                  throw new TypeError(
                    'Values of pointTwoX, pointTwoY and pointTwoZ should be numbers'
                  );
                if (
                  e.hasOwnProperty('pointOneX') &&
                  e.hasOwnProperty('pointOneY') &&
                  e.hasOwnProperty('pointOneZ') &&
                  t.hasOwnProperty('pointTwoX') &&
                  t.hasOwnProperty('pointTwoY') &&
                  t.hasOwnProperty('pointTwoZ')
                )
                  return p(
                    e.pointOneX,
                    e.pointOneY,
      ...
      function i(e) {
        return (
          e.constructor !== Array && (e = s(e)), 'number' == typeof e[0] && 'number' == typeof e[1]
        );
      }
      function o(e) {
        return (
          e.constructor !== Array && (e = s(e)),
      ...
      function c(e, t, r, n, i) {
        var o = Math.abs(r * e + n * t + i),
          a = Math.pow(r * r + n * n, 0.5),
          s = o / a;
        return s;
      }
      function f(e, t, r, n, i, o, a, s, u) {
        var c = [(i - t) * u - (o - r) * s, (o - r) * a - (n - e) * u, (n - e) * s - (i - t) * a];
        c = Math.pow(c[0] * c[0] + c[1] * c[1] + c[2] * c[2], 0.5);
        var f = Math.pow(a * a + s * s + u * u, 0.5),
          l = c / f;
        return l;
      }
      function l(e, t, r, n) {
      ...
      function h(e) {
        for (var t = [], r = 0; r < e.length - 1; r++)
          for (var n = r + 1; n < e.length; n++)
            2 == e[0].length
              ? t.push(l(e[r][0], e[r][1], e[n][0], e[n][1]))
              : 3 == e[0].length && t.push(p(e[r][0], e[r][1], e[r][2], e[n][0], e[n][1], e[n][2]));
        return t;
      }
      (t.name = 'distance'), (t.factory = n);
    },
    function (e, t, r) {
      e.exports = [r(428), r(429), r(431), r(432)];
    },
    function (e, t, r) {
      'use strict';
      function n(e, t, n, i) {
        ...
        return (m.toTex = { 2: '\\left(${args[0]}' + o.operators.and + '${args[1]}\\right)' }), m;
      }
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        ...
        return (s.toTex = { 1: a.operators.not + '\\left(${args[0]}\\right)' }), s;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        return (p.toTex = { 2: '\\left(${args[0]}' + o.operators.or + '${args[1]}\\right)' }), p;
      }
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        return (p.toTex = { 2: '\\left(${args[0]}' + o.operators.xor + '${args[1]}\\right)' }), p;
      }
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        function a(e, t) {
          var r = i(e),
            n = i(t);
          if (1 != r.length || 1 != n.length || 3 != r[0] || 3 != n[0])
            throw new RangeError(
          ...
          return [
            u(c(e[1], t[2]), c(e[2], t[1])),
            u(c(e[2], t[0]), c(e[0], t[2])),
            u(c(e[0], t[1]), c(e[1], t[0])),
          ];
        }
        var s = n(r(52)),
          u = n(r(77)),
        ...
        return (f.toTex = { 2: '\\left(${args[0]}\\right)\\times\\left(${args[1]}\\right)' }), f;
      }
      var i = r(40).size;
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        function s(e, t, r, n) {
          ...
          switch (r.length) {
            case 1:
              return u(e, t, n, r[0], a, i);
            case 2:
              return c(e, t, n, r, a, i);
          }
        ...
        function c(e, t, r, n, i, o) {
          if (e && e.isMatrix === !0) {
            var a = e.diagonal(t);
            return null !== r ? (r !== a.storage() ? f(a, r) : a) : a.valueOf();
          }
          for (var s = Math.min(n[0] - i, n[1] - o), u = [], c = 0; s > c; c++)
            u[c] = e[c + i][c + o];
          return null !== r ? f(u) : u;
        }
        var f = n(r(52)),
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        function a(e, t) {
          ...
          for (var a = 0, c = 0; o > c; c++) a = s(a, u(e[c], t[c]));
          return a;
        }
        var s = n(r(51)),
          u = n(r(84)),
        ...
        return (c.toTex = { 2: '\\left(${args[0]}\\cdot${args[1]}\\right)' }), c;
      }
      var i = r(40).size;
      ...
      function n(e, t, n, o) {
        ...
        function u(e, t, r) {
          ...
          for (var n = 0, i = e.length - 1; i > n; ) {
            for (var o = n, a = i, s = e[Math.floor(Math.random() * (i - n + 1)) + n]; a > o; )
              if (r(e[o], s) >= 0) {
                var u = e[a];
                (e[a] = e[o]), (e[o] = u), --a;
              } else ++o;
            r(e[o], s) > 0 && --o, o >= t ? (i = o) : (n = o + 1);
          }
          return e[t];
        }
        var c = n(r(440));
      ...
      function n(e, t, n, a) {
        var s = n(r(52)),
          ...
          h = a('compare', {
            ...
            'BigNumber, BigNumber': function (r, n) {
              return r.eq(n) || o(r, n, t.epsilon) ? new e.BigNumber(0) : new e.BigNumber(r.cmp(n));
            },
      ...
      function n(e, t, n, f) {
        function l(e, t, r) {
          ...
          if ('number' != typeof n || !a(n))
            throw new TypeError(
              'Invalid size, must contain positive integers (size: ' + s(t) + ')'
            );
          if (e.length > n) return e.substring(0, n);
          if (e.length < n) {
            for (var o = e, u = 0, c = n - e.length; c > u; u++) o += r;
            return o;
          }
          return e;
        }
        var p = n(r(52)),
          h = function (e, r, n) {
            if (2 != arguments.length && 3 != arguments.length)
              throw new o('resize', arguments.length, 2, 3);
            if (
              (r && r.isMatrix === !0 && (r = r.valueOf()),
              r.length &&
                r[0] &&
                r[0].isBigNumber === !0 &&
                (r = r.map(function (e) {
    ...
    function (e, t, r) {
      e.exports = [r(415), r(413), r(414), r(446), r(448), r(449), r(450), r(452), r(453)];
    },
    function (e, t, r) {
      'use strict';
      function n(e, t, n, i) {
        ...
        var s = n(r(413)),
          u = a('permutations', {
            ...
            'BigNumber, BigNumber': function (t, r) {
              ...
              for (n = new e.BigNumber(1), o = t.minus(r).plus(1); o.lte(t); o = o.plus(1))
                n = n.times(o);
              return n;
            },
          });
            ...
            var t = {
                ...
                randomInt: function (e, t, r) {
                  ...
                  if (arguments.length > 3 || arguments.length < 1)
                    throw new i('randomInt', arguments.length, 1, 3);
                  if (
                    (1 === arguments.length
                      ? o(e)
                        ? (s = e)
              ...
              a = function (e, t, r, n) {
                ...
                if (((e = e.slice(0)), e.length > 1))
                  for (o = 0, i = e.shift(); i > o; o++) s.push(a(e, t, r, n));
                else for (o = 0, i = e.shift(); i > o; o++) s.push(n(t, r));
                return s;
              };
            return t;
          })(r);
              ...
              return function () {
                for (var e, t, r = -1; 0 > r || r > 1; )
                  (e = Math.random()),
                    (t = Math.random()),
                    (r =
                      (1 / 6) * Math.pow(-2 * Math.log(e), 0.5) * Math.cos(2 * Math.PI * t) + 0.5);
                return r;
              };
            },
          };
    ...
    function (e, t, r) {
      e.exports = [r(440), r(455), r(88), r(64), r(351), r(60), r(456), r(457)];
    },
    function (e, t, r) {
      'use strict';
      function n(e, t, n, i) {
        function o(e, t) {
          if (Array.isArray(e)) {
            if (Array.isArray(t)) {
              ...
              for (var n = 0; r > n; n++) if (!o(e[n], t[n])) return !1;
              return !0;
            }
            return !1;
          }
          return Array.isArray(t) ? !1 : a(e, t);
        }
        var a = n(r(88)),
          s = i('deepEqual', {
            'any, any': function (e, t) {
      ...
      function n(e, t, n, a) {
        var s = n(r(52)),
          ...
          m = a('smallerEq', {
            ...
            'BigNumber, BigNumber': function (e, r) {
              return e.lte(r) || o(e, r, t.epsilon);
            },
            'Fraction, Fraction': function (e, t) {
              return 1 !== e.compare(t);
            },
        ...
        return (
          (m.toTex = { 2: '\\left(${args[0]}' + h.operators.smallerEq + '${args[1]}\\right)' }), m
        );
      }
      var i = r(6).nearlyEqual,
        o = r(49);
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        ...
        return (
          (m.toTex = { 2: '\\left(${args[0]}' + h.operators.unequal + '${args[1]}\\right)' }), m
        );
      }
      var i = r(6).nearlyEqual,
        o = r(49);
    ...
    function (e, t, r) {
      e.exports = [r(320), r(325), r(459), r(330), r(460), r(461), r(462), r(463), r(447), r(464)];
    },
    function (e, t, r) {
      'use strict';
      function n(e, t, n, a) {
        function s(e) {
          ...
          if (t % 2 == 0) {
            for (var r = t / 2 - 1, n = l(e, r + 1), o = e[r], a = 0; r > a; ++a)
              f(e[a], o) > 0 && (o = e[a]);
            return m(o, n);
          }
          var s = l(e, (t - 1) / 2);
      ...
      function n(e, t, r, n) {
        function o(e) {
          ...
          for (var a in e)
            e[a] in r || (r[e[a]] = 0),
              r[e[a]]++,
              r[e[a]] == o ? n.push(e[a]) : r[e[a]] > o && ((o = r[e[a]]), (n = [e[a]]));
          return n;
        }
        var a = n('mode', {
          'Array | Matrix': o,
            ...
            if (((n = n || !1), 'boolean' == typeof n)) {
              if (((u = t.valueOf()), o(r))) {
                ...
                if (r > 1) {
                  ...
                  var l = r + 1;
                  a = new Array(r);
                  for (var p = 0; r > p; ) a[p] = f(u, ++p / l, n);
                  return a;
                }
              }
              if (r && r.isBigNumber) {
                if (r.isNegative()) throw new Error('N/prob must be non-negative');
                if (((c = new r.constructor(1)), r.lte(c))) return f(u, r, n);
                if (r.gt(c)) {
                  ...
                  a = new Array(h);
                  for (var p = 0; h > p; ) a[p] = f(u, new e.BigNumber(++p).div(l), n);
                  return a;
                }
              }
              if (Array.isArray(r)) {
        ...
        function f(e, t, r) {
          ...
          if (o(t)) {
            ...
            if (r) (f = n[v]), (g = n[v + 1]);
              ...
              (g = h(n, v + 1)), (f = n[v]);
              for (var y = 0; v > y; ++y) m(n[y], f) > 0 && (f = n[y]);
            }
          ...
          if (r) (f = n[x]), (g = n[x + 1]);
            ...
            (g = h(n, x + 1)), (f = n[x]);
            for (var y = 0; x > y; ++y) m(n[y], f) > 0 && (f = n[y]);
          }
          d(f), d(g);
          var b = new u.constructor(1);
          return l(p(f, b.minus(u)), p(g, u));
        }
        var l = n(r(51)),
          p = n(r(84)),
          h = n(r(439)),
    ...
    function (e, t, r) {
      e.exports = [r(90), r(466)];
    },
    function (e, t, r) {
      'use strict';
      function n(e, t, r, n) {
        var o = n('print', { 'string, Object': i, 'string, Object, number': i });
        return (o.toTex = void 0), o;
      }
      function i(e, t, r) {
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\cos^{-1}\\left(${args[0]}\\right)' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        var a = n('acosh', {
          number: function (r) {
            return r >= 1 || t.predictable
              ? o(r)
              : -1 >= r
              ? new e.Complex(Math.log(Math.sqrt(r * r - 1) - r), Math.PI)
              : new e.Complex(r, 0).acosh();
          },
          Complex: function (e) {
            return e.acosh();
          },
        ...
        return (a.toTex = { 1: '\\cosh^{-1}\\left(${args[0]}\\right)' }), a;
      }
      var i = r(19),
        o =
          Math.acosh ||
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\cot^{-1}\\left(${args[0]}\\right)' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        var o = n('acoth', {
          number: function (r) {
            return r >= 1 || -1 >= r || t.predictable
              ? isFinite(r)
                ? (Math.log((r + 1) / r) + Math.log(r / (r - 1))) / 2
                : 0
              : new e.Complex(r, 0).acoth();
          },
          Complex: function (e) {
            return e.acoth();
          },
        ...
        return (o.toTex = { 1: '\\coth^{-1}\\left(${args[0]}\\right)' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        var o = n('acsc', {
          number: function (r) {
            return -1 >= r || r >= 1 || t.predictable
              ? Math.asin(1 / r)
              : new e.Complex(r, 0).acsc();
          },
          Complex: function (e) {
            return e.acsc();
          },
        ...
        return (o.toTex = { 1: '\\csc^{-1}\\left(${args[0]}\\right)' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\mathrm{csch}^{-1}\\left(${args[0]}\\right)' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\sec^{-1}\\left(${args[0]}\\right)' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        var a =
          (o.find(n(r(469)), ['Complex']),
          o('asech', {
            number: function (r) {
              if ((1 >= r && r >= -1) || t.predictable) {
                r = 1 / r;
                var n = Math.sqrt(r * r - 1);
                return r > 0 || t.predictable
                  ? Math.log(n + r)
                  : new e.Complex(Math.log(n - r), Math.PI);
              }
        ...
        return (a.toTex = { 1: '\\mathrm{sech}^{-1}\\left(${args[0]}\\right)' }), a;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\sin^{-1}\\left(${args[0]}\\right)' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\sinh^{-1}\\left(${args[0]}\\right)' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\tan^{-1}\\left(${args[0]}\\right)' }), o;
      }
      var i = r(19);
      ...
      function n(e, t, n, i) {
        var o = n(r(52)),
          ...
          h = i('atan2', {
            ...
            'Array, number | BigNumber': function (e, t) {
              return p(o(e), t, h, !1).valueOf();
            },
            'number | BigNumber, Array': function (e, t) {
              return p(o(t), e, h, !0).valueOf();
            },
          });
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        var a = n('atanh', {
          number: function (r) {
            return (1 >= r && r >= -1) || t.predictable ? o(r) : new e.Complex(r, 0).atanh();
          },
          Complex: function (e) {
            return e.atanh();
          },
        ...
        return (a.toTex = { 1: '\\tanh^{-1}\\left(${args[0]}\\right)' }), a;
      }
      var i = r(19),
        o =
          Math.atanh ||
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\cos\\left(${args[0]}\\right)' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (a.toTex = { 1: '\\cosh\\left(${args[0]}\\right)' }), a;
      }
      var i = r(19),
        o =
          Math.cosh ||
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\cot\\left(${args[0]}\\right)' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (a.toTex = { 1: '\\coth\\left(${args[0]}\\right)' }), a;
      }
      function i(e) {
        var t = Math.exp(2 * e);
        return (t + 1) / (t - 1);
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\csc\\left(${args[0]}\\right)' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (a.toTex = { 1: '\\mathrm{csch}\\left(${args[0]}\\right)' }), a;
      }
      function i(e) {
        return 0 == e
          ? Number.POSITIVE_INFINITY
          : Math.abs(2 / (Math.exp(e) - Math.exp(-e))) * a(e);
      }
      var o = r(19),
        a = r(6).sign;
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\sec\\left(${args[0]}\\right)' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (a.toTex = { 1: '\\mathrm{sech}\\left(${args[0]}\\right)' }), a;
      }
      function i(e) {
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\sin\\left(${args[0]}\\right)' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (a.toTex = { 1: '\\sinh\\left(${args[0]}\\right)' }), a;
      }
      var i = r(19),
        o =
          Math.sinh ||
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (o.toTex = { 1: '\\tan\\left(${args[0]}\\right)' }), o;
      }
      var i = r(19);
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        return (a.toTex = { 1: '\\tanh\\left(${args[0]}\\right)' }), a;
      }
      var i = r(19),
        o =
          Math.tanh ||
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        return (c.toTex = { 2: '\\left(${args[0]}' + o.operators.to + '${args[1]}\\right)' }), c;
      }
      (t.name = 'to'), (t.factory = n);
    },
    function (e, t, r) {
      e.exports = [r(496), r(416), r(365), r(89), r(378), r(497), r(430), r(498), r(91)];
    },
    function (e, t, r) {
      'use strict';
      function n(e, t, r, n) {
        var o = n('clone', { any: i.clone });
        return (o.toTex = void 0), o;
      }
      var i = r(3);
      ...
      function n(e, t, r, n) {
        var o = n('isPrime', {
          number: function (e) {
            ...
            if (2 == e) return !0;
            if (e % 2 == 0) return !1;
            for (var t = 3; e >= t * t; t += 2) if (e % t == 0) return !1;
            return !0;
          },
          BigNumber: function (t) {
            if (t.lt(2)) return !1;
