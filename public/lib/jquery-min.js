...
(function (e, t) {
  ...
  (x.fn = x.prototype =
    ...
    x.extend({
      ...
      makeArray: function (e, t) {
        var n = t || [];
        return (
          null != e && (M(Object(e)) ? x.merge(n, 'string' == typeof e ? [e] : e) : h.call(n, e)), n
        );
      },
          ...
          if ((n = o.relative[e[l].type])) f = [vt(bt(f), n)];
            ...
            if (((n = o.filter[e[l].type].apply(null, e[l].matches)), n[b])) {
              ...
              return wt(
                l > 1 && bt(f),
                l > 1 &&
                  yt(e.slice(0, l - 1).concat({ value: ' ' === e[l - 2].type ? '*' : '' })).replace(
                    z,
                    '$1'
                  ),
                n,
      ...
      p = {
        ...
        fireWith: function (e, t) {
          return (
            !l ||
              (i && !u) ||
              ((t = t || []), (t = [e, t.slice ? t.slice() : t]), n ? u.push(t) : c(t)),
            this
          );
        },
        fire: function () {
  ...
  (x.event = {
    ...
    remove: function (e, t, n, r, i) {
      ...
      if (m && (c = m.events)) {
        ...
        while (u--)
          if (
            ((s = rt.exec(t[u]) || []), (d = g = s[1]), (h = (s[2] || '').split('.').sort()), d)
          ) {
            (p = x.event.special[d] || {}),
  ...
  x.extend({
    clone: function (e, t, n) {
      ...
      return (
        (r = Ft(o, 'script')), r.length > 0 && _t(r, !l && Ft(e, 'script')), (r = s = i = null), o
      );
    },
      ...
      style: function (e, n, r, i) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          ...
          if (
            ...
            'string' === a &&
              (o = Jt.exec(r)) &&
              ((r = (o[1] + 1) * o[2] + parseFloat(x.css(e, n))), (a = 'number')),
            !(
              null == r ||
              ('number' === a && isNaN(r)) ||
    ...
    x.cssHooks[n] = {
      ...
      set: function (e, t, r) {
        ...
        return on(
          ...
          t,
          r
            ? an(e, n, r, x.support.boxSizing && 'border-box' === x.css(e, 'boxSizing', !1, i), i)
            : 0
        );
      },
    };
    ...
    if (!x.isEmptyObject(c)) {
      ...
      for (r in c)
        (a = Zn(f ? d[r] : 0, r, u)),
          r in d ||
            ((d[r] = a.start),
            f && ((a.end = a.start), (a.start = 'width' === r || 'height' === r ? 1 : 0)));
    }
  }
